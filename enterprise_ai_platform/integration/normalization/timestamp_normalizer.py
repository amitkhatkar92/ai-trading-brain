"""enterprise_ai_platform/integration/normalization/timestamp_normalizer.py
...
from enterprise_ai_platform.integration.integration_exceptions import TimestampNormalizationError
