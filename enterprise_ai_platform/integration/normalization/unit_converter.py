"""enterprise_ai_platform/integration/normalization/unit_converter.py
...
from enterprise_ai_platform.integration.integration_exceptions import UnitConversionError
