"""enterprise_ai_platform/integration/normalization/field_mapper.py
...
from enterprise_ai_platform.integration.integration_exceptions import FieldMappingError
