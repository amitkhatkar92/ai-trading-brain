"""enterprise_ai_platform/integration/validation/validation_report.py"""
...
from enterprise_ai_platform.integration.integration_constants import ValidationSeverity, ValidationStatus
