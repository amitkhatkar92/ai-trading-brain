...
```python
import json
from enterprise_ai_platform.integration.snapshot import IntegrationSnapshotFactory
...
```python
from enterprise_ai_platform.integration.snapshot import ConnectivitySummary
...
```python
from enterprise_ai_platform.integration.snapshot import SnapshotMetadata
...
```python
from enterprise_ai_platform.integration.snapshot import IntegrationSnapshotBundle
