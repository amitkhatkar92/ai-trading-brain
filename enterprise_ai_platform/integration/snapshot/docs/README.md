...
**Package:** `enterprise_ai_platform.integration.snapshot`
...
| Module | Package |
|---|---|
| M1 — Integration Lifecycle | `enterprise_ai_platform.integration.lifecycle` |
| M2 — Integration Engine | `enterprise_ai_platform.integration.engine` |
| M3 — Integration Governance Policy Framework | `enterprise_ai_platform.integration.policies` |
| M4 — Integration Services Framework | `enterprise_ai_platform.integration.services` |
