"""enterprise_ai_platform/integration/pipeline/pipeline_stage.py
...
from enterprise_ai_platform.integration.integration_constants import PipelineStageStatus, PipelineStageType
...
class ExtractionStage(PipelineStage):
    ...
    async def process(self, context: "PipelineContext") -> PipelineStageResult:
        from enterprise_ai_platform.integration.integration_exceptions import ProviderFetchError
...
from enterprise_ai_platform.integration.pipeline.pipeline_context import PipelineContext  # noqa: E402
