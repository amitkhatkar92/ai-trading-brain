"""enterprise_ai_platform/integration/pipeline/pipeline_engine.py
...
from enterprise_ai_platform.integration.integration_exceptions import PipelineNotFoundError
from enterprise_ai_platform.integration.core.data_record import DataRequest
