"""enterprise_ai_platform/integration/__init__.py
...
from enterprise_ai_platform.integration.integration_manager import IntegrationManager
...
# ── Core models ───────────────────────────────────────────────────────────────
from enterprise_ai_platform.integration.core import (
    DataRecord,
    DataRequest,
    DataResponse,
    IntegrationEvent,
...
# ── Providers ─────────────────────────────────────────────────────────────────
from enterprise_ai_platform.integration.providers import (
    BaseProvider,
    CircuitBreaker,
...
# ── Pipeline ──────────────────────────────────────────────────────────────────
from enterprise_ai_platform.integration.pipeline import (
    Pipeline,
    PipelineBuilder,
    PipelineContext,
    PipelineEngine,
...
# ── Normalization ─────────────────────────────────────────────────────────────
from enterprise_ai_platform.integration.normalization import (
    FieldMapper,
    FieldMapping,
    NormalizationEngine,
    SchemaMapper,
...
# ── Validation ────────────────────────────────────────────────────────────────
from enterprise_ai_platform.integration.validation import (
    FieldSpec,
    IntegrityChecker,
    QualityChecker,
    SchemaValidator,
...
# ── Monitoring ────────────────────────────────────────────────────────────────
from enterprise_ai_platform.integration.monitoring import (
    AvailabilityMonitor,
    HealthMonitor,
    LatencyMonitor,
    ProviderMonitor,
...
# ── Cache ─────────────────────────────────────────────────────────────────────
from enterprise_ai_platform.integration.cache import CacheEntry, CacheKey, IntegrationCache

# ── Registry ──────────────────────────────────────────────────────────────────
from enterprise_ai_platform.integration.registry import CapabilityRegistry
