...
from enterprise_ai_platform.integration.research.backtesting.backtest_constants import DEFAULT_MAX_BACKTESTS
from enterprise_ai_platform.integration.research.backtesting.core.backtest_configuration import BacktestConfiguration
from enterprise_ai_platform.integration.research.backtesting.core.backtest_history import BacktestHistory
...
class BacktestFactory:
    ...
    def create_simulation_engine():
        from enterprise_ai_platform.integration.research.backtesting.engine.simulation_engine import SimulationEngine
        return SimulationEngine()

    @staticmethod
    def create_market_simulator():
        from enterprise_ai_platform.integration.research.backtesting.engine.market_simulator import MarketSimulator
    ...
    def create_event_scheduler():
        from enterprise_ai_platform.integration.research.backtesting.engine.event_scheduler import EventScheduler
    ...
    def create_overfitting_detector():
        from enterprise_ai_platform.integration.research.backtesting.validation.overfitting_detector import OverfittingDetector
