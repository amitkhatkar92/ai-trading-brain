"""enterprise_ai_platform/integration/research/backtesting/__init__.py
...
Quick-start::
    ...
    from enterprise_ai_platform.integration.research.backtesting import (
...
from enterprise_ai_platform.integration.research.backtesting.core                  import (
...
from enterprise_ai_platform.integration.research.backtesting.engine               import (
    BarEvent, BacktestStrategy,
    SimulationEngine, MarketSimulator, ExecutionSimulator,
    SimulationClock, EventScheduler,
)
from enterprise_ai_platform.integration.research.backtesting.execution            import (
    Order, OrderSignal, Fill,
    Trade, Portfolio, Position, PortfolioSnapshot,
)
from enterprise_ai_platform.integration.research.backtesting.metrics              import (
...
from enterprise_ai_platform.integration.research.backtesting.reporting            import (
    ReportGenerator, EquityCurveReport, TradeReport,
    BenchmarkReport, ComparisonReport,
)
from enterprise_ai_platform.integration.research.backtesting.validation           import (
