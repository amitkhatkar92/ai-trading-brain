...
class EquityCurveReport:
    ...
    def build(
        ...
        *,
        ...
        from enterprise_ai_platform.integration.research.backtesting.metrics.return_calculator import cumulative_returns
        from enterprise_ai_platform.integration.research.backtesting.metrics.drawdown_calculator import underwater_curve
