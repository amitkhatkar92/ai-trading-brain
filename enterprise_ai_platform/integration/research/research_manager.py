"""enterprise_ai_platform/integration/research/research_manager.py
...
from enterprise_ai_platform.integration.research.core.research_dataset     import ResearchDataset
