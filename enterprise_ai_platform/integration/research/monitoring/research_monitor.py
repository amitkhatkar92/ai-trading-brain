"""enterprise_ai_platform/integration/research/monitoring/research_monitor.py
...
from enterprise_ai_platform.integration.research.research_constants import DEFAULT_EXPERIMENT_TIMEOUT_SEC
