"""enterprise_ai_platform/integration/research/tracking/execution_tracker.py
...
from enterprise_ai_platform.integration.research.research_constants  import CheckpointStatus
