...
```python
from enterprise_ai_platform.integration.services import ProtocolRegistry, ProtocolDescriptor, TransportType
...
```python
from enterprise_ai_platform.integration.services import ProtocolEngine, ConnectorContext, ServiceType, TransportType, AuthScheme
