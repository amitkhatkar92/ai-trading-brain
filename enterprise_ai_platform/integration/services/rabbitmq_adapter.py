"""
rabbitmq_adapter.py — enterprise_ai_platform.integration.services
-------------------------------------------------
    ...
    def execute(self, request: ConnectorRequest) -> ConnectorResponse:
        ...
        try:
            ...
            if operation == "consume":
                msgs = self.consume(
                    queue=cfg.get("rmq_queue", "enterprise_ai_platform"),
                ...
                msg  = self.publish(
                    ...
                    routing_key=cfg.get("rmq_routing_key", "enterprise_ai_platform"),
