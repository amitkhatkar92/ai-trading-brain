"""enterprise_ai_platform/integration/history/simulation/simulation_clock.py
...
from enterprise_ai_platform.integration.history.history_exceptions import SimulationClockError
