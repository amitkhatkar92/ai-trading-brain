"""enterprise_ai_platform/integration/history/simulation/scenario_loader.py
...
from enterprise_ai_platform.integration.history.history_exceptions import ScenarioNotFoundError
