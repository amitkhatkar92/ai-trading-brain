"""enterprise_ai_platform/integration/history/historical_data_engine.py
...
from enterprise_ai_platform.integration.history.simulation.scenario_loader import Scenario
