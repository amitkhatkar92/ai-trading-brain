"""enterprise_ai_platform/integration/history/history_manager.py
...
from enterprise_ai_platform.integration.history.query.historical_filter         import HistoricalFilter
