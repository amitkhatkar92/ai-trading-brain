"""enterprise_ai_platform/integration/history/compression/__init__.py
...
from enterprise_ai_platform.integration.history.history_constants import CompressionType
