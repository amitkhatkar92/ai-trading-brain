"""enterprise_ai_platform/integration/integration_manager.py
...
from enterprise_ai_platform.integration.integration_constants import DataCategory, DataFrequency, PipelineStatus
