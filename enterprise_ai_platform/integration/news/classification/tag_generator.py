"""enterprise_ai_platform/integration/news/classification/tag_generator.py
...
from enterprise_ai_platform.integration.news.news_constants     import DEFAULT_MAX_TAGS
