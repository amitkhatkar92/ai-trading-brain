"""enterprise_ai_platform/integration/news/news_factory.py
...
from enterprise_ai_platform.integration.news.sentiment.sentiment_registry import SentimentRegistry
