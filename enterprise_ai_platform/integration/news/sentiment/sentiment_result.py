"""enterprise_ai_platform/integration/news/sentiment/sentiment_result.py
...
from enterprise_ai_platform.integration.news.news_constants import SentimentLabel, SentimentScope
