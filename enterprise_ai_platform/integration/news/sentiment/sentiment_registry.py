"""enterprise_ai_platform/integration/news/sentiment/sentiment_registry.py
...
from enterprise_ai_platform.integration.news.news_constants    import SentimentScope
