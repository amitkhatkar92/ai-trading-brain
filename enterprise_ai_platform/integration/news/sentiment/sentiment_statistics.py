"""enterprise_ai_platform/integration/news/sentiment/sentiment_statistics.py
...
from enterprise_ai_platform.integration.news.news_constants import SentimentLabel
