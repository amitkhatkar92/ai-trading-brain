"""enterprise_ai_platform/integration/market_data/normalization/market_normalizer.py
...
from enterprise_ai_platform.integration.market_data.market_data_constants import DataQuality
