"""enterprise_ai_platform/integration/market_data/streaming/stream_router.py
...
from enterprise_ai_platform.integration.market_data.market_data_constants import MarketDataType, MarketEventType
