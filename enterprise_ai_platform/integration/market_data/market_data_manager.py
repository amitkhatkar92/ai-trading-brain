"""enterprise_ai_platform/integration/market_data/market_data_manager.py
...
from enterprise_ai_platform.integration.market_data.providers.market_data_session        import SubscriptionHandle
