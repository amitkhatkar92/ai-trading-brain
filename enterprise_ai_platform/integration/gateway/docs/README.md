...
The **Enterprise Integration Gateway** (`enterprise_ai_platform.integration.gateway`) is the **ONLY** public entry point for the entire Enterprise Integration & Connectivity subsystem (C15).

External components **MUST NOT** directly access:
- Integration Lifecycle (`enterprise_ai_platform.integration.lifecycle`)
- Integration Engine (`enterprise_ai_platform.integration.engine`)
- Integration Governance Policy Framework (`enterprise_ai_platform.integration.policies`)
- Integration Services Framework (`enterprise_ai_platform.integration.services`)
- Integration Snapshot (`enterprise_ai_platform.integration.snapshot`)
