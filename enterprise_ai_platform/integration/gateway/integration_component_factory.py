"""
integration_component_factory.py — enterprise_ai_platform.integration.gateway
-------------------------------------------------------------
...
class IntegrationComponentFactory:
    ...
    def create_connector_engine() -> Any:
        ...
        from enterprise_ai_platform.integration.services import ConnectorEngine
        ce = ConnectorEngine()
    ...
    def create_snapshot_registry() -> Any:
        ...
        from enterprise_ai_platform.integration.snapshot import IntegrationSnapshotRegistry
