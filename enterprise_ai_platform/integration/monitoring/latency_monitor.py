"""enterprise_ai_platform/integration/monitoring/latency_monitor.py"""
...
from enterprise_ai_platform.integration.integration_constants import DEFAULT_HIGH_LATENCY_WARNING_MS, DEFAULT_HIGH_LATENCY_CRITICAL_MS
