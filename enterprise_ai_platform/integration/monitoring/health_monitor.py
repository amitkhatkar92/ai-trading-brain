"""enterprise_ai_platform/integration/monitoring/health_monitor.py
...
from enterprise_ai_platform.integration.providers.provider_health import ProviderHealth
