"""enterprise_ai_platform/integration/monitoring/availability_monitor.py"""
...
from enterprise_ai_platform.integration.integration_constants import DEFAULT_MIN_AVAILABILITY_PCT
