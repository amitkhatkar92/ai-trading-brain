"""enterprise_ai_platform/integration/registry/capability_registry.py
...
from enterprise_ai_platform.integration.integration_constants import DataCategory, DataFrequency
