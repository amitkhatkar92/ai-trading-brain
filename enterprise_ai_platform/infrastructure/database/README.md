...
```
enterprise_ai_platform/infrastructure/database/
...
```python
from enterprise_ai_platform.infrastructure.database import DatabaseFactory, DatabaseEngine as EngineType
...
# From config
from enterprise_ai_platform.infrastructure.database import DatabaseConfig, DatabaseEngine as EngineType
...
from enterprise_ai_platform.infrastructure.database import BaseModel, Eq, Gt, DatabaseFactory
...
```python
from enterprise_ai_platform.infrastructure.database import Eq, Ne, Gt, Ge, Lt, Le, In, Between, And, Or, Not
...
```python
from enterprise_ai_platform.infrastructure.database import OrmQueryBuilder, Gt
...
```python
from enterprise_ai_platform.infrastructure.database import Migration, MigrationManager
...
```python
from enterprise_ai_platform.infrastructure.database import get_database_manager, DatabaseConfig, DatabaseEngine as EngineType
...
```python
from enterprise_ai_platform.infrastructure.database import BackupManager, BackupConfig
...
```python
from enterprise_ai_platform.infrastructure.database import AuditLogger, AuditEntry, AuditAction
...
`SQLiteBackend` and `QueryBuilder` (the original low-level modules) remain fully exported from `enterprise_ai_platform.infrastructure.database` and are not modified.
