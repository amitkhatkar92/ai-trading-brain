"""
enterprise_ai_platform/infrastructure/database/sqlite_backend.py
===============================================
...
class SQLiteBackend:
    ...
    Usage::
        ...
        db = SQLiteBackend("data/enterprise_ai_platform.db")
    ...
    def __init__(self, path: str = "data/enterprise_ai_platform.db", check_same_thread: bool = False) -> None:
        self._path = path
