"""
enterprise_ai_platform/infrastructure/database/database_factory.py
=================================================
...
class DatabaseFactory:
    ...
    def in_memory(name: str = "test", echo: bool = False) -> DatabaseEngine:
        ...
        cfg = DatabaseConfig(
            ...
            audit=__import__("enterprise_ai_platform.infrastructure.database.database_config", fromlist=["AuditConfig"]).AuditConfig(enabled=False),
        )
        return DatabaseEngine(cfg)
