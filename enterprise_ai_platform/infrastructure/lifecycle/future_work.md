# Future Work: enterprise_ai_platform.infrastructure.lifecycle
...
All public interfaces must match the specification in **IIOS-CIS-001 Group B** before Wave 2 PR merge.
