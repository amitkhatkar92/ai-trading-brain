"""
enterprise_ai_platform/infrastructure/security/security_models.py
================================================
...
class SecretRecord:
    ...
    name: str = ""
    path: str = ""          # e.g. "enterprise_ai_platform/broker/dhan/api_key"
...
class AuditRecord:
    ...
    resource: str = ""
    outcome: str = "success"
    source: str = "enterprise_ai_platform.security"
