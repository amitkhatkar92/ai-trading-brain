"""
enterprise_ai_platform/infrastructure/security/security_manager.py
=================================================
...
_LOG = logging.getLogger("enterprise_ai_platform.security")
...
class SecurityManager:
    ...
    def set_secret(
        ...
        **kwargs: Any,
        ...
        get_audit_manager().secret_created("enterprise_ai_platform:system", path)
        return rec

    def get_secret(self, path: str) -> bytes:
        value = get_secret_manager().get(path)
        get_audit_manager().secret_accessed("enterprise_ai_platform:system", path)
        return value
    ...
    def rotate_secret(self, path: str, new_value: bytes) -> SecretRecord:
        ...
        get_audit_manager().secret_rotated("enterprise_ai_platform:system", path)
        return rec

    def delete_secret(self, path: str) -> bool:
        ok = get_secret_manager().delete(path)
        if ok:
            get_audit_manager().secret_deleted("enterprise_ai_platform:system", path)
        return ok
