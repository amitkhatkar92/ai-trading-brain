"""
enterprise_ai_platform/infrastructure/security/secret_manager.py
===============================================
...
_LOG = logging.getLogger("enterprise_ai_platform.security.secret")
...
class SecretManager:
    ...
    Usage::
        ...
        sm.set("enterprise_ai_platform/broker/dhan/api_key", b"sk-secret", secret_type=SecretType.API_KEY)
        value = sm.get("enterprise_ai_platform/broker/dhan/api_key")
        sm.rotate("enterprise_ai_platform/broker/dhan/api_key", new_value=b"sk-new-secret")
    """
