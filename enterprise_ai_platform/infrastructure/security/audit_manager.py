"""
enterprise_ai_platform/infrastructure/security/audit_manager.py
==============================================
...
_LOG = logging.getLogger("enterprise_ai_platform.security.audit_manager")
...
class AuditManager:
    ...
    Usage::
        ...
        audit.secret_accessed("service:bot", "enterprise_ai_platform/broker/dhan/api_key")
    """
    ...
    def login(self, principal_id: str, success: bool, ip: str = "", details: Optional[dict[str, Any]] = None) -> AuditRecord:
        ...
        return get_audit_recorder().record(
            ...
            action="login",
            resource="enterprise_ai_platform.auth",
    ...
    def token_issued(self, principal_id: str, token_type: str = "access") -> AuditRecord:
        return get_audit_recorder().record(
            ...
            principal_id=principal_id,
            action="token_issued",
            resource="enterprise_ai_platform.token",
            severity=AuditSeverity.INFO,
