"""
enterprise_ai_platform/infrastructure/security/permission_manager.py
===================================================
...
_LOG = logging.getLogger("enterprise_ai_platform.security.permission")
...
class PermissionManager:
    ...
    def _register_defaults(self) -> None:
        defaults = [
            ("*", "*", "*"),
            ("enterprise_ai_platform:admin", "enterprise_ai_platform", "admin"),
            ("enterprise_ai_platform:read", "enterprise_ai_platform", "read"),
            ("enterprise_ai_platform:write", "enterprise_ai_platform", "write"),
