"""
enterprise_ai_platform/infrastructure/security/role_manager.py
=============================================
...
_LOG = logging.getLogger("enterprise_ai_platform.security.role")
...
_BUILTIN_ROLES: list[dict] = [
    ...
    },
    {
        ...
        "permissions": ["enterprise_ai_platform:admin", "audit:read", "secrets:read"],
    ...
    },
    {
        ...
        "permissions": ["trade:read", "orders:read", "portfolio:read", "enterprise_ai_platform:read"],
        "parent_roles": [],
        "is_system": True,
    },
    {
    ...
    },
    {
        ...
        "permissions": ["enterprise_ai_platform:read", "enterprise_ai_platform:write"],
        "parent_roles": [],
        "is_system": True,
    },
]
