"""
enterprise_ai_platform/infrastructure/security/certificate_manager.py
====================================================
...
_LOG = logging.getLogger("enterprise_ai_platform.security.certificate")
...
class CertificateManager:
    ...
    def generate_self_signed(
        self,
        name: str,
        common_name: str = "enterprise_ai_platform.local",
        valid_days: int = 365,
