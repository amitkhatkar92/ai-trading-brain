"""
enterprise_ai_platform/infrastructure/security/vault_provider.py
===============================================
...
_LOG = logging.getLogger("enterprise_ai_platform.security.vault")
...
class EnvironmentVaultProvider(VaultProvider):
    ...
    E.g., ``enterprise_ai_platform/broker/dhan/api_key`` → env var ``IIOS_BROKER_DHAN_API_KEY``.
    """
