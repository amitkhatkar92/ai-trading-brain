"""
enterprise_ai_platform/infrastructure/events/event_bus.py
========================================
...
_LOG = logging.getLogger("enterprise_ai_platform.infrastructure.events.bus")
    ...
    def start(self) -> None:
        ...
        with self._lock:
            ...
            self._worker = threading.Thread(
                ...
                daemon=True,
                name="enterprise_ai_platform.event_bus.worker",
            )
            self._worker.start()
            self._running = True
