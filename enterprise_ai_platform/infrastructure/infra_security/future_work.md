# Future Work: enterprise_ai_platform.infrastructure.infra_security
...
All public interfaces must match the specification in **IIOS-CIS-001 Group D** before Wave 2 PR merge.
...
- All services registered with DI Container (enterprise_ai_platform.infrastructure.configuration).
