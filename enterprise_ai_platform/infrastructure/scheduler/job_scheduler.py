"""
enterprise_ai_platform/infrastructure/scheduler/job_scheduler.py
===============================================
...
_LOG = logging.getLogger("enterprise_ai_platform.infrastructure.scheduler")
    ...
    def start(self) -> None:
        with self._lock:
            ...
            self._worker = threading.Thread(
                ...
                daemon=True,
                name="enterprise_ai_platform.scheduler.worker",
            )
            self._worker.start()
            self._running = True
