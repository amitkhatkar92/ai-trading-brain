"""
enterprise_ai_platform/ontology/loader/resource_loader.py
=========================================
...
_LOG = logging.getLogger("enterprise_ai_platform.ontology.loader.resource")
...
class ResourceLoader:
    ...
    The expected dict schema::
        ...
        {
            "uri":         "enterprise_ai_platform.myext.ontology",
            "name":        "MY_EXTENSION",
            "version":     "1.0.0",
            "description": "...",
            "category":    "extension",
            "namespace": {
                "uri":    "enterprise_ai_platform.myext",
                "name":   "MyExtension",
                "prefix": "ext"
            },
            "imports": [],
            "types": {
                "MyType": {
                    "uri":           "enterprise_ai_platform.myext.MyType",
                    "name":          "MyType",
                    "namespace_uri": "enterprise_ai_platform.myext",
                    "kind":          "concrete",
                    "parent_uri":    "enterprise_ai_platform.information.BaseObject",
                    "description":   "...",
                    "properties": {
                        "symbol": {
                            "name":      "symbol",
