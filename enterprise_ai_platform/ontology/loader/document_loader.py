"""
enterprise_ai_platform/ontology/loader/document_loader.py
=========================================
...
def _build_information_ontology() -> OntologyDocument:
    ns_uri = "enterprise_ai_platform.information"
...
def _build_entity_ontology() -> OntologyDocument:
    ns_uri = "enterprise_ai_platform.entity"
    base   = "enterprise_ai_platform.information"
    ns     = OntologyNamespace(
        uri         = ns_uri,
        name        = "EntityOntology",
        prefix      = "ent",
    ...
    return OntologyDocument(
        ...
        description = "Market and system entity types for IIOS.",
        types       = {t.name: t for t in types},
        imports     = ["enterprise_ai_platform.information.ontology"],
    )
...
def _build_relationship_ontology() -> OntologyDocument:
    ns_uri = "enterprise_ai_platform.relationship"
    ns     = OntologyNamespace(
        uri         = ns_uri,
    ...
    rels: list[OntologyRelationshipDef] = [
        _rel(
            ...
            name            = "BelongsTo",
            namespace_uri   = ns_uri,
            source_type_uri = "enterprise_ai_platform.entity.Instrument",
            target_type_uri = "enterprise_ai_platform.entity.Sector",
        ...
        _rel(
            ...
            name            = "Contains",
            namespace_uri   = ns_uri,
            source_type_uri = "enterprise_ai_platform.entity.Sector",
            target_type_uri = "enterprise_ai_platform.entity.Instrument",
        ...
        _rel(
            ...
            name            = "GeneratedBy",
            namespace_uri   = ns_uri,
            source_type_uri = "enterprise_ai_platform.observation.Observation",
            target_type_uri = "enterprise_ai_platform.entity.Agent",
            cardinality     = Cardinality.MANY_TO_ONE,
        ...
        _rel(
            ...
            name            = "DerivedFrom",
            namespace_uri   = ns_uri,
            source_type_uri = "enterprise_ai_platform.knowledge.KnowledgeRecord",
            target_type_uri = "enterprise_ai_platform.observation.Observation",
        ...
        _rel(
            ...
            namespace_uri   = ns_uri,
            source_type_uri = "enterprise_ai_platform.knowledge.KnowledgeRecord",
            target_type_uri = "enterprise_ai_platform.knowledge.KnowledgeRecord",
            cardinality     = Cardinality.MANY_TO_MANY,
        ...
        _rel(
            ...
            name            = "AppliesTo",
            namespace_uri   = ns_uri,
            source_type_uri = "enterprise_ai_platform.entity.Strategy",
            target_type_uri = "enterprise_ai_platform.entity.Instrument",
            cardinality     = Cardinality.MANY_TO_MANY,
        ...
        _rel(
            ...
            name            = "TriggeredBy",
            namespace_uri   = ns_uri,
            source_type_uri = "enterprise_ai_platform.event.Event",
            target_type_uri = "enterprise_ai_platform.observation.Observation",
            cardinality     = Cardinality.MANY_TO_MANY,
    ...
    return OntologyDocument(
        ...
        imports       = ["enterprise_ai_platform.entity.ontology", "enterprise_ai_platform.observation.ontology", "enterprise_ai_platform.knowledge.ontology"],
    )
...
def _build_event_ontology() -> OntologyDocument:
    ns_uri = "enterprise_ai_platform.event"
    base   = "enterprise_ai_platform.information"
    ns     = OntologyNamespace(
        uri         = ns_uri,
        name        = "EventOntology",
...
def _build_observation_ontology() -> OntologyDocument:
    ns_uri = "enterprise_ai_platform.observation"
    base   = "enterprise_ai_platform.information"
    ns     = OntologyNamespace(
        uri         = ns_uri,
...
def _build_knowledge_ontology() -> OntologyDocument:
    ns_uri = "enterprise_ai_platform.knowledge"
    base   = "enterprise_ai_platform.information"
    ns     = OntologyNamespace(
        uri         = ns_uri,
...
def _build_master_ontology() -> OntologyDocument:
    ns_uri = "enterprise_ai_platform.architecture"
    ns     = OntologyNamespace(
        uri         = ns_uri,
    ...
    types: list[OntologyTypeDef] = [
        _type(
            ...
            kind          = TypeKind.ABSTRACT,
            abstract      = True,
            parent_uri    = "enterprise_ai_platform.information.NamedObject",
