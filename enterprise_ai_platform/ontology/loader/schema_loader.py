"""
enterprise_ai_platform/ontology/loader/schema_loader.py
=======================================
...
_LOG = logging.getLogger("enterprise_ai_platform.ontology.loader.schema")
    ...
    def _validate_namespace(self, ns: OntologyNamespace) -> None:
        ...
        if "." not in ns.uri:
            raise OntologySchemaError(
                f"Namespace URI {ns.uri!r} must be a dotted path (e.g. 'enterprise_ai_platform.observation')."
            )
