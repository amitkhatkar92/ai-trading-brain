"""
enterprise_ai_platform/ontology/query/query_context.py
=====================================
...
class QueryContext:
    ...
    Usage::
        ...
        with ctx.query_operation(QueryType.ANCESTORS, "enterprise_ai_platform.entity.Instrument"):
            with ctx.resolution("enterprise_ai_platform.entity.Instrument", ResolutionStrategy.AUTO):
                ...
    """
