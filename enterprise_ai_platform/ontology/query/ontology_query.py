"""
enterprise_ai_platform/ontology/query/ontology_query.py
=======================================
Query builder and executor for ontology type lookups.

Usage::

    from enterprise_ai_platform.ontology.query import OntologyQuery, OntologyQueryEngine
...
_LOG  = logging.getLogger("enterprise_ai_platform.ontology.query")
