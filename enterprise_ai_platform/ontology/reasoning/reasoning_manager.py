"""
enterprise_ai_platform/ontology/reasoning/reasoning_manager.py
=============================================
...
class ReasoningManager:
    ...
    def initialize(self, mgr: Optional[Any] = None) -> None:
        ...
        with self._lock:
            if mgr is None:
                from enterprise_ai_platform.ontology.registry.ontology_registry_manager import (
    ...
    def explain(self, session_id: str) -> dict:
        ...
        return self._expl_engine.explain(
            ...
            explanation_type = __import__(
                "enterprise_ai_platform.ontology.reasoning.reasoning_constants",
