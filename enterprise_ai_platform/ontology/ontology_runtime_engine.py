"""
enterprise_ai_platform/ontology/ontology_runtime_engine.py
==========================================
...
Usage::
    ...
    td = manager.get_type("enterprise_ai_platform.entity.Index") # by full URI
...
_LOG  = logging.getLogger("enterprise_ai_platform.ontology.engine")
