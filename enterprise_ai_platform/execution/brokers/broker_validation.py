"""enterprise_ai_platform/execution/brokers/broker_validation.py
==================================================
...
from enterprise_ai_platform.execution.brokers.broker_request import BrokerRequest, OrderRequest
from enterprise_ai_platform.execution.brokers.broker_response import BrokerResponse
from enterprise_ai_platform.execution.brokers.broker_metadata import BrokerMetadata
from enterprise_ai_platform.execution.brokers.broker_capabilities import BrokerCapabilities
...
_log = get_logger(__name__, engine_id="enterprise_ai_platform:execution:brokers:validator")
...
class BrokerValidator:
    ...
    def validate_request(
        ...
        from enterprise_ai_platform.execution.brokers.constants import BrokerRequestType
    ...
    def _validate_order_request(
        ...
        from enterprise_ai_platform.execution.brokers.constants import BrokerCapabilityCode
