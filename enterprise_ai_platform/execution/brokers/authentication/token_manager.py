"""enterprise_ai_platform/execution/brokers/authentication/token_manager.py"""
...
from enterprise_ai_platform.execution.brokers.broker_constants import DEFAULT_TOKEN_TTL_SEC
