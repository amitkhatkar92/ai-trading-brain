"""enterprise_ai_platform/execution/brokers/connection/connection_monitor.py"""
...
from enterprise_ai_platform.execution.brokers.broker_constants import DEFAULT_HEARTBEAT_INTERVAL_SEC
