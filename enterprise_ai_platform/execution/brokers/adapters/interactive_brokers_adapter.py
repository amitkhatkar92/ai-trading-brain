"""enterprise_ai_platform/execution/brokers/adapters/interactive_brokers_adapter.py — IBKR skeleton."""
...
from enterprise_ai_platform.execution.brokers.core.base_broker_adapter import BaseBrokerAdapter, BrokerAdapterConfig
