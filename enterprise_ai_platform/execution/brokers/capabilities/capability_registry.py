"""enterprise_ai_platform/execution/brokers/capabilities/capability_registry.py"""
...
from enterprise_ai_platform.execution.brokers.core.broker_capability import BrokerCapabilitySet
