"""enterprise_ai_platform/execution/brokers/registry/plugin_registry.py
...
# Map of well-known broker_id → module name within enterprise_ai_platform.execution.brokers.adapters
...
_ADAPTER_PACKAGE = "enterprise_ai_platform.execution.brokers.adapters"
