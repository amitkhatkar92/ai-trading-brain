"""enterprise_ai_platform/execution/brokers/registry/adapter_registry.py
...
from enterprise_ai_platform.execution.brokers.broker_constants import DEFAULT_MAX_BROKERS
