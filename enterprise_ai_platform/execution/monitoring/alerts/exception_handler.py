"""enterprise_ai_platform/execution/monitoring/alerts/exception_handler.py"""
from __future__ import annotations

import logging
from typing import Any, Callable

from enterprise_ai_platform.execution.monitoring.monitoring_constants import AlertSeverity
