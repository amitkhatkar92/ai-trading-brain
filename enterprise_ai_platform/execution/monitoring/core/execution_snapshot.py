"""enterprise_ai_platform/execution/monitoring/core/execution_snapshot.py
...
from enterprise_ai_platform.execution.monitoring.monitoring_constants import MonitoringStatus
