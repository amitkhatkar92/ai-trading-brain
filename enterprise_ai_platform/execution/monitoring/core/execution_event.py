"""enterprise_ai_platform/execution/monitoring/core/execution_event.py"""
...
from enterprise_ai_platform.execution.monitoring.monitoring_constants import ExecutionEventType
