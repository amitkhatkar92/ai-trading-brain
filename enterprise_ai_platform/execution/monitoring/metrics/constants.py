"""enterprise_ai_platform/execution/monitoring/metrics/constants.py
==================================================
...
ENGINE_SYSTEM_ID    = "enterprise_ai_platform:execution:monitoring:metrics:engine"
MANAGER_SYSTEM_ID   = "enterprise_ai_platform:execution:monitoring:metrics:manager"
REGISTRY_SYSTEM_ID  = "enterprise_ai_platform:execution:monitoring:metrics:registry"
FACTORY_SYSTEM_ID   = "enterprise_ai_platform:execution:monitoring:metrics:factory"
COLLECTOR_SYSTEM_ID = "enterprise_ai_platform:execution:monitoring:metrics:collector"
