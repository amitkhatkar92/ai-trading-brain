"""enterprise_ai_platform/execution/core/execution_result.py"""
...
from enterprise_ai_platform.execution.execution_constants import ExecutionStatus, ExecutionType
