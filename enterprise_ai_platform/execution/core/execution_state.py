"""enterprise_ai_platform/execution/core/execution_state.py"""
...
from enterprise_ai_platform.execution.execution_exceptions import ExecutionStateError
...
class ExecutionState:
    ...
    def is_terminal(self) -> bool:
        from enterprise_ai_platform.execution.execution_constants import TERMINAL_STATUSES
        return self.current_status in TERMINAL_STATUSES

    @property
    def is_active(self) -> bool:
        from enterprise_ai_platform.execution.execution_constants import ACTIVE_STATUSES
