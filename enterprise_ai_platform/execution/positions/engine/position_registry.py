"""enterprise_ai_platform/execution/positions/engine/position_registry.py
==================================================
...
class EngineRegistry(LifecycleAwareMixin):
    """
    Engine-layer wrapper around ``enterprise_ai_platform.execution.positions.lifecycle.PositionRegistry``.
