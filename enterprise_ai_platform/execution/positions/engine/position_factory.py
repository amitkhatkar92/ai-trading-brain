"""enterprise_ai_platform/execution/positions/engine/position_factory.py
==================================================
...
class EngineFactory:
    ...
    Uses ``enterprise_ai_platform.execution.positions.lifecycle.PositionFactory`` internally.
    """
