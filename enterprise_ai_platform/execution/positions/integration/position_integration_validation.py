"""enterprise_ai_platform/execution/positions/integration/position_integration_validation.py
==================================================
...
class IntegrationValidator:
    ...
    def validate_risk_consistency(
        ...
        warnings: List[str] = []
        try:
            from enterprise_ai_platform.execution.positions.risk.position_risk_registry import RiskRegistry
