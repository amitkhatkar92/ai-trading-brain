"""enterprise_ai_platform/execution/positions/integration/constants.py
==================================================
...
from enterprise_ai_platform.investment.workflow.engine_lifecycle import EngineState  # re-export StrEnum base
