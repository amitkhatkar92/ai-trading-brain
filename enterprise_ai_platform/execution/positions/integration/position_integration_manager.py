"""enterprise_ai_platform/execution/positions/integration/position_integration_manager.py
==================================================
...
from enterprise_ai_platform.execution.positions.lifecycle import PositionState
...
from enterprise_ai_platform.execution.positions.snapshot import PositionSnapshot, PositionSnapshotStore
    ...
    * No snapshot building logic (owned by PositionSnapshotStore).
    ...
    def snapshot(self) -> PositionIntegrationSnapshot:
        ...
        try:
            ...
            try:
                from enterprise_ai_platform.execution.positions.risk import make_risk_book_snapshot
