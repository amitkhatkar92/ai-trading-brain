"""enterprise_ai_platform/execution/positions/integration/position_integration_request.py
==================================================
...
from enterprise_ai_platform.execution.positions.lifecycle import PositionDirection, PositionProduct, PositionState
...
if TYPE_CHECKING:
    from enterprise_ai_platform.execution.positions.risk import RiskLimits
