"""enterprise_ai_platform/execution/positions/snapshot/constants.py
==================================================
...
SNAPSHOT_SYSTEM_ID  = "enterprise_ai_platform:execution:positions:snapshot"
STORE_SYSTEM_ID     = "enterprise_ai_platform:execution:positions:snapshot:store"
REGISTRY_SYSTEM_ID  = "enterprise_ai_platform:execution:positions:snapshot:registry"
CACHE_SYSTEM_ID     = "enterprise_ai_platform:execution:positions:snapshot:cache"
BUILDER_SYSTEM_ID   = "enterprise_ai_platform:execution:positions:snapshot:builder"
FACTORY_SYSTEM_ID   = "enterprise_ai_platform:execution:positions:snapshot:factory"
VALIDATOR_SYSTEM_ID = "enterprise_ai_platform:execution:positions:snapshot:validator"
...
ACTOR_SNAPSHOT = "enterprise_ai_platform:execution:positions:snapshot"
ACTOR_STORE    = "enterprise_ai_platform:execution:positions:snapshot:store"
ACTOR_BUILDER  = "enterprise_ai_platform:execution:positions:snapshot:builder"
