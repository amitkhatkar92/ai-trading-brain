"""enterprise_ai_platform/execution/oms/integration/oms_integration_manager.py
==================================================
...
class OMSIntegrationManager(LifecycleAwareMixin):
    ...
    def _route_query(self, request: IntegrationRequest) -> dict:
        ...
        if qt == IntegrationQueryType.FIND_ORDER:
            ...
            from enterprise_ai_platform.execution.oms.persistence import RepositoryFactory
            ...
            from enterprise_ai_platform.execution.oms.persistence import RepositoryContext, OperationType
