"""enterprise_ai_platform/execution/oms/integration/oms_component_registry.py
==================================================
...
class OMSComponentRegistry(LifecycleAwareMixin):
    ...
    def _assert_running(self) -> None:
        if self.lifecycle_state() != EngineState.RUNNING:
            from enterprise_ai_platform.execution.oms.integration.exceptions import OMSNotInitializedError
