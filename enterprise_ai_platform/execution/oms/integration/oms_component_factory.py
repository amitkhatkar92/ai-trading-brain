"""enterprise_ai_platform/execution/oms/integration/oms_component_factory.py
==================================================
...
from enterprise_ai_platform.execution.oms.integration.constants import ComponentType, FACTORY_SYSTEM_ID
