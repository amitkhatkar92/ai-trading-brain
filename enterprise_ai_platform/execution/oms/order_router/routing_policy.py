"""enterprise_ai_platform/execution/oms/order_router/routing_policy.py
==================================================
...
def make_backtest_policy() -> RoutingPolicy:
    ...
    from enterprise_ai_platform.execution.oms.order_router.routing_rule import RoutingRule
    bt_rule = RoutingRule(
