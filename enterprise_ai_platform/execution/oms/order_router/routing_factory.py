"""enterprise_ai_platform/execution/oms/order_router/routing_factory.py
==================================================
...
from enterprise_ai_platform.execution.oms.order_router.constants import FACTORY_SYSTEM_ID
