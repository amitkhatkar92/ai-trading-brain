"""enterprise_ai_platform/execution/oms/persistence/repository_validation.py
==================================================
...
from enterprise_ai_platform.execution.oms.persistence.repository_interface import REQUIRED_METHODS
...
class RepositoryValidator:
    ...
    def validate_no_duplicate(
        ...
        from enterprise_ai_platform.execution.oms.persistence.exceptions import DuplicateRecordError
    ...
    def validate_record_exists(
        ...
        from enterprise_ai_platform.execution.oms.persistence.exceptions import RecordNotFoundError
    ...
    def validate_schema_version(
        ...
        if actual_schema != expected_schema:
            from enterprise_ai_platform.execution.oms.persistence.exceptions import SchemaVersionError
