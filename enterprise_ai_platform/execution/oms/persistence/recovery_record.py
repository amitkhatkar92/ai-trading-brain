"""enterprise_ai_platform/execution/oms/persistence/recovery_record.py
==================================================
...
from enterprise_ai_platform.execution.oms.persistence.constants import RecordType, RecoveryState
