"""enterprise_ai_platform/execution/oms/persistence/repository_factory.py
==================================================
...
from enterprise_ai_platform.execution.oms.persistence.storage_metadata import StorageRecord
from enterprise_ai_platform.execution.oms.persistence.storage_version import StorageVersion, VersionType
...
class RepositoryFactory:
    ...
    def make_version_entry(
        ...
        record_id:      str,
        version_number: int,
        author:         str         = "enterprise_ai_platform:system",
        change_summary: str         = "",
