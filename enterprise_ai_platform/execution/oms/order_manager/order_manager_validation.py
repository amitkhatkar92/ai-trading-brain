"""enterprise_ai_platform/execution/oms/order_manager/order_manager_validation.py
==================================================
...
from enterprise_ai_platform.execution.oms.order_manager.order_manager_context import ManagedOrder
from enterprise_ai_platform.execution.oms.order_manager.order_manager_request import CreateOrderRequest
from enterprise_ai_platform.common.logging.logging_manager import get_logger

_log = get_logger(__name__, engine_id="enterprise_ai_platform:execution:oms:order_manager:validator")
