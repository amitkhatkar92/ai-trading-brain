"""enterprise_ai_platform/execution/oms/order_manager/order_manager_context.py
==================================================
...
class ManagedOrder:
    ...
    order: Optional[Any] = None    # enterprise_ai_platform.execution.lifecycle.order.Order
    ...
    def is_terminal(self) -> bool:
        from enterprise_ai_platform.execution.oms.order_manager.constants import TERMINAL_MANAGER_STATES
        return self.manager_state in TERMINAL_MANAGER_STATES

    @property
    def is_active(self) -> bool:
        from enterprise_ai_platform.execution.oms.order_manager.constants import ACTIVE_MANAGER_STATES
