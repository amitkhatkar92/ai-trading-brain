"""enterprise_ai_platform/execution/oms/order_queue/queue_events.py
==================================================
...
from enterprise_ai_platform.execution.oms.order_queue.constants import QueueEventType, QueueEntryState
...
class QueueEvent:
    ...
    actor:       str   = "enterprise_ai_platform:execution:oms:order_queue"
