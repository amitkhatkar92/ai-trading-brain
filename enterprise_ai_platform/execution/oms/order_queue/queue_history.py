"""enterprise_ai_platform/execution/oms/order_queue/queue_history.py
==================================================
...
from enterprise_ai_platform.execution.oms.order_queue.constants import DEFAULT_MAX_HISTORY, QueueEntryState
