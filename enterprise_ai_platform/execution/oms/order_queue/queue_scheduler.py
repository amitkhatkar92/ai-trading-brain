"""enterprise_ai_platform/execution/oms/order_queue/queue_scheduler.py
==================================================
...
class QueueScheduler:
    ...
    def get_expired_entries(
        ...
        from enterprise_ai_platform.execution.oms.order_queue.constants import ACTIVE_ENTRY_STATES
        t = now if now is not None else time.time()
        return [
            e for e in entries
