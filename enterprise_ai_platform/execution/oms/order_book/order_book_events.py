"""enterprise_ai_platform/execution/oms/order_book/order_book_events.py
==================================================
...
from enterprise_ai_platform.execution.oms.order_book.constants import BookEntryStatus, BookEventType
