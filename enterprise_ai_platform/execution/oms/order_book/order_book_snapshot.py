"""enterprise_ai_platform/execution/oms/order_book/order_book_snapshot.py
==================================================
...
from enterprise_ai_platform.execution.oms.order_book.constants import BookEntryStatus, VERSION
