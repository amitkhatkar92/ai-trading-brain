"""enterprise_ai_platform/execution/oms/order_book/order_book_validation.py
==================================================
...
from enterprise_ai_platform.execution.oms.order_book.constants import BookValidationCode
from enterprise_ai_platform.execution.oms.order_book.order_book_context import OrderAddRequest
...
_log = get_logger(__name__, engine_id="enterprise_ai_platform:execution:oms:order_book:validator")
