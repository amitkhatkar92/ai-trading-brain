"""enterprise_ai_platform/execution/planning/planning_manager.py
...
from enterprise_ai_platform.execution.planning.planning_constants import ExecutionPlanStatus
