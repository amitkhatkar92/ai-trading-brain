"""enterprise_ai_platform/execution/planning/analytics/impact_estimator.py
...
from enterprise_ai_platform.execution.planning.planning_constants import DEFAULT_IMPACT_RATE
