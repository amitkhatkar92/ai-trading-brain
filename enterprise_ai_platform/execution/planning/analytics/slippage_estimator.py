"""enterprise_ai_platform/execution/planning/analytics/slippage_estimator.py"""
...
from enterprise_ai_platform.execution.planning.planning_constants import DEFAULT_SLIPPAGE_RATE
