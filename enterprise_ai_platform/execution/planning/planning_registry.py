"""enterprise_ai_platform/execution/planning/planning_registry.py
...
from enterprise_ai_platform.execution.planning.planning_constants import DEFAULT_MAX_PLANS
