"""enterprise_ai_platform/execution/planning/core/execution_plan.py"""
...
class ExecutionPlan:
    ...
    def transition_to(self, new_status: ExecutionPlanStatus, reason: str = "") -> None:
        from enterprise_ai_platform.execution.planning.planning_exceptions import PlanTerminalError
        if (
