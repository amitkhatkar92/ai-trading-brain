"""enterprise_ai_platform/execution/risk/controls/constants.py
==================================================
...
CONTROLS_SYSTEM_ID  = "enterprise_ai_platform:execution:risk:controls"
ENGINE_SYSTEM_ID    = "enterprise_ai_platform:execution:risk:controls:engine"
MANAGER_SYSTEM_ID   = "enterprise_ai_platform:execution:risk:controls:manager"
REGISTRY_SYSTEM_ID  = "enterprise_ai_platform:execution:risk:controls:registry"
FACTORY_SYSTEM_ID   = "enterprise_ai_platform:execution:risk:controls:factory"
VALIDATOR_SYSTEM_ID = "enterprise_ai_platform:execution:risk:controls:validator"

VERSION = "1.0.0"

# ── Actor labels ──────────────────────────────────────────────────────────────

ACTOR_ENGINE   = "enterprise_ai_platform:execution:risk:controls:engine"
ACTOR_MANAGER  = "enterprise_ai_platform:execution:risk:controls:manager"
ACTOR_POLICY   = "enterprise_ai_platform:execution:risk:controls:policy"
...
# Import from enterprise_ai_platform.execution.risk.rules.constants at runtime to avoid
