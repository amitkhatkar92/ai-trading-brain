"""enterprise_ai_platform/execution/risk/snapshot/constants.py
==================================================
...
SNAPSHOT_SYSTEM_ID  = "enterprise_ai_platform:execution:risk:snapshot"
BUILDER_SYSTEM_ID   = "enterprise_ai_platform:execution:risk:snapshot:builder"
REGISTRY_SYSTEM_ID  = "enterprise_ai_platform:execution:risk:snapshot:registry"
STORE_SYSTEM_ID     = "enterprise_ai_platform:execution:risk:snapshot:store"
CACHE_SYSTEM_ID     = "enterprise_ai_platform:execution:risk:snapshot:cache"
FACTORY_SYSTEM_ID   = "enterprise_ai_platform:execution:risk:snapshot:factory"
VALIDATOR_SYSTEM_ID = "enterprise_ai_platform:execution:risk:snapshot:validator"
...
ACTOR_BUILDER  = "enterprise_ai_platform:execution:risk:snapshot:builder"
ACTOR_REGISTRY = "enterprise_ai_platform:execution:risk:snapshot:registry"
