"""enterprise_ai_platform/execution/risk/rules/rule_result.py
==================================================
...
class RuleResult:
    ...
    def to_engine_result(self) -> Any:
        """
        Convert to M2 ``enterprise_ai_platform.execution.risk.engine.RuleResult``.
...
def _lazy_engine_outcomes():
    from enterprise_ai_platform.execution.risk.engine import RuleOutcome as EO
    return {
