"""enterprise_ai_platform/execution/risk/rules/rule_category.py
==================================================
...
from enterprise_ai_platform.execution.risk.lifecycle import RiskCategory as LifecycleRiskCategory
