"""enterprise_ai_platform/execution/risk/engine/execution_risk_registry.py
==================================================
...
class EngineRiskRegistry(LifecycleAwareMixin):
    """
    Engine-layer wrapper around ``enterprise_ai_platform.execution.risk.lifecycle.RiskRegistry``.
