"""enterprise_ai_platform/execution/risk/engine/execution_risk_manager.py
==================================================
...
from enterprise_ai_platform.execution.risk.lifecycle import RiskState
...
class RiskManager(LifecycleAwareMixin):
    ...
    def query(self, request: QueryEvaluationRequest) -> EvaluationResult:
        ...
        if not request.include_archived:
            from enterprise_ai_platform.execution.risk.lifecycle import RiskState as LS
