"""enterprise_ai_platform/execution/risk/engine/execution_risk_factory.py
==================================================
...
from enterprise_ai_platform.execution.risk.lifecycle import RiskFactory
...
class EvaluationFactory:
    ...
    def create_from_request(self, request: "EvaluationRequest"):
        ...
        from enterprise_ai_platform.execution.risk.lifecycle import ExecutionRisk
