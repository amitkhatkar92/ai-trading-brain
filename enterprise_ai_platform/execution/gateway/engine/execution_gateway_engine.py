"""enterprise_ai_platform/execution/gateway/engine/execution_gateway_engine.py
==================================================
...
from enterprise_ai_platform.investment.workflow.engine_lifecycle import EngineState as FrameworkState
