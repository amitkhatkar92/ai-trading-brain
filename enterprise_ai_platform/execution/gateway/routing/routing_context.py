"""enterprise_ai_platform/execution/gateway/routing/routing_context.py
==================================================
...
from enterprise_ai_platform.execution.gateway.brokers.constants import BrokerCapability
