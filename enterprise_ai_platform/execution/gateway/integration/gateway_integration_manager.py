"""enterprise_ai_platform/execution/gateway/integration/gateway_integration_manager.py
==================================================
...
from enterprise_ai_platform.execution.gateway.lifecycle import make_gateway_context
from enterprise_ai_platform.execution.gateway.engine import make_engine_gateway_context
from enterprise_ai_platform.execution.gateway.routing import make_routing_context
from enterprise_ai_platform.execution.gateway.snapshot import GatewaySnapshotFactory
from enterprise_ai_platform.execution.gateway.snapshot.constants import (
    DispatchStatus,
    GatewayState,
    GatewayStatus,
    QueueStatus,
