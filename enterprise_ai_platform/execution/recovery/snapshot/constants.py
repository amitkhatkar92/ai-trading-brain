"""
enterprise_ai_platform/execution/recovery/snapshot/constants.py
=============================================
...
SYSTEM_ID   = "enterprise_ai_platform:execution:recovery:snapshot"
BUILDER_ID  = "enterprise_ai_platform:execution:recovery:snapshot:builder"
FACTORY_ID  = "enterprise_ai_platform:execution:recovery:snapshot:factory"
STORE_ID    = "enterprise_ai_platform:execution:recovery:snapshot:store"
CACHE_ID    = "enterprise_ai_platform:execution:recovery:snapshot:cache"
REGISTRY_ID = "enterprise_ai_platform:execution:recovery:snapshot:registry"
HISTORY_ID  = "enterprise_ai_platform:execution:recovery:snapshot:history"
...
ACTOR_BUILDER  = "enterprise_ai_platform:execution:recovery:snapshot:builder"
