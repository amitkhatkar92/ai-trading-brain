"""
enterprise_ai_platform/execution/recovery/policies/recovery_policy_engine.py
==========================================================
...
class RecoveryPolicyEngineAdapter:
    ...
    def invoke(self, m2_request: Any, m2_context: Any) -> Any:
        ...
        """
        from enterprise_ai_platform.execution.recovery.engine.recovery_dispatcher import PolicyDecision  # lazy
