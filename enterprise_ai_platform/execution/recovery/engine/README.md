...
The Execution Recovery Engine (`enterprise_ai_platform.execution.recovery.engine`) coordinates
...
```python
from enterprise_ai_platform.execution.recovery.engine import RecoveryEngineEvent
...
```
enterprise_ai_platform/execution/recovery/engine/
