"""
enterprise_ai_platform/execution/recovery/engine/constants.py
==========================================
...
SYSTEM_ID      = "enterprise_ai_platform:execution:recovery:engine"
ENGINE_ID      = "enterprise_ai_platform:execution:recovery:engine:main"
MANAGER_ID     = "enterprise_ai_platform:execution:recovery:engine:manager"
SCHEDULER_ID   = "enterprise_ai_platform:execution:recovery:engine:scheduler"
DISPATCHER_ID  = "enterprise_ai_platform:execution:recovery:engine:dispatcher"
PIPELINE_ID    = "enterprise_ai_platform:execution:recovery:engine:pipeline"
SESSION_MGR_ID = "enterprise_ai_platform:execution:recovery:engine:session_manager"
REGISTRY_ID    = "enterprise_ai_platform:execution:recovery:engine:registry"
FACTORY_ID     = "enterprise_ai_platform:execution:recovery:engine:factory"
