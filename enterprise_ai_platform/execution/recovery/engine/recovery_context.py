"""
enterprise_ai_platform/execution/recovery/engine/recovery_context.py
==================================================
...
(enterprise_ai_platform.execution.recovery.lifecycle.recovery_context).  M2's context is
