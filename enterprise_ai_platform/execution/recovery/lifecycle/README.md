...
The Execution Recovery Lifecycle (`enterprise_ai_platform.execution.recovery.lifecycle`) manages
...
```python
from enterprise_ai_platform.execution.recovery.lifecycle import RecoveryLifecycle, RecoveryTrigger
...
```python
from enterprise_ai_platform.execution.recovery.lifecycle import RecoveryEvent
...
```
enterprise_ai_platform/execution/recovery/lifecycle/
