"""enterprise_ai_platform/execution/snapshot/constants.py
==================================================
...
SNAPSHOT_SYSTEM_ID   = "enterprise_ai_platform:execution:snapshot"
BUILDER_SYSTEM_ID    = "enterprise_ai_platform:execution:snapshot:builder"
FACTORY_SYSTEM_ID    = "enterprise_ai_platform:execution:snapshot:factory"
REGISTRY_SYSTEM_ID   = "enterprise_ai_platform:execution:snapshot:registry"
VALIDATOR_SYSTEM_ID  = "enterprise_ai_platform:execution:snapshot:validator"
STORE_SYSTEM_ID      = "enterprise_ai_platform:execution:snapshot:store"
CACHE_SYSTEM_ID      = "enterprise_ai_platform:execution:snapshot:cache"
...
ACTOR_BUILDER   = "enterprise_ai_platform:execution:snapshot:builder"
ACTOR_FACTORY   = "enterprise_ai_platform:execution:snapshot:factory"
ACTOR_REGISTRY  = "enterprise_ai_platform:execution:snapshot:registry"
ACTOR_STORE     = "enterprise_ai_platform:execution:snapshot:store"
ACTOR_USER      = "enterprise_ai_platform:user"
