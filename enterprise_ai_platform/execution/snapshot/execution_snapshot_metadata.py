"""enterprise_ai_platform/execution/snapshot/execution_snapshot_metadata.py
==================================================
...
SNAPSHOT_SYSTEM_ID_DEFAULT = "enterprise_ai_platform:execution:snapshot"
...
class SnapshotAuditMetadata:
    ...
    # Provenance
    created_by:     str            = "enterprise_ai_platform:system"
