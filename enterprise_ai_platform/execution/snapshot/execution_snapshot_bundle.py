"""enterprise_ai_platform/execution/snapshot/execution_snapshot_bundle.py
==================================================
...
from enterprise_ai_platform.execution.snapshot.constants import SnapshotLifecycle
