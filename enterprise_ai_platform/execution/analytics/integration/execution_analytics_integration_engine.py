"""
execution_analytics_integration_engine.py — enterprise_ai_platform.execution.analytics.integration
==================================================================================
...
class ExecutionAnalyticsIntegration(LifecycleAwareMixin):
    ...
    :class:`~enterprise_ai_platform.execution.analytics.snapshot.ExecutionAnalyticsSnapshot`
    objects to callers.
