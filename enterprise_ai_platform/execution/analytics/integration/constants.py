"""
constants.py — enterprise_ai_platform.execution.analytics.integration
====================================================
...
# System identifiers
# ---------------------------------------------------------------------------
INTEGRATION_SYSTEM_ID: str = "enterprise_ai_platform.execution.analytics.integration"
MANAGER_SYSTEM_ID: str     = "enterprise_ai_platform.execution.analytics.integration.manager"
REGISTRY_SYSTEM_ID: str    = "enterprise_ai_platform.execution.analytics.integration.registry"
COMPONENT_REG_ID: str      = "enterprise_ai_platform.execution.analytics.integration.components"
FACTORY_SYSTEM_ID: str     = "enterprise_ai_platform.execution.analytics.integration.factory"
VALIDATOR_SYSTEM_ID: str   = "enterprise_ai_platform.execution.analytics.integration.validation"
HEALTH_SYSTEM_ID: str      = "enterprise_ai_platform.execution.analytics.integration.health"
