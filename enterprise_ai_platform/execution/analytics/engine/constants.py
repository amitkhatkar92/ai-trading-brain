"""
enterprise_ai_platform/execution/analytics/engine/constants.py
============================================
...
ENGINE_SYSTEM_ID      = "enterprise_ai_platform:execution:analytics:engine"
MANAGER_SYSTEM_ID     = "enterprise_ai_platform:execution:analytics:engine:manager"
SCHEDULER_SYSTEM_ID   = "enterprise_ai_platform:execution:analytics:engine:scheduler"
DISPATCHER_SYSTEM_ID  = "enterprise_ai_platform:execution:analytics:engine:dispatcher"
SESSION_MGR_SYSTEM_ID = "enterprise_ai_platform:execution:analytics:engine:session_manager"
REGISTRY_SYSTEM_ID    = "enterprise_ai_platform:execution:analytics:engine:registry"
FACTORY_SYSTEM_ID     = "enterprise_ai_platform:execution:analytics:engine:factory"
...
ACTOR_ENGINE     = "enterprise_ai_platform:execution:analytics:engine"
ACTOR_MANAGER    = "enterprise_ai_platform:execution:analytics:engine:manager"
ACTOR_SCHEDULER  = "enterprise_ai_platform:execution:analytics:engine:scheduler"
ACTOR_DISPATCHER = "enterprise_ai_platform:execution:analytics:engine:dispatcher"
ACTOR_SYSTEM     = "enterprise_ai_platform:system"
