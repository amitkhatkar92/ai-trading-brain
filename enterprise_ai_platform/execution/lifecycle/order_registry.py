"""enterprise_ai_platform/execution/lifecycle/order_registry.py
==================================================
...
from enterprise_ai_platform.investment.workflow.engine_lifecycle import LifecycleAwareMixin, EngineState
