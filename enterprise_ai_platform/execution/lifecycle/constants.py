"""enterprise_ai_platform/execution/lifecycle/constants.py
==================================================
Enumerations and numeric constants for the Order
Lifecycle module.

These are the only definitions of OrderSide, OrderType,
and TimeInForce within enterprise_ai_platform.execution.lifecycle.
...
# ── System identifiers ─────────────────────────────────────────────────────────
LIFECYCLE_SYSTEM_ID = "enterprise_ai_platform:execution:lifecycle"
REGISTRY_SYSTEM_ID  = "enterprise_ai_platform:execution:lifecycle:registry"
FACTORY_SYSTEM_ID   = "enterprise_ai_platform:execution:lifecycle:factory"
VALIDATOR_SYSTEM_ID = "enterprise_ai_platform:execution:lifecycle:validator"
VERSION             = "1.0.0"
