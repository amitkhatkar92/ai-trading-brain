"""enterprise_ai_platform/execution/execution_manager.py"""
...
from enterprise_ai_platform.execution.execution_exceptions      import ExecutionNotFoundError
from enterprise_ai_platform.execution.execution_registry        import ExecutionRegistry
...
class ExecutionManager:
    ...
    def __init__(
        ...
        self._executor   = concurrent.futures.ThreadPoolExecutor(
            ...
            thread_name_prefix="enterprise_ai_platform-execution",
        )
