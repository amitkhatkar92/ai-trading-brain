"""enterprise_ai_platform/execution/execution_registry.py"""
...
from enterprise_ai_platform.execution.execution_constants       import DEFAULT_MAX_SESSIONS, ExecutionStatus
