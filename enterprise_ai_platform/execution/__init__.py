"""
enterprise_ai_platform/execution/__init__.py

Execution Engine — Institutional Execution Platform for IIOS.

Entry points
------------
    from enterprise_ai_platform.execution import get_execution_engine, ExecutionEngine
    from enterprise_ai_platform.execution import ExecutionRequest, ExecutionResult
