"""enterprise_ai_platform/common/errors/exceptions.py
...
Usage::
    ...
    from enterprise_ai_platform.common.errors.exceptions import EngineError, ValidationError

    raise EngineError(
        "Market engine failed to start",
        code        = "ENGINE-START-001",
        context     = {"engine_id": "enterprise_ai_platform:market:integration"},
