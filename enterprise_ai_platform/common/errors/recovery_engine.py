"""enterprise_ai_platform/common/errors/recovery_engine.py
...
Usage::
    ...
    from enterprise_ai_platform.common.errors.recovery_engine import RecoveryEngine, RecoveryStrategy
    from enterprise_ai_platform.common.errors.retry_policy import ExponentialBackoffWithJitter

    engine = RecoveryEngine(
        engine_id   = "enterprise_ai_platform:market:integration",
...
from enterprise_ai_platform.common.errors.retry_policy import NoRetry, RetryPolicy
