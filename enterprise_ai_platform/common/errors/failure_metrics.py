"""enterprise_ai_platform/common/errors/failure_metrics.py
...
Usage::
    ...
    tracker.record_failure("enterprise_ai_platform:market:integration", ValueError)
    tracker.record_retry("enterprise_ai_platform:market:integration")
    tracker.record_recovery("enterprise_ai_platform:market:integration", recovery_time_sec=1.2, succeeded=True)
