"""enterprise_ai_platform/common/errors/error_manager.py
...
Usage::
    ...
    from enterprise_ai_platform.common.errors.error_manager import ErrorManager, get_error_manager
    ...
    recovery = mgr.get_recovery_engine("enterprise_ai_platform:market:intelligence:integration")
...
from enterprise_ai_platform.common.errors.error_context import ErrorContext, get_error_context
from enterprise_ai_platform.common.errors.exceptions import IIOSError
from enterprise_ai_platform.common.errors.failure_metrics import FailureTracker, get_failure_tracker
from enterprise_ai_platform.common.errors.recovery_engine import (
    CircuitBreakerHook,
    DeadLetterHook,
    RecoveryEngine,
)
from enterprise_ai_platform.common.errors.retry_policy import ExponentialBackoffWithJitter, RetryPolicy
...
class ErrorManager:
    ...
    def __init__(
        ...
        self._log   = get_logger(__name__, engine_id="enterprise_ai_platform:error:manager", component="ErrorManager")
        self._audit = get_audit_logger(__name__, engine_id="enterprise_ai_platform:error:manager", component="ErrorManager")
