"""enterprise_ai_platform/common/async_exec/migration_analysis.py
...
class EngineAsyncProfile:
    ...
    ----------
    engine_id:
        Canonical IIOS engine identifier (e.g. ``"enterprise_ai_platform:market:intelligence:integration"``).
    file_path:
...
PLATFORM_ASYNC_PROFILES: Dict[str, EngineAsyncProfile] = {
    ...
    "enterprise_ai_platform:market:intelligence:integration": EngineAsyncProfile(
        engine_id               = "enterprise_ai_platform:market:intelligence:integration",
        file_path               = "enterprise_ai_platform/investment/market/integration/market_intelligence_integration_engine.py",
    ...
    "enterprise_ai_platform:company:intelligence:integration": EngineAsyncProfile(
        engine_id               = "enterprise_ai_platform:company:intelligence:integration",
        file_path               = "enterprise_ai_platform/investment/company/integration/company_intelligence_integration_engine.py",
    ...
    "enterprise_ai_platform:strategy:intelligence:integration": EngineAsyncProfile(
        engine_id               = "enterprise_ai_platform:strategy:intelligence:integration",
        file_path               = "enterprise_ai_platform/investment/strategy/integration/strategy_intelligence_integration_engine.py",
        has_native_async        = True,
        has_own_executor        = False,
    ...
    "enterprise_ai_platform:decision:intelligence:integration": EngineAsyncProfile(
        engine_id               = "enterprise_ai_platform:decision:intelligence:integration",
        file_path               = "enterprise_ai_platform/investment/decision/integration/decision_intelligence_integration_engine.py",
        has_native_async        = True,
        has_own_executor        = False,
        has_daemon_loop         = False,
        methods                 = [
    ...
    "enterprise_ai_platform:portfolio:intelligence:integration": EngineAsyncProfile(
        engine_id               = "enterprise_ai_platform:portfolio:intelligence:integration",
        file_path               = "enterprise_ai_platform/investment/portfolio/integration/portfolio_intelligence_integration_engine.py",
        has_native_async        = False,
        has_own_executor        = False,
        has_daemon_loop         = False,
        methods                 = [],
    ...
    "enterprise_ai_platform:workflow:institutional": EngineAsyncProfile(
        engine_id               = "enterprise_ai_platform:workflow:institutional",
        file_path               = "enterprise_ai_platform/investment/workflow/institutional_investment_workflow.py",
        has_native_async        = False,
        has_own_executor        = False,
        has_daemon_loop         = False,
        methods                 = [],
    ...
    "enterprise_ai_platform:shared:health_monitor": EngineAsyncProfile(
        engine_id               = "enterprise_ai_platform:shared:health_monitor",
        file_path               = "enterprise_ai_platform/investment/shared/health_monitor.py",
        has_native_async        = True,
        has_own_executor        = False,
        has_daemon_loop         = False,
        methods                 = [
