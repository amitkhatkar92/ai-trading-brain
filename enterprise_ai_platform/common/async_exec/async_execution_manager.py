"""enterprise_ai_platform/common/async_exec/async_execution_manager.py
...
Usage (from sync code — most current IIOS engines)::
    ...
    from enterprise_ai_platform.common.async_exec.async_execution_manager import get_execution_manager
...
from enterprise_ai_platform.common.async_exec.timeout_policy import TimeoutPolicy, apply_timeout
