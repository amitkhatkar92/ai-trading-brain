"""enterprise_ai_platform/common/logging/log_rotation.py
...
Usage::
    ...
    from enterprise_ai_platform.common.logging.log_rotation import LogRotationConfig, configure_rotation

    cfg = LogRotationConfig(
        filepath     = "/var/log/enterprise_ai_platform/audit.log",
        max_bytes    = 50 * 1024 * 1024,   # 50 MB
        backup_count = 10,
        compress     = True,
    )
    configure_rotation("enterprise_ai_platform.audit", cfg)
"""
