"""enterprise_ai_platform/common/logging/performance_logger.py
...
Usage::
    ...
    from enterprise_ai_platform.common.logging.performance_logger import get_performance_logger

    perf = get_performance_logger("enterprise_ai_platform.market.integration",
