"""enterprise_ai_platform/common/logging/structured_logger.py
...
Usage::
    ...
    log = StructuredLogger.get("my.module", engine_id="enterprise_ai_platform:my:engine")
...
class JsonFormatter(logging.Formatter):
    ...
    Output format::
        ...
        {"ts":"2026-01-01T00:00:00.123456+00:00","level":"INFO",
         "logger":"enterprise_ai_platform.market.integration","msg":"Engine started",
