"""enterprise_ai_platform/common/logging/logging_manager.py
...
Usage::
    ...
    from enterprise_ai_platform.common.logging.logging_manager import LoggingManager, LoggingConfig

    # One-time initialization at startup
    cfg = LoggingConfig(
        level        = "INFO",
        json_console = True,
        log_file     = "/var/log/enterprise_ai_platform/enterprise_ai_platform.log",
    ...
    log = LoggingManager.get_logger("enterprise_ai_platform.market.integration",
                                    engine_id="enterprise_ai_platform:market:intelligence:integration")
    log.info("Market engine ready")

    # Runtime level override
    LoggingManager.set_level("enterprise_ai_platform.market", "DEBUG")
"""
...
class LoggingConfig:
    ...
    # Per-package level overrides: {"enterprise_ai_platform.market": "DEBUG", ...}
...
def get_logger(
    ...
    *,
    ...
    Intended for use in module-level logger declarations::
        ...
        _log = get_logger(__name__, engine_id="enterprise_ai_platform:market:integration")
    """
