"""
enterprise_ai_platform/observation/classifiers/classification_registry.py
========================================================
...
_LOG  = logging.getLogger("enterprise_ai_platform.observation.classification.registry")
