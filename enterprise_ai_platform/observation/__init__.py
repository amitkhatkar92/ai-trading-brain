"""
enterprise_ai_platform/observation/__init__.py
=============================
Public surface of the Observation Layer.

Preferred import paths::

    from enterprise_ai_platform.observation import get_observation_engine, ObservationType
    from enterprise_ai_platform.observation.observation_constants import ObservationStatus
    from enterprise_ai_platform.observation.models import Observation
"""
