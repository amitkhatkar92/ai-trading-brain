"""
enterprise_ai_platform/observation/collectors/base_collector.py
=============================================
...
_LOG = logging.getLogger("enterprise_ai_platform.collector.base")
...
class BaseCollector(ABC):
    ...
    * ``_do_normalise(raw) -> list[Observation]``  — convert to observations
    ...
    def __init__(self, config: CollectorConfig) -> None:
        self.config      = config
        self._log        = logging.getLogger(f"enterprise_ai_platform.collector.{config.name}")
