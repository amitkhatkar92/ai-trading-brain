...
**Module:** `enterprise_ai_platform.workflow.snapshot`
...
```python
from enterprise_ai_platform.workflow.snapshot import WorkflowSnapshotFactory, WorkflowSnapshotValidation
