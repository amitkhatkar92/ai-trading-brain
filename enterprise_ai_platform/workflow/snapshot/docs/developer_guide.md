...
```
enterprise_ai_platform/workflow/snapshot/
...
# With coverage
python -m pytest tests/unit/workflow/test_workflow_snapshot_m5.py --cov=enterprise_ai_platform/workflow/snapshot --cov-report=term-missing
```
