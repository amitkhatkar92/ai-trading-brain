"""
workflow_request.py — enterprise_ai_platform.workflow.engine
-------------------------------------------
...
from enterprise_ai_platform.workflow.lifecycle import WorkflowPriority, WorkflowType
...
class WorkflowEngineRequest:
    ...
    def create(
        ...
        *,
        ...
        enterprise_id:    str                        = "enterprise_ai_platform",
        correlation_id:   str                        = "",
        trace_id:         str                        = "",
    ...
    def from_dict(cls, d: Dict[str, Any]) -> "WorkflowEngineRequest":
        return cls(
            ...
            enterprise_id    = d.get("enterprise_id", "enterprise_ai_platform"),
