"""
workflow_component_factory.py — enterprise_ai_platform.workflow.gateway
------------------------------------------------------
...
class WorkflowComponentFactory:
    ...
    def create_engine(self) -> Any:
        from enterprise_ai_platform.workflow.engine import WorkflowEngine
    ...
    def create_policy_engine(self) -> Any:
        from enterprise_ai_platform.workflow.policies import WorkflowPolicyEngine
    ...
    def create_orchestration_engine(self) -> Any:
        from enterprise_ai_platform.workflow.orchestration import WorkflowOrchestrationEngine
    ...
    def create_snapshot_builder(self) -> Any:
        from enterprise_ai_platform.workflow.snapshot import WorkflowSnapshotBuilder
    ...
    def create_snapshot_factory(self) -> Any:
        from enterprise_ai_platform.workflow.snapshot import WorkflowSnapshotFactory
