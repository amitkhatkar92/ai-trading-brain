...
**Module:** `enterprise_ai_platform.workflow.gateway`
...
- M1 — Workflow Lifecycle (`enterprise_ai_platform.workflow.lifecycle`)
- M2 — Workflow Engine (`enterprise_ai_platform.workflow.engine`)
- M3 — Workflow Governance Policy Framework (`enterprise_ai_platform.workflow.policies`)
- M4 — Workflow Orchestration Framework (`enterprise_ai_platform.workflow.orchestration`)
- M5 — Workflow Snapshot (`enterprise_ai_platform.workflow.snapshot`)
...
```python
from enterprise_ai_platform.workflow.gateway import WorkflowGateway, WorkflowGatewayFactory
...
All services in `enterprise_ai_platform.workflow.gateway` are thread-safe.
