"""
workflow_gateway_dispatcher.py — enterprise_ai_platform.workflow.gateway
-------------------------------------------------------
...
class WorkflowGatewayDispatcher:
    ...
    def _handle_submit(
        ...
        if engine is not None:
            from enterprise_ai_platform.workflow.engine import WorkflowEngineRequest
            from enterprise_ai_platform.workflow.lifecycle import WorkflowType as M1Type
        ...
        if snap_factory is not None and not snapshot_id:
            from enterprise_ai_platform.workflow.snapshot import ExecutionStatus, GovernanceDecision
            exec_status = (
