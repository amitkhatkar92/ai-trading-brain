...
The **Workflow Governance Policy Framework** (`enterprise_ai_platform.workflow.policies`) provides
...
```
enterprise_ai_platform/workflow/policies/
├── __init__.py
...
5. **No vendor SDK** — pure Python; no external library dependencies beyond `enterprise_ai_platform.common`
