...
**Package**: `enterprise_ai_platform.workflow.lifecycle`  
...
```python
from enterprise_ai_platform.workflow.lifecycle import WorkflowLifecycle, WorkflowMetadata, WorkflowType
