"""enterprise_ai_platform/investment/strategy/risk/risk_policy.py
...
from enterprise_ai_platform.investment.strategy.risk.stress_scenarios import StressScenario, BUILTIN_SCENARIOS
