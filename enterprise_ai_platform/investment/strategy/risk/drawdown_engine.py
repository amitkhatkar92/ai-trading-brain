"""enterprise_ai_platform/investment/strategy/risk/drawdown_engine.py
...
from enterprise_ai_platform.investment.strategy.risk.recovery_analysis import RecoveryAnalysis, RecoveryReport
