"""enterprise_ai_platform/investment/strategy/opportunity/ranking_engine.py
...
from enterprise_ai_platform.investment.strategy.opportunity.strategy_opportunity import StrategyOpportunity
