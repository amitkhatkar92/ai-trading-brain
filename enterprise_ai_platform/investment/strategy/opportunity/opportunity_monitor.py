"""enterprise_ai_platform/investment/strategy/opportunity/opportunity_monitor.py
...
from enterprise_ai_platform.investment.strategy.opportunity.change_detector import ChangeDetector, ChangeEvent
