"""enterprise_ai_platform/investment/strategy/opportunity/compatibility_engine.py
...
from enterprise_ai_platform.investment.strategy.opportunity.market_opportunity import MarketOpportunity
...
class CompatibilityEngine:
    ...
    def _exec_readiness(c: StrategyCandidate) -> float:
        from enterprise_ai_platform.investment.strategy.opportunity.suitability_statistics import execution_readiness_score
