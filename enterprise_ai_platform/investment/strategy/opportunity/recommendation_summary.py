"""enterprise_ai_platform/investment/strategy/opportunity/recommendation_summary.py
...
from enterprise_ai_platform.investment.strategy.opportunity.evidence_collector import EvidenceBundle
