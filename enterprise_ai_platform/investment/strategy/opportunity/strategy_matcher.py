"""enterprise_ai_platform/investment/strategy/opportunity/strategy_matcher.py
...
from enterprise_ai_platform.investment.strategy.opportunity.matching_profile import MatchingProfile
