"""enterprise_ai_platform/investment/strategy/performance/performance_tracker.py
...
from enterprise_ai_platform.investment.strategy.strategy_constants import DEFAULT_HISTORY_SIZE
...
class StrategyStatistics:
    ...
    def has_enough_data(self) -> bool:
        from enterprise_ai_platform.investment.strategy.strategy_constants import MIN_TRADES_FOR_EVAL
