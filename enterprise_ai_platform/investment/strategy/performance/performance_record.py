"""enterprise_ai_platform/investment/strategy/performance/performance_record.py
...
from enterprise_ai_platform.investment.strategy.strategy_constants import MarketRegime
