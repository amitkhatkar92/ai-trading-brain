"""enterprise_ai_platform/investment/strategy/lifecycle/lifecycle_history.py
...
from enterprise_ai_platform.investment.strategy.strategy_constants import LifecycleEvent, StrategyStatus
