"""enterprise_ai_platform/investment/strategy/lifecycle/strategy_lifecycle_engine.py
...
from enterprise_ai_platform.investment.strategy.lifecycle.dependency_registry import DependencyType
...
from enterprise_ai_platform.investment.strategy.lifecycle.runtime_manager import RuntimeManager
from enterprise_ai_platform.investment.strategy.lifecycle.runtime_state import (
    RuntimeState,
    RuntimeStateSnapshot,
)
from enterprise_ai_platform.investment.strategy.lifecycle.runtime_statistics import CycleSample
...
class StrategyLifecycleEngine:
    ...
    def __init__(
        ...
        self._pool = ThreadPoolExecutor(
            ...
            thread_name_prefix="enterprise_ai_platform-engine",
        )
