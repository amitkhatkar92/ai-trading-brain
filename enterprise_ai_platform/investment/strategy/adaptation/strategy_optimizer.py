"""enterprise_ai_platform/investment/strategy/adaptation/strategy_optimizer.py
...
from enterprise_ai_platform.investment.strategy.strategy_constants import AdaptationType
