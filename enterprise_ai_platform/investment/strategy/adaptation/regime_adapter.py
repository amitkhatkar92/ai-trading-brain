"""enterprise_ai_platform/investment/strategy/adaptation/regime_adapter.py
...
from enterprise_ai_platform.investment.strategy.strategy_constants import AdaptationType, MarketRegime
