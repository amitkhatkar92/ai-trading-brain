"""enterprise_ai_platform/investment/strategy/debate/debate_orchestrator.py
...
from enterprise_ai_platform.investment.strategy.debate.debate_constants import DebateEventType, DebatePhase
...
from enterprise_ai_platform.investment.strategy.debate.participant_roles import BaseDebateAgent
...
from enterprise_ai_platform.investment.strategy.debate.argument_manager import Argument, Rebuttal
...
class DebateOrchestrator:
    ...
    async def _phase_consensus(
        ...
        from enterprise_ai_platform.investment.strategy.debate.voting_engine import Vote as VoteT
        for v in results:
