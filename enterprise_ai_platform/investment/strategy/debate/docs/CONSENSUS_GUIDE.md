...
```python
from enterprise_ai_platform.investment.strategy.debate import ConsensusPolicy, VotingMechanism
...
```python
from enterprise_ai_platform.investment.strategy.debate import AgreementAnalysis
