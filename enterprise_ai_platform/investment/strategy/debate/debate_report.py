"""enterprise_ai_platform/investment/strategy/debate/debate_report.py
...
from enterprise_ai_platform.investment.strategy.debate.argument_manager import Argument
from enterprise_ai_platform.investment.strategy.debate.consensus_engine import ConsensusResult
from enterprise_ai_platform.investment.strategy.debate.debate_constants import DebateStatus, ConsensusLevel
from enterprise_ai_platform.investment.strategy.debate.executive_summary import ExecutiveSummary
from enterprise_ai_platform.investment.strategy.debate.debate_explanation import DebateExplanation
from enterprise_ai_platform.investment.strategy.debate.recommendation_summary import RecommendationSummary
...
def build_report(session, debate_id: Optional[str] = None) -> DebateReport:
    ...
    """
    from enterprise_ai_platform.investment.strategy.debate.argument_manager import ArgumentType
    from enterprise_ai_platform.investment.strategy.debate.executive_summary import ExecutiveSummaryBuilder
    from enterprise_ai_platform.investment.strategy.debate.debate_explanation import DebateExplainer
    from enterprise_ai_platform.investment.strategy.debate.recommendation_summary import build_recommendation_summary
