"""enterprise_ai_platform/investment/strategy/debate/debate_events.py
...
from enterprise_ai_platform.investment.strategy.debate.debate_constants import DebateEventType
