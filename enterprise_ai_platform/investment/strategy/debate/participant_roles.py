"""enterprise_ai_platform/investment/strategy/debate/participant_roles.py
...
if TYPE_CHECKING:
    ...
    from enterprise_ai_platform.investment.strategy.debate.evidence_registry import Evidence, EvidenceRegistry
