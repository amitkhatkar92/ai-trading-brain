"""enterprise_ai_platform/investment/strategy/debate/evidence_validator.py
...
from enterprise_ai_platform.investment.strategy.debate.evidence_registry import Evidence
