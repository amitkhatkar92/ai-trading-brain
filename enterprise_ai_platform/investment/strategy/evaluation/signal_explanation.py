"""enterprise_ai_platform/investment/strategy/evaluation/signal_explanation.py
...
class SignalExplainer:
    ...
    def explain(self, trades: List[Trade]) -> SignalExplanation:
        ...
        if mean_abs > 0:
            from enterprise_ai_platform.investment.strategy.evaluation.performance_statistics import safe_std
