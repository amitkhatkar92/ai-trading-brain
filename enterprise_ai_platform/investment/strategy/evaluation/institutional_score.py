"""enterprise_ai_platform/investment/strategy/evaluation/institutional_score.py
...
from enterprise_ai_platform.investment.strategy.evaluation.approval_engine import ApprovalStatus
from enterprise_ai_platform.investment.strategy.evaluation.performance_statistics import clamp
...
class InstitutionalStrategyScore:
    ...
    def compute(
        ...
        *,
        ...
        from enterprise_ai_platform.investment.strategy.evaluation.performance_statistics import scale_metric
