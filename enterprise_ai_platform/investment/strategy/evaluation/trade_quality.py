"""enterprise_ai_platform/investment/strategy/evaluation/trade_quality.py
...
from enterprise_ai_platform.investment.strategy.evaluation.trade_statistics import (
    TradeStatistics, TradeStatisticsCalculator
)
from enterprise_ai_platform.investment.strategy.evaluation.execution_quality import (
    ExecutionMetrics, ExecutionQualityAnalyzer
)
from enterprise_ai_platform.investment.strategy.evaluation.trade_distribution import (
