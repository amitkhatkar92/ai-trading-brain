"""enterprise_ai_platform/investment/strategy/core/strategy_profile.py
...
from enterprise_ai_platform.investment.strategy.strategy_constants import StrategyStatus
