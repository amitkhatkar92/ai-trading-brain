"""enterprise_ai_platform/investment/strategy/core/strategy_history.py
...
from enterprise_ai_platform.investment.strategy.strategy_constants import DEFAULT_SNAPSHOT_HISTORY
