"""enterprise_ai_platform/investment/strategy/integration/validation_report.py
...
from enterprise_ai_platform.investment.strategy.integration.integration_constants import ValidationStatus
