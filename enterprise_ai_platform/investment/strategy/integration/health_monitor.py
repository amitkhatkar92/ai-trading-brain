"""enterprise_ai_platform/investment/strategy/integration/health_monitor.py
...
from enterprise_ai_platform.investment.strategy.integration.coverage_monitor import CoverageMonitor, CoverageReport
