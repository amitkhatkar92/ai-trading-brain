"""enterprise_ai_platform/investment/strategy/integration/strategy_statistics.py
...
from enterprise_ai_platform.investment.strategy.integration.aggregation_state import IntelligenceUpdate
