"""enterprise_ai_platform/investment/strategy/learning/failure_library.py
...
from enterprise_ai_platform.investment.strategy.learning.lesson_registry import Lesson, LessonCategory
