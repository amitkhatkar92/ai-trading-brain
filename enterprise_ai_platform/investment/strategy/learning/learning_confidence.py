"""enterprise_ai_platform/investment/strategy/learning/learning_confidence.py
...
class LearningConfidence:
    ...
    def compute(
        ...
        from enterprise_ai_platform.investment.strategy.learning.learning_statistics import consistency_score
