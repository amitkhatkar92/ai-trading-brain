"""enterprise_ai_platform/investment/strategy/migration/migration_steps.py
...
from enterprise_ai_platform.investment.strategy.migration.migration_status import MigrationPhase
