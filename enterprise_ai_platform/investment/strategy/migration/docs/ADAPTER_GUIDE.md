...
```python
from enterprise_ai_platform.investment.strategy.migration import AdapterFactory
...
### Manual construction
```python
from enterprise_ai_platform.investment.strategy.migration import LegacyStrategyAdapter, AdaptationMode
...
```python
from enterprise_ai_platform.investment.strategy.migration import AdapterRegistry
