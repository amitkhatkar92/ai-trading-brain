...
```python
from enterprise_ai_platform.investment.strategy.migration import CompatibilityValidator
...
```python
from enterprise_ai_platform.investment.strategy.migration import CompatibilityLayer
