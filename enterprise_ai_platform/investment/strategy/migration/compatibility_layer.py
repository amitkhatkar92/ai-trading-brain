"""enterprise_ai_platform/investment/strategy/migration/compatibility_layer.py
...
class CompatibilityLayer:
    ...
    def infer_category(strategy_name: str, raw_category: str) -> StrategyCategory:
        ...
        from enterprise_ai_platform.investment.strategy.strategy_constants import StrategyCategory as SC
