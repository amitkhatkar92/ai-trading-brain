"""enterprise_ai_platform/investment/strategy/migration/signal_equivalence.py
...
from enterprise_ai_platform.investment.strategy.migration.signal_comparator import SignalComparator
