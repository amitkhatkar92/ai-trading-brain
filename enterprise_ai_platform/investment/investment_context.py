"""enterprise_ai_platform/investment/investment_context.py
...
from enterprise_ai_platform.investment.investment_constants import InvestmentObjective, WorkflowStatus
