"""enterprise_ai_platform/investment/company/models/company_intelligence.py"""
...
from enterprise_ai_platform.investment.company.models.company_signal import CompanySignal
