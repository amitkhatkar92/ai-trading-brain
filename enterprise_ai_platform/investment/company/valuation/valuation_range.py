"""enterprise_ai_platform/investment/company/valuation/valuation_range.py
...
from enterprise_ai_platform.investment.company.valuation.fair_value_estimate import ValuationRange
