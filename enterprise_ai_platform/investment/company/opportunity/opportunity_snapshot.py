"""enterprise_ai_platform/investment/company/opportunity/opportunity_snapshot.py
...
from enterprise_ai_platform.investment.company.opportunity.ranking_score import RankingResult
