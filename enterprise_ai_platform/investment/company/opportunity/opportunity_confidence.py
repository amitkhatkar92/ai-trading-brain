"""enterprise_ai_platform/investment/company/opportunity/opportunity_confidence.py
...
from enterprise_ai_platform.investment.company.opportunity.opportunity_statistics import clamp
