"""enterprise_ai_platform/investment/company/opportunity/explanation_engine.py
...
from enterprise_ai_platform.investment.company.opportunity.evidence_collector import collect_all_evidence
