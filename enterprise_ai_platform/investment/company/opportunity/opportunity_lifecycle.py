"""enterprise_ai_platform/investment/company/opportunity/opportunity_lifecycle.py
...
from enterprise_ai_platform.investment.company.opportunity.opportunity_profile import OpportunityLifecycle
