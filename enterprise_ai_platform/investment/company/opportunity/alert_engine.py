"""enterprise_ai_platform/investment/company/opportunity/alert_engine.py
...
from enterprise_ai_platform.investment.company.opportunity.change_detector import ChangeRecord
