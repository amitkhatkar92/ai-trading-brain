"""enterprise_ai_platform/investment/company/opportunity/evidence_collector.py
...
from enterprise_ai_platform.investment.company.opportunity.investment_thesis import ThesisEvidence
