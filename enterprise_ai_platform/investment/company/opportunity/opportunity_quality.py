"""enterprise_ai_platform/investment/company/opportunity/opportunity_quality.py
...
from enterprise_ai_platform.investment.company.opportunity.opportunity_statistics import clamp, safe_float
