"""enterprise_ai_platform/investment/company/governance/governance_engine.py
...
from enterprise_ai_platform.investment.company.governance.board_analysis import (
    score_board_independence_full, score_board_diversity, score_board_size,
)
from enterprise_ai_platform.investment.company.governance.committee_analysis import score_committee_quality
