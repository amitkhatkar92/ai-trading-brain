"""enterprise_ai_platform/investment/company/governance/management_snapshot.py
...
from enterprise_ai_platform.investment.company.governance.executive_profile import ExecutiveTeamProfile
