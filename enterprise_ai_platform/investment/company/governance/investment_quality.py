"""enterprise_ai_platform/investment/company/governance/investment_quality.py
...
from enterprise_ai_platform.investment.company.governance.management_statistics import clamp, score_roic
