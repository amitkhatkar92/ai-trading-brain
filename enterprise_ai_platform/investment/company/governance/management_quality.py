"""enterprise_ai_platform/investment/company/governance/management_quality.py
...
from enterprise_ai_platform.investment.company.governance.leadership_effectiveness import (
    score_execution_from_financials, score_strategic_consistency,
    score_long_term_orientation, score_management_credibility,
)
from enterprise_ai_platform.investment.company.governance.execution_quality import score_execution_quality
from enterprise_ai_platform.investment.company.governance.decision_quality import score_decision_quality
