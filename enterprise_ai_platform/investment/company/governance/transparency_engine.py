"""enterprise_ai_platform/investment/company/governance/transparency_engine.py
...
from enterprise_ai_platform.investment.company.governance.governance_events import GovernanceEventLog
from enterprise_ai_platform.investment.company.governance.disclosure_quality import (
    score_disclosure_quality, score_reporting_transparency,
)
from enterprise_ai_platform.investment.company.governance.compliance_tracker import score_compliance
from enterprise_ai_platform.investment.company.governance.ethics_profile import score_accounting_integrity
