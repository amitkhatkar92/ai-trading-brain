"""enterprise_ai_platform/investment/company/earnings/cost_efficiency.py
...
from enterprise_ai_platform.investment.company.earnings.earnings_statistics import safe_mean, _clean
