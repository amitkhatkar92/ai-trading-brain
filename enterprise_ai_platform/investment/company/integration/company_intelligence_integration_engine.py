"""enterprise_ai_platform/investment/company/integration/company_intelligence_integration_engine.py
...
from enterprise_ai_platform.investment.company.integration.aggregation_engine import AggregationEngine
from enterprise_ai_platform.investment.company.integration.aggregation_history import AggregationHistory
from enterprise_ai_platform.investment.company.integration.aggregation_state import AggregationState
...
from enterprise_ai_platform.investment.company.integration.company_state import KNOWN_ENGINES, SCORED_ENGINES
from enterprise_ai_platform.investment.company.integration.company_statistics import clamp
...
from enterprise_ai_platform.investment.company.integration.quality_history import QualityHistory
...
_log = get_logger(__name__, engine_id="enterprise_ai_platform:company:intelligence:integration")
...
class CompanyIntelligenceIntegrationEngine(LifecycleAwareMixin):
    ...
    VERSION   = "1.0.0"
    SYSTEM_ID = "enterprise_ai_platform:company:intelligence:integration"
