"""enterprise_ai_platform/investment/company/integration/company_quality.py
...
from enterprise_ai_platform.investment.company.integration.quality_history import QualityHistory, QualityRecord
