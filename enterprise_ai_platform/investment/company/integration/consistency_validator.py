"""enterprise_ai_platform/investment/company/integration/consistency_validator.py
...
from enterprise_ai_platform.investment.company.integration.validation_report import ValidationCheck, ValidationReport
