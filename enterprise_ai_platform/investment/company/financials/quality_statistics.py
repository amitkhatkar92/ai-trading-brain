"""enterprise_ai_platform/investment/company/financials/quality_statistics.py
...
from enterprise_ai_platform.investment.company.financials.statement_consistency import ConsistencyReport
