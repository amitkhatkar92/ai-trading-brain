"""enterprise_ai_platform/investment/company/financials/financial_statement.py
...
from enterprise_ai_platform.investment.company.financials.financial_period import FinancialPeriod
