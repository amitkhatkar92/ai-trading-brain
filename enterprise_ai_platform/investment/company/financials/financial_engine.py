"""enterprise_ai_platform/investment/company/financials/financial_engine.py
...
from enterprise_ai_platform.investment.company.company_constants import FinancialHealth, GrowthProfile
