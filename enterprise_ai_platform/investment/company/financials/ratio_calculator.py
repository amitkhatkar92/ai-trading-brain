"""enterprise_ai_platform/investment/company/financials/ratio_calculator.py
...
from enterprise_ai_platform.investment.company.financials.financial_ratios import RatioCategory, RatioResult
