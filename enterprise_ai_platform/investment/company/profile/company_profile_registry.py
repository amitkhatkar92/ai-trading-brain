"""enterprise_ai_platform/investment/company/profile/company_registry.py
...
from enterprise_ai_platform.investment.company.profile.models import CompanyProfile, ListingStatus
