"""enterprise_ai_platform/investment/company/profile/identity_utils.py
...
from enterprise_ai_platform.investment.company.profile.models import CompanyIdentity
