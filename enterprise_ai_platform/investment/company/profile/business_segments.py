"""enterprise_ai_platform/investment/company/profile/business_segments.py
...
from enterprise_ai_platform.investment.company.profile.models import BusinessSegment
