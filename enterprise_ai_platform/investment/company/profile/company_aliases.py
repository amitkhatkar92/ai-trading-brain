"""enterprise_ai_platform/investment/company/profile/company_aliases.py
...
from enterprise_ai_platform.investment.company.profile.models import AliasType, CompanyAlias
