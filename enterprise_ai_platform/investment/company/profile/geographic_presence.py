"""enterprise_ai_platform/investment/company/profile/geographic_presence.py
...
from enterprise_ai_platform.investment.company.profile.models import GeographicPresence, OperationsType
