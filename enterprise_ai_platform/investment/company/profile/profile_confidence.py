"""enterprise_ai_platform/investment/company/profile/profile_confidence.py
...
from enterprise_ai_platform.investment.company.profile.models import CompanyProfile
