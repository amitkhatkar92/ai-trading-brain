"""enterprise_ai_platform/investment/company/profile/profile_statistics.py
...
from enterprise_ai_platform.investment.company.profile.models import CompanyProfile, ProfileQualityScore
