"""enterprise_ai_platform/investment/company/profile/company_profile_engine.py
...
from enterprise_ai_platform.investment.company.profile.company_profile_registry import CompanyProfileRegistry
