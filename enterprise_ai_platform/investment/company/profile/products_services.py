"""enterprise_ai_platform/investment/company/profile/products_services.py
...
from enterprise_ai_platform.investment.company.profile.models import Product, Service
