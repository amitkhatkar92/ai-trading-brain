"""enterprise_ai_platform/investment/company/profile/subsidiaries.py
...
from enterprise_ai_platform.investment.company.profile.models import RelationshipType, Subsidiary
