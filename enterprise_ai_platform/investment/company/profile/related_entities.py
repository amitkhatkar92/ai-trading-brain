"""enterprise_ai_platform/investment/company/profile/related_entities.py
...
from enterprise_ai_platform.investment.company.profile.models import RelatedEntity, RelationshipType
