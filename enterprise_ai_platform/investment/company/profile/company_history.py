"""enterprise_ai_platform/investment/company/profile/company_history.py
...
from enterprise_ai_platform.investment.company.company_constants import DEFAULT_SNAPSHOT_HISTORY
