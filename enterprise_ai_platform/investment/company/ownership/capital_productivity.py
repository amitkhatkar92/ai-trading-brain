"""enterprise_ai_platform/investment/company/ownership/capital_productivity.py
...
from enterprise_ai_platform.investment.company.ownership.capital_efficiency import score_invested_capital_productivity
...
def score_reinvestment_effectiveness(
    ...
    if avg_roic is not None:
        from enterprise_ai_platform.investment.company.ownership.ownership_statistics import score_roic_spread
