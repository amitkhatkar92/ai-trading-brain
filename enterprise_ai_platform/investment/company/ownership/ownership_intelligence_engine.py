"""enterprise_ai_platform/investment/company/ownership/ownership_intelligence_engine.py
PRIMARY ENGINE — Institutional Ownership & Capital Allocation Intelligence Engine.

Consumes:
  • FinancialSnapshot         (enterprise_ai_platform.investment.company.financials)
  • EarningsSnapshot          (enterprise_ai_platform.investment.company.earnings)
  • BusinessQualitySnapshot   (enterprise_ai_platform.investment.company.business_quality)
  • ValuationSnapshot         (enterprise_ai_platform.investment.company.valuation)     [optional]
  • GrowthSnapshot            (enterprise_ai_platform.investment.company.growth)        [optional]
  • ManagementSnapshot        (enterprise_ai_platform.investment.company.governance)    [optional]
...
from enterprise_ai_platform.investment.company.ownership.ownership_snapshot import OwnershipSnapshot
from enterprise_ai_platform.investment.company.ownership.ownership_history import OwnershipHistory
...
from enterprise_ai_platform.investment.company.ownership.capital_allocation_engine import (
...
from enterprise_ai_platform.investment.company.ownership.ownership_score import compute_ownership_score
from enterprise_ai_platform.investment.company.ownership.ownership_quality import compute_ownership_quality_score
from enterprise_ai_platform.investment.company.ownership.capital_allocation_score import compute_capital_allocation_score
from enterprise_ai_platform.investment.company.ownership.ownership_confidence import compute_ownership_confidence
from enterprise_ai_platform.investment.company.ownership.ownership_plugin import (
    OwnershipPlugin, OwnershipPluginRegistry,
)
from enterprise_ai_platform.investment.company.ownership.ownership_statistics import clamp
