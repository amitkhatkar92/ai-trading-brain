"""enterprise_ai_platform/investment/company/ownership/shareholder_analysis.py
...
def _classify_institutional_participation(pct: Optional[float]) -> InstitutionalParticipationLabel:
    from enterprise_ai_platform.investment.company.ownership.ownership_statistics import pct_to_100
    if pct is None:
