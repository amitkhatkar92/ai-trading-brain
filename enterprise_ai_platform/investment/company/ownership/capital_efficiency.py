"""enterprise_ai_platform/investment/company/ownership/capital_efficiency.py
...
from enterprise_ai_platform.investment.company.ownership.ownership_statistics import clamp, score_roic_spread
