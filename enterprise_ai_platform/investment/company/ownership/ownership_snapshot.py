"""enterprise_ai_platform/investment/company/ownership/ownership_snapshot.py
...
class OwnershipSnapshot:
    ...
    def has_high_ownership_risk(self) -> bool:
        from enterprise_ai_platform.investment.company.ownership.ownership_profile import OwnershipRiskLabel
