"""enterprise_ai_platform/investment/company/ownership/ownership_stability.py
...
from enterprise_ai_platform.investment.company.ownership.ownership_profile import PromoterStabilityLabel
...
def score_promoter_conviction(
    ...
    """
    from enterprise_ai_platform.investment.company.ownership.ownership_statistics import score_promoter_holding
