"""enterprise_ai_platform/investment/company/ownership/insider_activity.py
...
from enterprise_ai_platform.investment.company.ownership.insider_transactions import build_transaction_log
