"""enterprise_ai_platform/investment/company/business_quality/revenue_model.py
...
from enterprise_ai_platform.investment.company.business_quality.business_model import RevenueVisibilityLabel
