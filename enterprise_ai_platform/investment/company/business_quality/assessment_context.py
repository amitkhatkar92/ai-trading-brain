"""enterprise_ai_platform/investment/company/business_quality/assessment_context.py
...
class AssessmentContext:
    ...
    """
    ticker:             str
    financial_snapshot: Any = None    # enterprise_ai_platform.investment.company.financials.FinancialSnapshot
    earnings_snapshot:  Any = None    # enterprise_ai_platform.investment.company.earnings.EarningsSnapshot
