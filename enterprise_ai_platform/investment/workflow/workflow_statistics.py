"""enterprise_ai_platform/investment/workflow/workflow_statistics.py
...
from enterprise_ai_platform.investment.workflow.workflow_types import PIPELINE_STAGES, WorkflowStage
