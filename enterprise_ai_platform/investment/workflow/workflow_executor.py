"""enterprise_ai_platform/investment/workflow/workflow_executor.py
...
class WorkflowExecutor:
    ...
    def execute(
        ...
        from enterprise_ai_platform.investment.models.investment_context_model import InvestmentContext as _IC  # noqa: PLC0415
        ctx = context or _IC(
