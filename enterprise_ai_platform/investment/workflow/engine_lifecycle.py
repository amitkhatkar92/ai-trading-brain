...
Usage::
    ...
    class MyEngine(LifecycleAwareMixin):
        VERSION   = "1.0.0"
        SYSTEM_ID = "enterprise_ai_platform:my:engine"
...
from enterprise_ai_platform.common.logging.logging_manager import get_logger as _get_iios_logger
from enterprise_ai_platform.common.logging.audit_logger import get_audit_logger as _get_audit_logger
from enterprise_ai_platform.common.errors.error_context import ErrorContext, bind_error_context
from enterprise_ai_platform.common.errors.error_manager import get_error_manager as _get_error_manager
from enterprise_ai_platform.common.async_exec.async_execution_manager import get_execution_manager as _get_exec_manager

_log = _get_iios_logger(__name__, engine_id="enterprise_ai_platform:lifecycle")
_audit = _get_audit_logger(__name__, engine_id="enterprise_ai_platform:lifecycle", component="engine_lifecycle")
