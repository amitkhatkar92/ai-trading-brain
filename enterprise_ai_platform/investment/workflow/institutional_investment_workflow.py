"""enterprise_ai_platform/investment/workflow/institutional_investment_workflow.py
...
from enterprise_ai_platform.investment.investment_constants import IntelligenceType
...
from enterprise_ai_platform.investment.workflow.investment_workflow import InvestmentWorkflow
...
class InstitutionalWorkflowOrchestrator(LifecycleAwareMixin):
    ...
    VERSION   = WORKFLOW_VERSION
    SYSTEM_ID = "enterprise_ai_platform:workflow:institutional"
    ...
    def _stage_portfolio(
        ...
        from enterprise_ai_platform.investment.portfolio.integration.integration_types import EngineId
