"""enterprise_ai_platform/investment/market/market_registry.py
...
from enterprise_ai_platform.investment.market.market_constants import DEFAULT_MAX_ANALYZERS, DEFAULT_MAX_MARKETS
