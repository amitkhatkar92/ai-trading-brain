"""enterprise_ai_platform/investment/market/correlation/regime_transition.py
...
from enterprise_ai_platform.investment.market.correlation.correlation_regime import regime_severity
