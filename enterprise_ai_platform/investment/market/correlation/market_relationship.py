"""enterprise_ai_platform/investment/market/correlation/market_relationship.py
...
from enterprise_ai_platform.investment.market.correlation.models import AssetClass, RelationshipType
