"""enterprise_ai_platform/investment/market/sector_rotation/sector_transition.py
...
from enterprise_ai_platform.investment.market.sector_rotation.models import SectorEvent, SectorEventType, SectorStage
