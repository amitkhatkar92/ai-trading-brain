"""enterprise_ai_platform/investment/market/sector_rotation/flow_profile.py
...
from enterprise_ai_platform.investment.market.sector_rotation.sector_performance import _breadth
