"""enterprise_ai_platform/investment/market/sector_rotation/rotation_statistics.py
...
from enterprise_ai_platform.investment.market.sector_rotation.models import RotationSignal, RotationType
