"""enterprise_ai_platform/investment/market/sector_rotation/sector_history.py
...
from enterprise_ai_platform.investment.market.sector_rotation.models import SectorIntelligenceSnapshot
