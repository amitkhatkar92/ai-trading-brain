"""enterprise_ai_platform/investment/market/sector_rotation/industry_history.py
...
from enterprise_ai_platform.investment.market.sector_rotation.models import IndustryProfile
