"""enterprise_ai_platform/investment/market/sector_rotation/sector_taxonomy.py
...
from enterprise_ai_platform.investment.market.sector_rotation.models import SectorCharacter, TaxonomyType
