"""enterprise_ai_platform/investment/market/sector_rotation/__init__.py
...
from enterprise_ai_platform.investment.market.sector_rotation.sector_rotation_engine import (
