"""enterprise_ai_platform/investment/market/structure/trend_transition.py
...
from enterprise_ai_platform.investment.market.structure.models import Bar, SwingSequence, TrendTransition
