"""enterprise_ai_platform/investment/market/structure/structure_analyzer.py
...
from enterprise_ai_platform.investment.market.structure.models import Bar, SwingPoint
