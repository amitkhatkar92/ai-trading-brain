"""enterprise_ai_platform/investment/market/structure/structure_score.py
...
from enterprise_ai_platform.investment.market.structure.models import StructureQualityScore
