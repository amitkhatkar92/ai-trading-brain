"""enterprise_ai_platform/investment/market/structure/zone_registry.py
...
from enterprise_ai_platform.investment.market.structure.models import Zone, ZoneType
