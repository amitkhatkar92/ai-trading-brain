"""enterprise_ai_platform/investment/market/structure/trend_strength.py
...
from enterprise_ai_platform.investment.market.structure.models import SwingPoint, SwingSequence, SwingType
