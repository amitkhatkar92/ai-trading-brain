"""enterprise_ai_platform/investment/market/structure/consolidation_engine.py
...
from enterprise_ai_platform.investment.market.structure.models import Bar, ConsolidationState, ConsolidationType
