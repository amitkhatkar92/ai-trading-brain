"""enterprise_ai_platform/investment/market/structure/zone_strength.py
...
from enterprise_ai_platform.investment.market.structure.models import Bar, Zone, ZoneStrength, ZoneType
