"""enterprise_ai_platform/investment/market/breadth/leadership_analysis.py
...
from enterprise_ai_platform.investment.market.breadth.models import ParticipationSnapshot
