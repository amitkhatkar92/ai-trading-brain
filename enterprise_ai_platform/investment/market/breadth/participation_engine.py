"""enterprise_ai_platform/investment/market/breadth/participation_engine.py
...
from enterprise_ai_platform.investment.market.breadth.models import ParticipationSnapshot, UniverseSnapshot
