"""enterprise_ai_platform/investment/market/breadth/participation_rate_metric.py
...
from enterprise_ai_platform.investment.market.breadth.models import BreadthMetricValue

if TYPE_CHECKING:
    from enterprise_ai_platform.investment.market.breadth.models import SecurityObservation
