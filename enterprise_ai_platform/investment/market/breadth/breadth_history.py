"""enterprise_ai_platform/investment/market/breadth/breadth_history.py
...
if TYPE_CHECKING:
    from enterprise_ai_platform.investment.market.breadth.models import BreadthIntelligenceSnapshot
