"""enterprise_ai_platform/investment/market/breadth/breadth_state.py
...
from enterprise_ai_platform.investment.market.breadth.models import BreadthData, BreadthTrend
