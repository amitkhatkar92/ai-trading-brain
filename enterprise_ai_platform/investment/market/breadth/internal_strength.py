"""enterprise_ai_platform/investment/market/breadth/internal_strength.py
Internal market strength calculation from breadth and participation data.
"""
from __future__ import annotations

from enterprise_ai_platform.investment.market.breadth.models import BreadthData, ParticipationSnapshot
