"""enterprise_ai_platform/investment/market/breadth/breadth_transition.py
...
from enterprise_ai_platform.investment.market.breadth.breadth_regime import regime_severity
