"""enterprise_ai_platform/investment/market/breadth/participation_profile.py
...
from enterprise_ai_platform.investment.market.breadth import participation_score as ps
