"""enterprise_ai_platform/investment/market/analytics/breadth_analyzer.py
...
from enterprise_ai_platform.investment.market.market_constants import BreadthCondition
