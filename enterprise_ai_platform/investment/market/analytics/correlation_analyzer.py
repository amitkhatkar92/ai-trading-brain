"""enterprise_ai_platform/investment/market/analytics/correlation_analyzer.py
...
from enterprise_ai_platform.investment.market.market_constants import CorrelationRegime
