"""enterprise_ai_platform/investment/market/analytics/liquidity_analyzer.py
...
from enterprise_ai_platform.investment.market.market_constants import LiquidityLevel
