"""enterprise_ai_platform/investment/market/regime/transition_detector.py
...
from enterprise_ai_platform.investment.market.market_constants import VolatilityLevel
