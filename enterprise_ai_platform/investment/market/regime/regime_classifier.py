"""enterprise_ai_platform/investment/market/regime/regime_classifier.py
...
class StructureBasedClassifier(RegimeClassifier):
    ...
    def classify_from_structure(
        ...
        from enterprise_ai_platform.investment.market.regime.models import regime_type_to_market_regime
