"""enterprise_ai_platform/investment/market/regime/regime_history.py
...
from enterprise_ai_platform.investment.market.market_constants import DEFAULT_HISTORY_SIZE, MarketRegime
from enterprise_ai_platform.investment.market.market_exceptions import SnapshotNotFoundError
