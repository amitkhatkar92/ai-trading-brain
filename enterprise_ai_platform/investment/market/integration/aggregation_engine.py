"""enterprise_ai_platform/investment/market/integration/aggregation_engine.py
...
from enterprise_ai_platform.investment.market.integration.models import EngineSource, IntelligenceBundle
