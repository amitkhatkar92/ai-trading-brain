"""enterprise_ai_platform/investment/market/integration/__init__.py
...
from enterprise_ai_platform.investment.market.integration.consistency_rules import ConsistencyRule, BUILT_IN_RULES
