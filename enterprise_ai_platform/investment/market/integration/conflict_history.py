"""enterprise_ai_platform/investment/market/integration/conflict_history.py
...
from enterprise_ai_platform.investment.market.integration.models import ConflictSeverity, ConflictSummary
