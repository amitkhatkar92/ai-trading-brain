"""enterprise_ai_platform/investment/market/integration/conflict_resolution.py
...
from enterprise_ai_platform.investment.market.integration.models import Conflict, ConflictSeverity, ConflictType
