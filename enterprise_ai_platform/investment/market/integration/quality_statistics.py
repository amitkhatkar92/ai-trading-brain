"""enterprise_ai_platform/investment/market/integration/quality_statistics.py
...
from enterprise_ai_platform.investment.market.integration.models import QualityScore
