"""enterprise_ai_platform/investment/market/integration/market_state.py
...
from enterprise_ai_platform.investment.market.integration.models import MarketStateLabel
