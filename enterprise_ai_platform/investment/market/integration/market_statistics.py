"""enterprise_ai_platform/investment/market/integration/market_statistics.py
...
from enterprise_ai_platform.investment.market.integration.models import MarketIntelligenceSnapshot
