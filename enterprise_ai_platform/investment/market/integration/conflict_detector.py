"""enterprise_ai_platform/investment/market/integration/conflict_detector.py
...
from enterprise_ai_platform.investment.market.integration.models import Conflict, ValidationReport
