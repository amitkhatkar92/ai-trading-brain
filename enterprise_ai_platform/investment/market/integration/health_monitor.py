"""enterprise_ai_platform/investment/market/integration/health_monitor.py
...
from enterprise_ai_platform.investment.market.integration.models import EngineHealthRecord, HealthStatus
