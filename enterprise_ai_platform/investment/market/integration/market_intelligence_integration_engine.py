"""enterprise_ai_platform/investment/market/integration/market_intelligence_integration_engine.py
...
_log = get_logger(__name__, engine_id="enterprise_ai_platform:market:intelligence:integration")
...
class MarketIntelligenceIntegrationEngine(LifecycleAwareMixin):
    ...
    VERSION   = "1.0.0"
    SYSTEM_ID = "enterprise_ai_platform:market:intelligence:integration"
    ...
    def make_bundle(
        ...
        from enterprise_ai_platform.investment.market.integration.models import EnginePayload
        sources = sources or {}
