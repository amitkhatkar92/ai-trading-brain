"""enterprise_ai_platform/investment/market/trend/trend_statistics.py
...
from enterprise_ai_platform.investment.market.trend.models import TrendStage, TrendEventType
