"""enterprise_ai_platform/investment/market/trend/trend_intelligence_engine.py
...
from enterprise_ai_platform.investment.market.trend.trend_snapshot import TrendSnapshotBuilder, _is_regime_aligned
...
if TYPE_CHECKING:
    from enterprise_ai_platform.investment.market.structure.models import MarketStructureSnapshot
    from enterprise_ai_platform.investment.market.regime.models import RegimeSnapshot
