"""enterprise_ai_platform/investment/market/trend/trend_state.py
...
from enterprise_ai_platform.investment.market.structure.models import TrendState as StructureTrendState
