"""enterprise_ai_platform/investment/market/trend/trend_transition.py
...
from enterprise_ai_platform.investment.market.trend.trend_stage import is_advancing, is_declining
