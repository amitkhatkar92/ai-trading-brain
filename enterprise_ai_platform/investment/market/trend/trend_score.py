"""enterprise_ai_platform/investment/market/trend/trend_score.py
...
from enterprise_ai_platform.investment.market.trend.trend_stage import STAGE_LIFECYCLE_SCORES
