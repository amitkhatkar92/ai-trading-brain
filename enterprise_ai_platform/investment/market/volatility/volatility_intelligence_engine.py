"""enterprise_ai_platform/investment/market/volatility/volatility_intelligence_engine.py
...
from enterprise_ai_platform.investment.market.volatility.regime_transition import RegimeTransitionDetector
...
from enterprise_ai_platform.investment.market.volatility.risk_statistics import RiskStatistics
...
class InstitutionalVolatilityIntelligenceEngine:
    ...
    def risk_statistics(self) -> "RiskStats":  # type: ignore[name-defined]
        from enterprise_ai_platform.investment.market.volatility.risk_statistics import RiskStats
