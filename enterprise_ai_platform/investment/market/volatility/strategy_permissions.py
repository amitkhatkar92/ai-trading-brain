"""enterprise_ai_platform/investment/market/volatility/strategy_permissions.py
...
from enterprise_ai_platform.investment.market.volatility.models import StrategyType, VolatilityRegimeType
