"""enterprise_ai_platform/investment/market/volatility/volatility_constraints.py
...
from enterprise_ai_platform.investment.market.volatility.models import VolatilityRegimeType
