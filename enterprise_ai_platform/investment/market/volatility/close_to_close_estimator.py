"""enterprise_ai_platform/investment/market/volatility/close_to_close_estimator.py
...
from enterprise_ai_platform.investment.market.volatility.models import VolatilityEstimate
