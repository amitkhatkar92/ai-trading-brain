"""enterprise_ai_platform/investment/market/volatility/strategy_volatility_mapper.py
...
from enterprise_ai_platform.investment.market.volatility import strategy_permissions as sp
