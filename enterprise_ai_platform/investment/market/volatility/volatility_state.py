"""enterprise_ai_platform/investment/market/volatility/volatility_state.py
...
from enterprise_ai_platform.investment.market.volatility.models import VolatilityState
