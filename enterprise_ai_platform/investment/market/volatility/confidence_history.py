"""enterprise_ai_platform/investment/market/volatility/confidence_history.py
...
from enterprise_ai_platform.investment.market.volatility.models import ConfidenceScore
