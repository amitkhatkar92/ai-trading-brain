"""enterprise_ai_platform/investment/market/volatility/volatility_history.py
...
if TYPE_CHECKING:
    from enterprise_ai_platform.investment.market.volatility.models import VolatilityIntelligenceSnapshot
