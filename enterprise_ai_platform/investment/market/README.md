...
**Package:** `enterprise_ai_platform/investment/market/`  
**Version:** 1.0.0  
**System ID:** `enterprise_ai_platform:market:engine`
...
```python
from enterprise_ai_platform.investment.market import get_market_engine
...
```python
from enterprise_ai_platform.investment.market import MarketFactory, get_market_engine
...
```python
from enterprise_ai_platform.investment.market.regime.regime_classifier import RegimeClassifier
...
```python
from enterprise_ai_platform.investment import get_investment_engine, IntelligenceType
from enterprise_ai_platform.investment.market import get_market_engine
