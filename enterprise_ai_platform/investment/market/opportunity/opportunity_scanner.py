"""enterprise_ai_platform/investment/market/opportunity/opportunity_scanner.py
...
from enterprise_ai_platform.investment.market.opportunity.models import AssetObservation, Opportunity, ScanScope
