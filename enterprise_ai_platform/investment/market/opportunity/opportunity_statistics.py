"""enterprise_ai_platform/investment/market/opportunity/opportunity_statistics.py
...
from enterprise_ai_platform.investment.market.opportunity.models import OpportunitySnapshotData
