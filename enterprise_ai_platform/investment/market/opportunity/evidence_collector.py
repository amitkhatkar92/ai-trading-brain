"""enterprise_ai_platform/investment/market/opportunity/evidence_collector.py
...
from enterprise_ai_platform.investment.market.opportunity.models import Evidence, IntelligenceContext
