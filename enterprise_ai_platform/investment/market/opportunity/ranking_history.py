"""enterprise_ai_platform/investment/market/opportunity/ranking_history.py
...
from enterprise_ai_platform.investment.market.opportunity.models import RankingScore
