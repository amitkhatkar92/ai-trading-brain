"""enterprise_ai_platform/investment/market/opportunity/alert_engine.py
...
from enterprise_ai_platform.investment.market.opportunity.models import AlertType, OpportunityAlert
