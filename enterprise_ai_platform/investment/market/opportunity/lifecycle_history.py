"""enterprise_ai_platform/investment/market/opportunity/lifecycle_history.py
...
from enterprise_ai_platform.investment.market.opportunity.models import OpportunityEvent, OpportunityEventType
