"""enterprise_ai_platform/investment/market/liquidity/participation_score.py
...
from enterprise_ai_platform.investment.market.liquidity.models import VolumeBar, ParticipationBias
