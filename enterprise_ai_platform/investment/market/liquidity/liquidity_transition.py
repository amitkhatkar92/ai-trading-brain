"""enterprise_ai_platform/investment/market/liquidity/liquidity_transition.py
...
from enterprise_ai_platform.investment.market.liquidity.models import LiquidityProfile
