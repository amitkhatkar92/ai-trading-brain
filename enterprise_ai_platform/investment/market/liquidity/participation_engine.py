"""enterprise_ai_platform/investment/market/liquidity/participation_engine.py
...
from enterprise_ai_platform.investment.market.liquidity.models import VolumeBar, ParticipationSnapshot
