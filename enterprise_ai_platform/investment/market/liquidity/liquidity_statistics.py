"""enterprise_ai_platform/investment/market/liquidity/liquidity_statistics.py
...
from enterprise_ai_platform.investment.market.liquidity.models import LiquidityEventType

if TYPE_CHECKING:
    from enterprise_ai_platform.investment.market.liquidity.models import VolumeLiquiditySnapshot
