"""enterprise_ai_platform/investment/market/liquidity/liquidity_profile.py
...
from enterprise_ai_platform.investment.market.liquidity.models import VolumeBar, LiquidityProfile
