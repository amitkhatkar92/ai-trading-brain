"""enterprise_ai_platform/investment/market/liquidity/liquidity_alerts.py
...
from enterprise_ai_platform.investment.market.liquidity.models import LiquidityEvent, LiquidityEventType
