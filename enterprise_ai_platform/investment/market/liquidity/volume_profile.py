"""enterprise_ai_platform/investment/market/liquidity/volume_profile.py
...
from enterprise_ai_platform.investment.market.liquidity.models import VolumeBar, VolumeProfile, VolumeTrend
