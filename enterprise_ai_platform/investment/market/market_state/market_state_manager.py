"""enterprise_ai_platform/investment/market/market_state/market_state_manager.py
...
from enterprise_ai_platform.investment.market.market_constants import MarketStatus
