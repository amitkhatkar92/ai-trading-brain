"""enterprise_ai_platform/investment/decision/integration/consistency_rules.py
...
class RiskPolicyRule(ConsistencyRule):
    ...
    def _evaluate(self, snap: _AggregationStateSnapshot) -> Optional[ValidationCheck]:
        from enterprise_ai_platform.investment.decision.risk.risk_constants import RiskPolicyStatus
