"""enterprise_ai_platform/investment/decision/integration/decision_snapshot.py
...
from enterprise_ai_platform.investment.decision.integration.decision_state import IntegrationDecisionState
