"""enterprise_ai_platform/investment/decision/integration/decision_intelligence_integration_engine.py
...
from enterprise_ai_platform.common.async_exec.async_execution_manager import get_execution_manager as _get_exec_manager
...
from enterprise_ai_platform.investment.decision.integration.aggregation_state import _AggregationStateSnapshot
from enterprise_ai_platform.investment.decision.integration.conflict_engine import ConflictEngine, ConflictReport
from enterprise_ai_platform.investment.decision.integration.consistency_validator import ConsistencyValidator
from enterprise_ai_platform.investment.decision.integration.coverage_monitor import CoverageReport
...
from enterprise_ai_platform.investment.decision.integration.validation_report import ValidationReport
...
from enterprise_ai_platform.common.logging.audit_logger import get_audit_logger
from enterprise_ai_platform.common.errors.error_manager import get_error_manager as _get_err_mgr
from enterprise_ai_platform.common.errors.error_context import ErrorContext

_log = get_logger(__name__, engine_id="enterprise_ai_platform:decision:intelligence:integration")
...
class DecisionIntelligenceIntegrationEngine(LifecycleAwareMixin):
    ...
    VERSION   = "1.0.0"
    SYSTEM_ID = "enterprise_ai_platform:decision:intelligence:integration"
