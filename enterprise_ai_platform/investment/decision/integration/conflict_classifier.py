"""enterprise_ai_platform/investment/decision/integration/conflict_classifier.py
...
from enterprise_ai_platform.investment.decision.integration.conflict_detector import DetectedConflict
