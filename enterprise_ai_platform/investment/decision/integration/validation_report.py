"""enterprise_ai_platform/investment/decision/integration/validation_report.py
...
from enterprise_ai_platform.investment.decision.integration.integration_constants import ValidationStatus
