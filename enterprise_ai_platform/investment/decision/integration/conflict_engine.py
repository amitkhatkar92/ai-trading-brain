"""enterprise_ai_platform/investment/decision/integration/conflict_engine.py
...
from enterprise_ai_platform.investment.decision.integration.integration_constants import ConflictSeverity
