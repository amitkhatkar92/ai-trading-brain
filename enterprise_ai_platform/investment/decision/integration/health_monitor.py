"""enterprise_ai_platform/investment/decision/integration/health_monitor.py
...
from enterprise_ai_platform.investment.decision.integration.coverage_monitor import CoverageMonitor, CoverageReport
