"""enterprise_ai_platform/investment/decision/integration/decision_quality.py
...
from enterprise_ai_platform.investment.decision.integration.conflict_engine import ConflictReport
