"""enterprise_ai_platform/investment/decision/confidence/historical_confidence.py
...
from enterprise_ai_platform.investment.decision.confidence.confidence_constants import TrendDirection
