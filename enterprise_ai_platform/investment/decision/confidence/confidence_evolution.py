"""enterprise_ai_platform/investment/decision/confidence/confidence_evolution.py
...
from enterprise_ai_platform.investment.decision.confidence.confidence_constants import HISTORY_WINDOW_SIZE
