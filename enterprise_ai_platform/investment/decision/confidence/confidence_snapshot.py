"""enterprise_ai_platform/investment/decision/confidence/confidence_snapshot.py
...
from enterprise_ai_platform.investment.decision.confidence.decision_confidence import DecisionConfidence
