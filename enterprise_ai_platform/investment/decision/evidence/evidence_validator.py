"""enterprise_ai_platform/investment/decision/evidence/evidence_validator.py
...
from enterprise_ai_platform.investment.decision.evidence.consistency_checker import ConsistencyChecker, ConsistencyReport
