"""enterprise_ai_platform/investment/decision/evidence/company_evidence.py
...
from enterprise_ai_platform.investment.decision.evidence.evidence_item import make_evidence_item, EvidenceItem
