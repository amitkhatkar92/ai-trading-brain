"""enterprise_ai_platform/investment/decision/evidence/evidence_item.py
...
class EvidenceItem:
    ...
    def is_fresh(self) -> bool:
        from enterprise_ai_platform.investment.decision.evidence.evidence_constants import EVIDENCE_FRESHNESS_WARN_SECONDS
        return self.age_seconds <= EVIDENCE_FRESHNESS_WARN_SECONDS

    @property
    def is_stale(self) -> bool:
        from enterprise_ai_platform.investment.decision.evidence.evidence_constants import EVIDENCE_FRESHNESS_STALE_SECONDS
