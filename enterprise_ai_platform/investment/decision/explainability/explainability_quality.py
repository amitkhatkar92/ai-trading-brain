"""enterprise_ai_platform/investment/decision/explainability/explainability_quality.py
ExplainabilityQualityEvaluator — aggregates transparency + traceability into
an overall explainability score.
"""
from __future__ import annotations

from enterprise_ai_platform.investment.decision.explainability.decision_explanation import DecisionExplanation
