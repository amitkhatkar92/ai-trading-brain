"""enterprise_ai_platform/investment/decision/explainability/reasoning_mapper.py
...
from enterprise_ai_platform.investment.decision.explainability.decision_trace import ReasoningTraceNode
