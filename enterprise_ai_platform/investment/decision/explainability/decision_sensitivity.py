"""enterprise_ai_platform/investment/decision/explainability/decision_sensitivity.py
...
from enterprise_ai_platform.investment.decision.explainability.what_if_analysis import _project_outcome
