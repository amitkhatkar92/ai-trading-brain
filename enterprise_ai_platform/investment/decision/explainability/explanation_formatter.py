"""enterprise_ai_platform/investment/decision/explainability/explanation_formatter.py
...
from enterprise_ai_platform.investment.decision.explainability.explainability_constants import ExplanationFormat
