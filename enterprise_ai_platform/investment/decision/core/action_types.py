"""enterprise_ai_platform/investment/decision/core/action_types.py
...
from enterprise_ai_platform.investment.decision.core.decision_constants import ActionType
