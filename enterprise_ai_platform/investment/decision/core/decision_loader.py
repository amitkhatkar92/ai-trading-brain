"""enterprise_ai_platform/investment/decision/core/decision_loader.py
...
class DecisionLoader:
    ...
    Usage:
        ...
        loader.load_from_module("enterprise_ai_platform.investment.decision.strategies.momentum")
        loader.load_from_class_path(
            "enterprise_ai_platform.investment.decision.strategies.mean_reversion.MeanReversionDecision",
            key="mean_reversion"
        )
    """
