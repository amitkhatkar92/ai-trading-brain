"""enterprise_ai_platform/investment/decision/core/configuration_engine.py
...
from enterprise_ai_platform.investment.decision.core.parameter_validation import ParameterValidator
