"""enterprise_ai_platform/investment/decision/core/decision_catalog.py
...
from enterprise_ai_platform.investment.decision.core.decision_constants import DecisionType
    ...
    def _load_builtins(self) -> None:
        for dt, desc in DECISION_TYPE_DESCRIPTORS.items():
            self._entries[dt.value] = CatalogEntry(
                descriptor=desc,
                class_name=f"enterprise_ai_platform.investment.decision.core.base_decision.BaseDecision",
                tags=("builtin",),
                is_builtin=True,
            )
