"""enterprise_ai_platform/investment/decision/core/recommendation_types.py
...
from enterprise_ai_platform.investment.decision.core.decision_constants import RecommendationType
