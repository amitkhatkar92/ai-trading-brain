"""enterprise_ai_platform/investment/decision/core/base_decision.py
...
from enterprise_ai_platform.investment.decision.core.decision_events import DecisionEvent, EventDispatcher, make_event
