"""enterprise_ai_platform/investment/decision/committee/member_registry.py
...
from enterprise_ai_platform.investment.decision.committee.member_profiles import SPECIALIST_PROFILES
