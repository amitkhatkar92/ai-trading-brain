"""enterprise_ai_platform/investment/decision/committee/committee_history.py
...
from enterprise_ai_platform.investment.decision.committee.committee_constants import COMMITTEE_HISTORY_WINDOW
