"""enterprise_ai_platform/investment/decision/committee/committee_session.py
...
from enterprise_ai_platform.investment.decision.committee.challenge_engine import ChallengeEngine
...
from enterprise_ai_platform.investment.decision.committee.committee_findings import CommitteeFindingsBuilder
...
class CommitteeSession:
    ...
    def _determine_position(self, vote_summary) -> CommitteePosition:
        ...
        from enterprise_ai_platform.investment.decision.committee.committee_constants import ConsensusLevel
    ...
    def _insufficient_evidence_report(self, duration_ms: float) -> CommitteeReport:
        ...
        from enterprise_ai_platform.investment.decision.committee.weighted_voting import VoteSummary
        from enterprise_ai_platform.investment.decision.committee.committee_findings import CommitteeFindings
        from enterprise_ai_platform.investment.decision.committee.committee_recommendations import CommitteeStance
