"""enterprise_ai_platform/investment/decision/committee/committee_member.py
...
from enterprise_ai_platform.investment.decision.committee.member_profiles import SpecialistProfile, get_profile
