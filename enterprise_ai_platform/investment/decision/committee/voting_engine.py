"""enterprise_ai_platform/investment/decision/committee/voting_engine.py
...
from enterprise_ai_platform.investment.decision.committee.vote_registry import VoteRegistry
