"""enterprise_ai_platform/investment/decision/reasoning/hypothesis_registry.py
...
from enterprise_ai_platform.investment.decision.reasoning.reasoning_constants import HypothesisStatus, HypothesisType
