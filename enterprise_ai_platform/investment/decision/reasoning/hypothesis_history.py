"""enterprise_ai_platform/investment/decision/reasoning/hypothesis_history.py
...
from enterprise_ai_platform.investment.decision.reasoning.reasoning_constants import HypothesisType
