"""enterprise_ai_platform/investment/decision/reasoning/reasoning_score.py
...
from enterprise_ai_platform.investment.decision.reasoning.reasoning_constants import ReasoningQualityDimension
