"""enterprise_ai_platform/investment/decision/reasoning/reasoning_quality.py
...
from enterprise_ai_platform.investment.decision.reasoning.reasoning_score import ReasoningQualityScore, compute_reasoning_score
