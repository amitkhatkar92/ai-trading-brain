"""enterprise_ai_platform/investment/decision/risk/decision_risk_score.py
...
from enterprise_ai_platform.investment.decision.risk.risk_constants import RiskLevel, RiskQualityGrade
