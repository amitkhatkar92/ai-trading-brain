"""enterprise_ai_platform/investment/decision/risk/scenario_risk.py
...
from enterprise_ai_platform.investment.decision.risk.stress_scenarios import StressScenario
