"""enterprise_ai_platform/investment/decision/risk/control_registry.py
...
from enterprise_ai_platform.investment.decision.risk.risk_controls import RiskControl
