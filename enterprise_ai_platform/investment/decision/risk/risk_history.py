"""enterprise_ai_platform/investment/decision/risk/risk_history.py
...
from enterprise_ai_platform.investment.decision.risk.risk_constants import HISTORY_WINDOW_SIZE
