"""enterprise_ai_platform/investment/portfolio/diversification/portfolio_diversification_engine.py
...
def _metrics_from_profile(
    ...
    from enterprise_ai_platform.investment.portfolio.diversification.diversification_metrics import DiversificationMetrics
