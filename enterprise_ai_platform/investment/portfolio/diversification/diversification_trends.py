"""enterprise_ai_platform/investment/portfolio/diversification/diversification_trends.py
...
from enterprise_ai_platform.investment.portfolio.diversification.diversification_types import TrendDirection
