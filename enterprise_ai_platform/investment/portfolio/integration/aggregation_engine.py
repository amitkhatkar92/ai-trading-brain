"""enterprise_ai_platform/investment/portfolio/integration/aggregation_engine.py
...
from enterprise_ai_platform.investment.portfolio.integration.aggregation_state import AggregationState
