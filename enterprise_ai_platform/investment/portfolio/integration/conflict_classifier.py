"""enterprise_ai_platform/investment/portfolio/integration/conflict_classifier.py
...
from enterprise_ai_platform.investment.portfolio.integration.integration_types import ConflictSeverity
