"""enterprise_ai_platform/investment/portfolio/integration/quality_history.py
...
from enterprise_ai_platform.investment.portfolio.integration.quality_statistics import QualityRunMetric
