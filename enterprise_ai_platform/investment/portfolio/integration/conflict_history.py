"""enterprise_ai_platform/investment/portfolio/integration/conflict_history.py
...
from enterprise_ai_platform.investment.portfolio.integration.conflict_resolution import ConflictResolutionResult
