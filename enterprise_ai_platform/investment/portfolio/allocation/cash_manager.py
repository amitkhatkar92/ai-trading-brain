"""enterprise_ai_platform/investment/portfolio/allocation/cash_manager.py
...
from enterprise_ai_platform.investment.portfolio.allocation.allocation_plan import AllocationRequest, CashAllocation
