"""enterprise_ai_platform/investment/portfolio/allocation/position_allocator.py
...
from enterprise_ai_platform.investment.portfolio.allocation.allocation_types import AllocationDirection, AllocationMethod
