"""enterprise_ai_platform/investment/portfolio/core/portfolio_framework.py
...
from enterprise_ai_platform.investment.portfolio.core.event_history import EventHistory
from enterprise_ai_platform.investment.portfolio.core.framework_context import (
    IntegrationRefs,
    PortfolioRuntimeContext,
)
from enterprise_ai_platform.investment.portfolio.core.portfolio_catalog import PortfolioCatalog
...
from enterprise_ai_platform.investment.portfolio.core.portfolio_lifecycle import PortfolioLifecycle
from enterprise_ai_platform.investment.portfolio.core.portfolio_loader import PortfolioLoader
from enterprise_ai_platform.investment.portfolio.core.portfolio_metadata import PortfolioMetadata
from enterprise_ai_platform.investment.portfolio.core.portfolio_registry import (
    PortfolioClassEntry,
    PortfolioClassRegistry,
)
from enterprise_ai_platform.investment.portfolio.core.portfolio_session import SessionManager
...
class PortfolioFramework:
    ...
    def subscribe_events(self, handler, *, event_types=None, portfolio_ids=None,
        ...
        from enterprise_ai_platform.investment.portfolio.core.event_dispatcher import EventPriority as EP
