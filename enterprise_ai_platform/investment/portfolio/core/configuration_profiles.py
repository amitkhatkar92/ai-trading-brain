"""enterprise_ai_platform/investment/portfolio/core/configuration_profiles.py
...
from enterprise_ai_platform.investment.portfolio.core.portfolio_types import PortfolioDomain
