"""enterprise_ai_platform/investment/portfolio/core/portfolio_metadata.py
...
from enterprise_ai_platform.investment.portfolio.portfolio_constants import RiskLevel
