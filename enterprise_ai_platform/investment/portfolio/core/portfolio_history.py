"""enterprise_ai_platform/investment/portfolio/core/portfolio_history.py
...
from enterprise_ai_platform.investment.portfolio.portfolio_constants import DEFAULT_SNAPSHOT_HISTORY
