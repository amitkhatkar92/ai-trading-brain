"""enterprise_ai_platform/investment/portfolio/core/portfolio_factory.py
...
from enterprise_ai_platform.investment.portfolio.core.portfolio_metadata import PortfolioMetadata, build_metadata
