"""enterprise_ai_platform/investment/portfolio/core/configuration_engine.py
...
from enterprise_ai_platform.investment.portfolio.core.parameter_registry import PARAMETER_REGISTRY
