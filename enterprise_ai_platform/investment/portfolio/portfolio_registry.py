"""enterprise_ai_platform/investment/portfolio/portfolio_registry.py
...
from enterprise_ai_platform.investment.portfolio.portfolio_constants import DEFAULT_MAX_PORTFOLIOS
