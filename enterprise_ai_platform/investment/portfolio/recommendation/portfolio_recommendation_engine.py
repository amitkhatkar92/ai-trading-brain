"""enterprise_ai_platform/investment/portfolio/recommendation/portfolio_recommendation_engine.py
...
from enterprise_ai_platform.investment.portfolio.recommendation.recommendation_confidence import (
    calculate_confidence, intelligence_quality_score,
)
from enterprise_ai_platform.investment.portfolio.recommendation.recommendation_expiration import (
    compute_expires_at,
)
...
from enterprise_ai_platform.investment.portfolio.recommendation.recommendation_history import (
...
from enterprise_ai_platform.investment.portfolio.recommendation.recommendation_snapshot import (
    RecommendationHistory, RecommendationRecord,
)
from enterprise_ai_platform.investment.portfolio.recommendation.recommendation_statistics import (
    ...
    def _build_recommendations(
        ...
        if not recs:
            fallback_candidate = RecommendationCandidate(
                ...
                priority       = __import__(
                    "enterprise_ai_platform.investment.portfolio.recommendation.recommendation_types",
