"""enterprise_ai_platform/investment/portfolio/recommendation/recommendation_registry.py
...
from enterprise_ai_platform.investment.portfolio.recommendation.recommendation_types import PolicyType
