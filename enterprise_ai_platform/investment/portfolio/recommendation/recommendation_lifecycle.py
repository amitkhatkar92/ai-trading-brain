"""enterprise_ai_platform/investment/portfolio/recommendation/recommendation_lifecycle.py
...
class LifecycleManager:
    ...
    def transition(self, rec: "PortfolioRecommendation", new_state: LifecycleState) -> "PortfolioRecommendation":
        ...
        from enterprise_ai_platform.investment.portfolio.recommendation.portfolio_recommendation import PortfolioRecommendation
        import dataclasses
