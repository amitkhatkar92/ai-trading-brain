"""enterprise_ai_platform/investment/portfolio/performance/return_statistics.py
...
from enterprise_ai_platform.investment.portfolio.performance.performance_types import TRADING_DAYS
