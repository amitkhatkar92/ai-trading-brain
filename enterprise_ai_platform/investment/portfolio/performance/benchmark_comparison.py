"""enterprise_ai_platform/investment/portfolio/performance/benchmark_comparison.py
...
from enterprise_ai_platform.investment.portfolio.performance.benchmark_registry import Benchmark
