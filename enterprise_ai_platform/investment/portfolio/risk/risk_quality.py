"""enterprise_ai_platform/investment/portfolio/risk/risk_quality.py
...
from enterprise_ai_platform.investment.portfolio.risk.portfolio_risk_score import RiskScore
