"""enterprise_ai_platform/investment/portfolio/risk/stress_statistics.py
...
from enterprise_ai_platform.investment.portfolio.risk.stress_testing import StressTestReport
