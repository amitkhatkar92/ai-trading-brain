"""enterprise_ai_platform/investment/portfolio/construction/construction_quality.py
...
class ConstructionQualityAssessor:
    ...
    def _policy_compliance_score(self, construction_report: Any) -> DimensionScore:
        ...
        from enterprise_ai_platform.investment.portfolio.construction.construction_types import ValidationCategory
        policy_findings = [
            f for f in findings
