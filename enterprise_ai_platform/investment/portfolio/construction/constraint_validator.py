"""enterprise_ai_platform/investment/portfolio/construction/constraint_validator.py
...
from enterprise_ai_platform.investment.portfolio.construction.constraint_history import ConstraintCheckRecord
