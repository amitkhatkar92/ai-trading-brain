"""enterprise_ai_platform/investment/portfolio/construction/construction_rules.py
...
class MarketNeutralRule(ConstructionRule):
    ...
    def apply(self, weights: WeightMap, request: Any) -> RuleApplication:
        from enterprise_ai_platform.investment.portfolio.construction.construction_types import ConstructionType
