"""enterprise_ai_platform/investment/portfolio/optimization/optimization_registry.py
...
from enterprise_ai_platform.investment.portfolio.optimization.optimization_types import OptimizationMethod
