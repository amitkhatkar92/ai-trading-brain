"""enterprise_ai_platform/investment/portfolio/optimization/optimization_snapshot.py
   enterprise_ai_platform/investment/portfolio/optimization/optimization_history.py
