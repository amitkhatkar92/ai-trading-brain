"""enterprise_ai_platform/investment/portfolio/rebalancing/portfolio_rebalancing_engine.py
...
from enterprise_ai_platform.investment.portfolio.rebalancing.allocation_drift import AllocationDrift, compute_allocation_drift
from enterprise_ai_platform.investment.portfolio.rebalancing.cost_validator import CostValidator
from enterprise_ai_platform.investment.portfolio.rebalancing.drift_engine import DriftEngine, DriftReport
from enterprise_ai_platform.investment.portfolio.rebalancing.execution_estimator import ExecutionEstimate, ExecutionEstimator
from enterprise_ai_platform.investment.portfolio.rebalancing.policy_engine import PolicyEngine, PolicyEngineResult
from enterprise_ai_platform.investment.portfolio.rebalancing.policy_registry import PolicyRegistry
from enterprise_ai_platform.investment.portfolio.rebalancing.policy_validator import PolicyValidator
...
from enterprise_ai_platform.investment.portfolio.rebalancing.rebalance_history import PortfolioRebalanceHistory
from enterprise_ai_platform.investment.portfolio.rebalancing.rebalance_plan import RebalancePlan
...
from enterprise_ai_platform.investment.portfolio.rebalancing.rebalance_snapshot import RebalanceHistory, RebalanceRecord
...
from enterprise_ai_platform.investment.portfolio.rebalancing.rebalance_validator import RebalanceValidator
...
from enterprise_ai_platform.investment.portfolio.rebalancing.risk_drift import compute_risk_drift
from enterprise_ai_platform.investment.portfolio.rebalancing.trade_planner import TradePlan, TradePlanner
...
class PortfolioRebalancingEngine:
    ...
    def _build_record(plan: RebalancePlan) -> RebalanceRecord:
        from enterprise_ai_platform.investment.portfolio.rebalancing.rebalance_snapshot import RebalanceRecord
