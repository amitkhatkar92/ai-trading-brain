"""enterprise_ai_platform/investment/portfolio/rebalancing/policy_validator.py
...
class PolicyValidator:
    ...
    def validate(
        ...
        if params.tax_aware and params.avoid_stcg_sells:
            from enterprise_ai_platform.investment.portfolio.rebalancing.rebalancing_types import TradeSide
            stcg_sells = [
