"""enterprise_ai_platform/investment/portfolio/rebalancing/trade_planner.py
...
from enterprise_ai_platform.investment.portfolio.rebalancing.trade_priority import prioritize_trades
...
class TradePlanner:
    ...
    def plan(
        ...
        # 5. Priority summary
        from enterprise_ai_platform.investment.portfolio.rebalancing.trade_priority import _PRIORITY_ORDER
