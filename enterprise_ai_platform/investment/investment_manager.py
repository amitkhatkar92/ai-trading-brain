"""enterprise_ai_platform/investment/investment_manager.py
...
class InvestmentManager:
    ...
    def get_session(self, session_id: str) -> InvestmentSession:
        ...
        if s is None:
            from enterprise_ai_platform.investment.investment_exceptions import SessionNotFoundError  # noqa: PLC0415
