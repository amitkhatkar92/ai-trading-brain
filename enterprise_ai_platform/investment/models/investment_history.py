"""enterprise_ai_platform/investment/models/investment_history.py
...
from enterprise_ai_platform.investment.investment_constants import MAX_HISTORY_SIZE
from enterprise_ai_platform.investment.investment_exceptions import InvestmentNotFoundError
