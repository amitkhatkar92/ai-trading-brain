"""enterprise_ai_platform/investment/models/investment_context_model.py
...
from enterprise_ai_platform.investment.investment_constants import AssetClass, IntelligenceType
