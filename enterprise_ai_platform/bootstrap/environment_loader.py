"""
enterprise_ai_platform/bootstrap/environment_loader.py
=======================================
...
_KNOWN_VARS: list[_EnvVar] = [
    ...
    _EnvVar("IIOS_LOG_FILE",         False, "logs/enterprise_ai_platform.log", "Log file path",       "str"),
    _EnvVar("IIOS_DB_PATH",          False, "data/enterprise_ai_platform.db",  "SQLite database path","str"),
...
class EnvironmentSnapshot:
    ...
    def log_file(self) -> str:
        return str(self.typed.get("IIOS_LOG_FILE", "logs/enterprise_ai_platform.log"))

    @property
    def db_path(self) -> str:
        return str(self.typed.get("IIOS_DB_PATH", "data/enterprise_ai_platform.db"))
