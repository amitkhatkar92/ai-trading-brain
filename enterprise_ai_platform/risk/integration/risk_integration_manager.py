"""
risk_integration_manager.py — enterprise_ai_platform.risk.integration
=====================================================
...
class RiskIntegrationManager:
    ...
    **Not part of the public API** — callers use
    ...
    def __init__(
        ...
        engine_id:          str                                    = "enterprise_ai_platform:risk:integration:engine",
    ) -> None:
    ...
    def _execute_pipeline(
        ...
        if assessment_component is not None and hasattr(assessment_component, "assess"):
            try:
                from enterprise_ai_platform.risk.assessment import RiskAssessmentRequest, RiskAssessmentContext
