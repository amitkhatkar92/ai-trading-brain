"""
constants.py — enterprise_ai_platform.risk.integration
=======================================
...
# System identifiers
# ---------------------------------------------------------------------------
INTEGRATION_SYSTEM_ID: str = "enterprise_ai_platform:risk:integration"
MANAGER_SYSTEM_ID:     str = "enterprise_ai_platform:risk:integration:manager"
REGISTRY_SYSTEM_ID:    str = "enterprise_ai_platform:risk:integration:registry"
COMPONENT_REGISTRY_ID: str = "enterprise_ai_platform:risk:integration:components"
FACTORY_SYSTEM_ID:     str = "enterprise_ai_platform:risk:integration:factory"
HEALTH_SYSTEM_ID:      str = "enterprise_ai_platform:risk:integration:health"
...
# Actors
# ---------------------------------------------------------------------------
ACTOR_INTEGRATION_ENGINE: str = "enterprise_ai_platform:risk:integration:engine"
ACTOR_INTEGRATION_MANAGER: str = "enterprise_ai_platform:risk:integration:manager"
