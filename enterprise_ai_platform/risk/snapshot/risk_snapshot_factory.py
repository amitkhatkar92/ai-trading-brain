"""
risk_snapshot_factory.py — enterprise_ai_platform.risk.snapshot
===============================================
...
class RiskSnapshotFactory:
    ...
    def from_assessment_report(
        ...
        *,
        ...
        """
        Build a snapshot from a :class:`~enterprise_ai_platform.risk.assessment.RiskAssessmentReport`.
