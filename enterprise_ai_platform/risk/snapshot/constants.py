"""
constants.py — enterprise_ai_platform.risk.snapshot
====================================
...
# System identifiers
# ---------------------------------------------------------------------------
SNAPSHOT_SYSTEM_ID:  str = "enterprise_ai_platform:risk:snapshot"
BUILDER_SYSTEM_ID:   str = "enterprise_ai_platform:risk:snapshot:builder"
REGISTRY_SYSTEM_ID:  str = "enterprise_ai_platform:risk:snapshot:registry"
STORE_SYSTEM_ID:     str = "enterprise_ai_platform:risk:snapshot:store"
CACHE_SYSTEM_ID:     str = "enterprise_ai_platform:risk:snapshot:cache"
FACTORY_SYSTEM_ID:   str = "enterprise_ai_platform:risk:snapshot:factory"
HISTORY_SYSTEM_ID:   str = "enterprise_ai_platform:risk:snapshot:history"
BUNDLE_SYSTEM_ID:    str = "enterprise_ai_platform:risk:snapshot:bundle"
...
# Actors
# ---------------------------------------------------------------------------
ACTOR_SNAPSHOT_BUILDER:  str = "enterprise_ai_platform:risk:snapshot:builder"
ACTOR_SNAPSHOT_FACTORY:  str = "enterprise_ai_platform:risk:snapshot:factory"
ACTOR_SNAPSHOT_REGISTRY: str = "enterprise_ai_platform:risk:snapshot:registry"
