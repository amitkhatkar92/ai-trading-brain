"""
constants.py — enterprise_ai_platform.risk.assessment
=====================================
...
# System identifiers
# ---------------------------------------------------------------------------
ASSESSMENT_SYSTEM_ID: str = "enterprise_ai_platform:risk:assessment"
CALCULATOR_SYSTEM_ID: str = "enterprise_ai_platform:risk:assessment:calculator"
REGISTRY_SYSTEM_ID:   str = "enterprise_ai_platform:risk:assessment:registry"
MODEL_REGISTRY_ID:    str = "enterprise_ai_platform:risk:assessment:models"
OPTIMIZER_SYSTEM_ID:  str = "enterprise_ai_platform:risk:assessment:optimizer"
FACTORY_SYSTEM_ID:    str = "enterprise_ai_platform:risk:assessment:factory"
...
# Actors
# ---------------------------------------------------------------------------
ACTOR_ASSESSMENT_ENGINE: str = "enterprise_ai_platform:risk:assessment:engine"
ACTOR_CALCULATOR:        str = "enterprise_ai_platform:risk:assessment:calculator"
ACTOR_OPTIMIZER:         str = "enterprise_ai_platform:risk:assessment:optimizer"
