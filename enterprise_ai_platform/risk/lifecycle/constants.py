"""
constants.py — enterprise_ai_platform.risk.lifecycle
====================================
...
# System identifiers
# ---------------------------------------------------------------------------
LIFECYCLE_SYSTEM_ID: str = "enterprise_ai_platform:risk:lifecycle"
REGISTRY_SYSTEM_ID:  str = "enterprise_ai_platform:risk:lifecycle:registry"
FACTORY_SYSTEM_ID:   str = "enterprise_ai_platform:risk:lifecycle:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_LIFECYCLE: str = "enterprise_ai_platform:risk:lifecycle"
ACTOR_OPERATOR:  str = "operator"
ACTOR_SYSTEM:    str = "enterprise_ai_platform:system"
ACTOR_RISK:      str = "enterprise_ai_platform:risk:engine"
ACTOR_MONITOR:   str = "enterprise_ai_platform:risk:monitor"
