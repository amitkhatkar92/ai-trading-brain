"""
risk_state.py — enterprise_ai_platform.risk.lifecycle
=====================================
...
class RiskStateRecord:
    """
    Immutable record of a risk session entering a particular state.
...
def can_transition(
    ...
    permitted by the institutional risk state machine.
