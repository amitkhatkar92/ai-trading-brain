"""
risk_statistics.py — enterprise_ai_platform.risk.lifecycle
==========================================
Thread-safe accumulation of risk lifecycle statistics.
...
class RiskStatistics:
    """
    Thread-safe accumulator for risk lifecycle statistics.
    ...
    def snapshot(self) -> Dict[str, Any]:
        ...
        Keys
        ----
        risk_sessions_created :   Total sessions created.
        risk_sessions_completed : Total sessions completed.
        risk_sessions_failed :    Total sessions failed.
        risk_sessions_archived :  Total sessions archived.
        ...
        with self._lock:
            ...
            return {
                "risk_sessions_created":    self._created,
                "risk_sessions_completed":  self._completed,
                "risk_sessions_failed":     self._failed,
                "risk_sessions_archived":   self._archived,
