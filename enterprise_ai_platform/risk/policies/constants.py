"""
constants.py — enterprise_ai_platform.risk.policies
====================================
...
# System identifiers
# ---------------------------------------------------------------------------
POLICY_SYSTEM_ID:    str = "enterprise_ai_platform:risk:policies"
EVALUATOR_SYSTEM_ID: str = "enterprise_ai_platform:risk:policies:evaluator"
REGISTRY_SYSTEM_ID:  str = "enterprise_ai_platform:risk:policies:registry"
FACTORY_SYSTEM_ID:   str = "enterprise_ai_platform:risk:policies:factory"
AUDITOR_SYSTEM_ID:   str = "enterprise_ai_platform:risk:policies:auditor"
CHAIN_SYSTEM_ID:     str = "enterprise_ai_platform:risk:policies:chain"
...
# Actors
# ---------------------------------------------------------------------------
ACTOR_POLICY_ENGINE:    str = "enterprise_ai_platform:risk:policies:engine"
ACTOR_EVALUATOR:        str = "enterprise_ai_platform:risk:policies:evaluator"
ACTOR_REGISTRY:         str = "enterprise_ai_platform:risk:policies:registry"
