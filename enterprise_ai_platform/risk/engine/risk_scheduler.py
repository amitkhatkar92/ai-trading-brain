"""
risk_scheduler.py — enterprise_ai_platform.risk.engine
=======================================
Thread-safe priority-based risk workflow scheduler.

Supports real-time, event-driven, scheduled, manual, priority,
and batch risk processing.
...
from .exceptions import RiskCapacityError, RiskSchedulerError


class RiskScheduler:
    """
    Thread-safe priority queue scheduler for risk workflow requests.
    ...
    Parameters
    ----------
    max_queue_size : Maximum pending requests before raising RiskCapacityError.
    """
    ...
    def next(self) -> Optional[RiskRequest]:
        """
