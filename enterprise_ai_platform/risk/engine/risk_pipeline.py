"""
risk_pipeline.py — enterprise_ai_platform.risk.engine
======================================
Risk workflow pipeline and stage value objects.
...
class RiskPipeline:
    """
    Mutable workflow pipeline tracking the execution of a risk request.

    A pipeline is created for every :class:`RiskRequest` submitted to the
    ...
    @property
    def workflow_type(self) -> RiskWorkflowType:
