"""
constants.py — enterprise_ai_platform.risk.engine
=================================
...
# System identifiers
# ---------------------------------------------------------------------------
ENGINE_SYSTEM_ID:     str = "enterprise_ai_platform:risk:engine"
SCHEDULER_SYSTEM_ID:  str = "enterprise_ai_platform:risk:engine:scheduler"
DISPATCHER_SYSTEM_ID: str = "enterprise_ai_platform:risk:engine:dispatcher"
REGISTRY_SYSTEM_ID:   str = "enterprise_ai_platform:risk:engine:registry"
FACTORY_SYSTEM_ID:    str = "enterprise_ai_platform:risk:engine:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_ENGINE:     str = "enterprise_ai_platform:risk:engine"
ACTOR_SCHEDULER:  str = "enterprise_ai_platform:risk:engine:scheduler"
ACTOR_DISPATCHER: str = "enterprise_ai_platform:risk:engine:dispatcher"
