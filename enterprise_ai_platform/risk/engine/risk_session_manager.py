"""
risk_session_manager.py — enterprise_ai_platform.risk.engine
=============================================
...
from enterprise_ai_platform.risk.lifecycle import RiskLifecycle, RiskSession, RiskType, RiskScope
...
class RiskSessionManager:
    ...
    Wraps :class:`enterprise_ai_platform.risk.lifecycle.RiskLifecycle` and exposes the
