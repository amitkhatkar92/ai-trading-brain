"""
constants.py — enterprise_ai_platform.market.policies
=====================================
...
# System identifiers
# ---------------------------------------------------------------------------
POLICY_SYSTEM_ID:    str = "enterprise_ai_platform:market:policies"
EVALUATOR_SYSTEM_ID: str = "enterprise_ai_platform:market:policies:evaluator"
REGISTRY_SYSTEM_ID:  str = "enterprise_ai_platform:market:policies:registry"
FACTORY_SYSTEM_ID:   str = "enterprise_ai_platform:market:policies:factory"
AUDITOR_SYSTEM_ID:   str = "enterprise_ai_platform:market:policies:auditor"
CHAIN_SYSTEM_ID:     str = "enterprise_ai_platform:market:policies:chain"
...
# Actors
# ---------------------------------------------------------------------------
ACTOR_POLICY_ENGINE: str = "enterprise_ai_platform:market:policies:engine"
ACTOR_EVALUATOR:     str = "enterprise_ai_platform:market:policies:evaluator"
ACTOR_REGISTRY:      str = "enterprise_ai_platform:market:policies:registry"
