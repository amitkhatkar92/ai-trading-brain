"""
market_policy.py — enterprise_ai_platform.market.policies
=========================================
Immutable market policy value object.

A policy is a versioned, named collection of
:class:`~.market_policy_rule.MarketPolicyRule` objects that governs a
particular market intelligence domain.
...
class MarketPolicy:
    """
    Immutable versioned market governance policy.

    Fields
    ------
    policy_id :         Unique identifier.
    name :              Human-readable name.
    policy_type :       Market domain this policy governs.
    ...
    def with_enabled(self, enabled: bool) -> "MarketPolicy":
