"""
market_policy_condition.py — enterprise_ai_platform.market.policies
===================================================
Immutable condition value object — the atomic unit of a market policy rule.
