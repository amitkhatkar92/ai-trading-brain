"""
market_policy_result.py — enterprise_ai_platform.market.policies
================================================
...
from .constants import VERSION, MarketPolicyType, PolicyAction, PolicyPriority


@dataclass(frozen=True)
class MarketPolicyResult:
    """
    Immutable result of evaluating a single market policy against a request.
    ...
    policy_type :           Market domain of the policy.
    ...
    def is_denying(self) -> bool:
        return self.action in (PolicyAction.REJECT, PolicyAction.BLOCK)
