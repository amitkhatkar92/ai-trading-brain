"""
constants.py — enterprise_ai_platform.market.lifecycle
======================================
...
# System identifiers
# ---------------------------------------------------------------------------
LIFECYCLE_SYSTEM_ID: str = "enterprise_ai_platform:market:lifecycle"
REGISTRY_SYSTEM_ID:  str = "enterprise_ai_platform:market:lifecycle:registry"
FACTORY_SYSTEM_ID:   str = "enterprise_ai_platform:market:lifecycle:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_LIFECYCLE: str = "enterprise_ai_platform:market:lifecycle"
ACTOR_OPERATOR:  str = "operator"
ACTOR_SYSTEM:    str = "enterprise_ai_platform:system"
ACTOR_MARKET:    str = "enterprise_ai_platform:market:engine"
ACTOR_MONITOR:   str = "enterprise_ai_platform:market:monitor"
