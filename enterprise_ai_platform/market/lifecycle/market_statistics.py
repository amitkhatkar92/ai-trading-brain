"""
market_statistics.py — enterprise_ai_platform.market.lifecycle
==============================================
Thread-safe accumulation of market lifecycle statistics.
...
class MarketStatistics:
    """
    Thread-safe accumulator for market lifecycle statistics.
    ...
    def snapshot(self) -> Dict[str, Any]:
        ...
        Keys
        ----
        market_sessions_created :    Total sessions created.
        market_sessions_completed :  Total sessions completed.
        market_sessions_failed :     Total sessions failed.
        market_sessions_archived :   Total sessions archived.
        ...
        with self._lock:
            ...
            return {
                "market_sessions_created":    self._created,
                "market_sessions_completed":  self._completed,
                "market_sessions_failed":     self._failed,
                "market_sessions_archived":   self._archived,
