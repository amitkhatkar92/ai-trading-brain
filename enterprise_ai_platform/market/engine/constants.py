"""
constants.py — enterprise_ai_platform.market.engine
===================================
...
# System identifiers
# ---------------------------------------------------------------------------
ENGINE_SYSTEM_ID:     str = "enterprise_ai_platform:market:engine"
SCHEDULER_SYSTEM_ID:  str = "enterprise_ai_platform:market:engine:scheduler"
DISPATCHER_SYSTEM_ID: str = "enterprise_ai_platform:market:engine:dispatcher"
REGISTRY_SYSTEM_ID:   str = "enterprise_ai_platform:market:engine:registry"
FACTORY_SYSTEM_ID:    str = "enterprise_ai_platform:market:engine:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_ENGINE:     str = "enterprise_ai_platform:market:engine"
ACTOR_SCHEDULER:  str = "enterprise_ai_platform:market:engine:scheduler"
ACTOR_DISPATCHER: str = "enterprise_ai_platform:market:engine:dispatcher"
