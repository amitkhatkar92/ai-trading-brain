"""
market_status.py — enterprise_ai_platform.market.engine
========================================
...
class MarketEngineStatus:
    """
    Immutable point-in-time status of the Market Engine.

    Captured via :meth:`MarketEngine.status()`.
    ...
    health :            Health report dict from MarketEngineHealth.
