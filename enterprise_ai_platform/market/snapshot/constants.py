"""
constants.py — enterprise_ai_platform.market.snapshot
=====================================
...
# System identifiers
# ---------------------------------------------------------------------------
SNAPSHOT_SYSTEM_ID:       str = "enterprise_ai_platform:market:snapshot"
BUILDER_SYSTEM_ID:        str = "enterprise_ai_platform:market:snapshot:builder"
REGISTRY_SYSTEM_ID:       str = "enterprise_ai_platform:market:snapshot:registry"
STORE_SYSTEM_ID:          str = "enterprise_ai_platform:market:snapshot:store"
CACHE_SYSTEM_ID:          str = "enterprise_ai_platform:market:snapshot:cache"
HISTORY_SYSTEM_ID:        str = "enterprise_ai_platform:market:snapshot:history"
FACTORY_SYSTEM_ID:        str = "enterprise_ai_platform:market:snapshot:factory"
VALIDATION_SYSTEM_ID:     str = "enterprise_ai_platform:market:snapshot:validation"
BUNDLE_SYSTEM_ID:         str = "enterprise_ai_platform:market:snapshot:bundle"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_SNAPSHOT:   str = "enterprise_ai_platform:market:snapshot"
ACTOR_BUILDER:    str = "enterprise_ai_platform:market:snapshot:builder"
