"""
constants.py — enterprise_ai_platform.market.analytics
======================================
...
# System identifiers
# ---------------------------------------------------------------------------
ANALYTICS_SYSTEM_ID:   str = "enterprise_ai_platform:market:analytics"
REGIME_SYSTEM_ID:      str = "enterprise_ai_platform:market:analytics:regime"
BREADTH_SYSTEM_ID:     str = "enterprise_ai_platform:market:analytics:breadth"
SECTOR_SYSTEM_ID:      str = "enterprise_ai_platform:market:analytics:sector"
VOLATILITY_SYSTEM_ID:  str = "enterprise_ai_platform:market:analytics:volatility"
FORECAST_SYSTEM_ID:    str = "enterprise_ai_platform:market:analytics:forecast"
SCORING_SYSTEM_ID:     str = "enterprise_ai_platform:market:analytics:scoring"
INTELLIGENCE_SYSTEM_ID: str = "enterprise_ai_platform:market:analytics:intelligence"
FACTORY_SYSTEM_ID:     str = "enterprise_ai_platform:market:analytics:factory"
REGISTRY_SYSTEM_ID:    str = "enterprise_ai_platform:market:analytics:registry"
...
# Actors
# ---------------------------------------------------------------------------
ACTOR_ANALYTICS_ENGINE: str = "enterprise_ai_platform:market:analytics:engine"
ACTOR_REGIME:           str = "enterprise_ai_platform:market:analytics:regime"
ACTOR_BREADTH:          str = "enterprise_ai_platform:market:analytics:breadth"
ACTOR_SECTOR:           str = "enterprise_ai_platform:market:analytics:sector"
ACTOR_FORECAST:         str = "enterprise_ai_platform:market:analytics:forecast"
ACTOR_SCORING:          str = "enterprise_ai_platform:market:analytics:scoring"
ACTOR_SYSTEM:           str = "enterprise_ai_platform:system"
