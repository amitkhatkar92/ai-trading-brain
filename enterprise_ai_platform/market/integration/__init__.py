"""
enterprise_ai_platform.market.integration — Market Integration subsystem
========================================================
...
:class:`~enterprise_ai_platform.market.snapshot.MarketSnapshot` is the ONLY published artefact.
...
::
    ...
    from enterprise_ai_platform.market.integration import MarketIntegrationEngine, MarketIntegrationRequest
