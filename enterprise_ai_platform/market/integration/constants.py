"""
constants.py — enterprise_ai_platform.market.integration
========================================
...
# System identifiers
# ---------------------------------------------------------------------------
INTEGRATION_SYSTEM_ID: str = "enterprise_ai_platform:market:integration"
ENGINE_SYSTEM_ID:      str = "enterprise_ai_platform:market:integration:engine"
MANAGER_SYSTEM_ID:     str = "enterprise_ai_platform:market:integration:manager"
REGISTRY_SYSTEM_ID:    str = "enterprise_ai_platform:market:integration:registry"
VALIDATION_SYSTEM_ID:  str = "enterprise_ai_platform:market:integration:validation"
HEALTH_SYSTEM_ID:      str = "enterprise_ai_platform:market:integration:health"
COMPONENT_SYSTEM_ID:   str = "enterprise_ai_platform:market:integration:components"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_INTEGRATION: str = "enterprise_ai_platform:market:integration"
ACTOR_ENGINE:      str = "enterprise_ai_platform:market:integration:engine"
ACTOR_MANAGER:     str = "enterprise_ai_platform:market:integration:manager"
