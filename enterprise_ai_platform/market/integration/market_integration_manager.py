"""
market_integration_manager.py — enterprise_ai_platform.market.integration
=========================================================
...
Workflow
--------
1. Build :class:`~enterprise_ai_platform.market.engine.MarketRequest` from the integration request
2. Submit to :class:`~enterprise_ai_platform.market.engine.MarketEngine`
3. Build :class:`~enterprise_ai_platform.market.snapshot.MarketSnapshot` from the engine response
...
class MarketIntegrationManager:
    ...
    def _build_engine_request(
        ...
        try:
            from enterprise_ai_platform.market.engine import MarketRequest
            from enterprise_ai_platform.market.engine.constants import MarketWorkflowType, SchedulerPriority
        except ImportError:
            return None
