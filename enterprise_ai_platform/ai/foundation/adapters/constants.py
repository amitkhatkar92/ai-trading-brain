"""
constants.py — enterprise_ai_platform.ai.foundation.adapters
============================================
...
# System identifiers
# ---------------------------------------------------------------------------
ADAPTERS_SYSTEM_ID: str  = "enterprise_ai_platform:ai:foundation:adapters"
PROVIDER_REGISTRY_ID: str = "enterprise_ai_platform:ai:foundation:adapters:registry"
CONFIG_SYSTEM_ID: str    = "enterprise_ai_platform:ai:foundation:adapters:config"
