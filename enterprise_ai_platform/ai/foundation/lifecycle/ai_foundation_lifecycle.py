"""
ai_foundation_lifecycle.py — enterprise_ai_platform.ai.foundation.lifecycle
==========================================================
...
``LifecycleAwareMixin`` (``enterprise_ai_platform.investment.workflow.engine_lifecycle``).
...
Usage example (A2–A10 pattern)::
    ...
    from enterprise_ai_platform.ai.foundation.lifecycle import AILifecycleAwareMixin
    from enterprise_ai_platform.ai.foundation.lifecycle.constants import AILifecycleState

    class MyAIEngine(AILifecycleAwareMixin):
        SYSTEM_ID = "enterprise_ai_platform:ai:my_module:engine"
        VERSION   = "1.0.0"
...
class AILifecycleAwareMixin:
    ...
    SYSTEM_ID : str
        ...
        Example: ``"enterprise_ai_platform:ai:model_management:engine"``
    VERSION : str
