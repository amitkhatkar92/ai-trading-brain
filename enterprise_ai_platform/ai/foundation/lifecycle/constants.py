"""
constants.py — enterprise_ai_platform.ai.foundation.lifecycle
============================================
...
# System identifiers
# ---------------------------------------------------------------------------
LIFECYCLE_SYSTEM_ID: str = "enterprise_ai_platform:ai:foundation:lifecycle"
REGISTRY_SYSTEM_ID:  str = "enterprise_ai_platform:ai:foundation:lifecycle:registry"
FACTORY_SYSTEM_ID:   str = "enterprise_ai_platform:ai:foundation:lifecycle:factory"
...
# Actor identifiers
# ---------------------------------------------------------------------------
ACTOR_LIFECYCLE: str = "enterprise_ai_platform:ai:foundation:lifecycle"
ACTOR_ENGINE:    str = "enterprise_ai_platform:ai:foundation:engine"
ACTOR_GATEWAY:   str = "enterprise_ai_platform:ai:foundation:gateway"
ACTOR_OPERATOR:  str = "operator"
ACTOR_SYSTEM:    str = "enterprise_ai_platform:ai:system"
