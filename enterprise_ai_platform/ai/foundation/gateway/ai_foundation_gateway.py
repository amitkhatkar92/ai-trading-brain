"""
ai_foundation_gateway.py — enterprise_ai_platform.ai.foundation.gateway
======================================================
...
this gateway.  No AI module imports from ``enterprise_ai_platform.ai.foundation.lifecycle``,
``enterprise_ai_platform.ai.foundation.adapters``, or any other internal A1 sub-package.
...
class AIFoundationGateway(AILifecycleAwareMixin):
    ...
    SYSTEM_ID  : str = "enterprise_ai_platform:ai:foundation:gateway"
    VERSION    : str = VERSION
    MODULE_ID  : str = "A1"
