"""
model_management_gateway.py -- enterprise_ai_platform.ai.model_management.gateway
=================================================================
...
from ``enterprise_ai_platform.ai.model_management.registry``, ``.router``, ``.health``, etc.
...
SYSTEM_ID = "enterprise_ai_platform:ai:model_management:gateway"
VERSION   = "1.0.0"
...
class ModelManagementGateway(AILifecycleAwareMixin):
    ...
    Usage::
        ...
        from enterprise_ai_platform.ai.model_management.capabilities import ModelCapabilityType
        from enterprise_ai_platform.ai.model_management.core import ModelCategory
