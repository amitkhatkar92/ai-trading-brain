"""
gateway_protocol.py -- enterprise_ai_platform.ai.platform.gateway_protocol
==========================================================
...
class GatewayProtocol(Protocol):
    ...
    Class attributes (metadata)::
        ...
        SYSTEM_ID   : str   — unique dotted id, e.g. "enterprise_ai_platform:ai:foundation:gateway"
    ...
    Usage::
        ...
        from enterprise_ai_platform.ai.platform import GatewayProtocol
