"""
agent_identity.py -- enterprise_ai_platform.ai.agent_framework.core
===================================================
...
class AgentIdentity:
    ...
    namespace:  str   # Reverse-DNS style, e.g. "enterprise_ai_platform:ai:agents"
    ...
    def create(
        ...
        agent_name: str,
        agent_type: str,
        namespace:  str = "enterprise_ai_platform:ai:agents",
        version:    str = "1.0.0",
    ) -> "AgentIdentity":
