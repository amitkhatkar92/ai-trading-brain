"""
memory_knowledge_gateway.py -- enterprise_ai_platform.ai.memory_knowledge.gateway
================================================================
...
SYSTEM_ID = "enterprise_ai_platform:ai:memory_knowledge:gateway"
...
class MemoryKnowledgeGateway(AILifecycleAwareMixin):
    ...
    SYSTEM_ID  : str = "enterprise_ai_platform:ai:memory_knowledge:gateway"
    VERSION    : str = "1.0.0"
    MODULE_ID  : str = "A4"
