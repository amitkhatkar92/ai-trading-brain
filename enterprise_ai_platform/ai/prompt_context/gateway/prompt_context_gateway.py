"""
prompt_context_gateway.py -- enterprise_ai_platform.ai.prompt_context.gateway
===============================================================
...
``enterprise_ai_platform.ai.prompt_context.registry``, ``.context``, ``.composer``, or
...
SYSTEM_ID = "enterprise_ai_platform:ai:prompt_context:gateway"
VERSION   = "1.0.0"
...
class PromptContextGateway(AILifecycleAwareMixin):
    ...
    Usage::
        ...
        from enterprise_ai_platform.ai.prompt_context.core import PromptCategory
