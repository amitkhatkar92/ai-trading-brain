"""
enterprise_ai_platform.ai.prompt_context.lifecycle
===================================
...
Usage::
    ...
    from enterprise_ai_platform.ai.prompt_context.lifecycle import AILifecycleAwareMixin

    class MyEngine(AILifecycleAwareMixin):
        SYSTEM_ID = "enterprise_ai_platform:ai:prompt_context:my_engine"
        VERSION   = "1.0.0"
