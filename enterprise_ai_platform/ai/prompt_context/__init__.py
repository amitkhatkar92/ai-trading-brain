"""
enterprise_ai_platform.ai.prompt_context
=======================
...
----------------------
M1 Lifecycle          -- enterprise_ai_platform.ai.prompt_context.lifecycle   (re-uses AILifecycleAwareMixin)
M2 Engine             -- enterprise_ai_platform.ai.prompt_context.context, .composer, .versioning
M3 Policy Framework   -- enterprise_ai_platform.ai.prompt_context.policy
M4 Core Framework     -- enterprise_ai_platform.ai.prompt_context.core, .registry, .validation, .events
M5 Snapshot           -- enterprise_ai_platform.ai.prompt_context.snapshot
M6 Gateway            -- enterprise_ai_platform.ai.prompt_context.gateway
