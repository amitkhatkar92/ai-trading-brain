"""
enterprise_ai_platform/monitoring/logging_manager.py
=====================================
...
class LoggingManager:
    ...
    def get_layer_logger(self, layer_name: str) -> IIOSLogger:
        ...
        return self.get_logger(
            f"enterprise_ai_platform.layers.{layer_name.lower()}",
    ...
    def set_component_level(self, component: str, level: str) -> None:
        """Set log level for the ``enterprise_ai_platform.<component>`` namespace."""
        self.set_level(level, f"enterprise_ai_platform.{component.lower()}")
