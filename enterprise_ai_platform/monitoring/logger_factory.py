"""
enterprise_ai_platform/monitoring/logger_factory.py
===================================
...
class IIOSLogger(logging.LoggerAdapter):
    ...
    Usage::
        ...
        log = get_logger("enterprise_ai_platform.risk", component="RiskGuardian", layer="RiskGuardian")
...
class LoggerFactory:
    ...
    def get_logger(
        ...
        **extra: Any,
        ...
        Args:
            name:      Logger name (use dotted module path, e.g. ``"enterprise_ai_platform.risk"``).
        ...
        with _FACTORY_LOCK:
            ...
            if self._log_dir:
                ...
                fh = logging.handlers.RotatingFileHandler(
                    str(self._log_dir / "enterprise_ai_platform.log"),
                    maxBytes=self._max_bytes,
                    backupCount=self._backup_count,
                    encoding="utf-8",
                )
