"""
portfolio_integration_manager.py — enterprise_ai_platform.portfolio.integration
==============================================================
...
class PortfolioIntegrationManager:
    ...
    def _try_lifecycle_init(
        ...
        if lc is None:
            return None
        try:
            from enterprise_ai_platform.portfolio.lifecycle.constants import (
    ...
    def _try_engine(
        ...
        if eng is None:
            return
        try:
            from enterprise_ai_platform.portfolio.engine import PortfolioRequest, PortfolioWorkflowType
    ...
    def _try_policy(
        ...
        if pol is None:
            return
        try:
            from enterprise_ai_platform.portfolio.policies import PortfolioPolicyRequest
    ...
    def _build_and_publish_snapshot(
        ...
        from enterprise_ai_platform.portfolio.snapshot import SnapshotStatus
