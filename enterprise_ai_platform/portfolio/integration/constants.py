"""
constants.py — enterprise_ai_platform.portfolio.integration
==========================================
...
# System identifiers
# ---------------------------------------------------------------------------
INTEGRATION_SYSTEM_ID: str  = "enterprise_ai_platform:portfolio:integration"
ACTOR_INTEGRATION:     str  = "enterprise_ai_platform:portfolio:integration:engine"
ACTOR_MANAGER:         str  = "enterprise_ai_platform:portfolio:integration:manager"
ACTOR_VALIDATOR:       str  = "enterprise_ai_platform:portfolio:integration:validator"
VERSION:               str  = "1.0.0"
