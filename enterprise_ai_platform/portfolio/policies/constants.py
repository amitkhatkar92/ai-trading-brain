"""
constants.py — enterprise_ai_platform.portfolio.policies
=======================================
...
# System identifiers
# ---------------------------------------------------------------------------
POLICY_SYSTEM_ID: str = "enterprise_ai_platform:portfolio:policies"
VERSION:          str = "1.0.0"

ACTOR_POLICY:    str = "enterprise_ai_platform:portfolio:policy"
ACTOR_EVALUATOR: str = "enterprise_ai_platform:portfolio:policy:evaluator"
ACTOR_ENGINE:    str = "enterprise_ai_platform:portfolio:policy:engine"
ACTOR_MANAGER:   str = "enterprise_ai_platform:portfolio:policy:manager"
