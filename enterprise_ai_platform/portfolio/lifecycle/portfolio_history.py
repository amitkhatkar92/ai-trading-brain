"""
portfolio_history.py — enterprise_ai_platform.portfolio.lifecycle
=================================================
Bounded history of portfolio lifecycle events and transitions.
...
from .constants import DEFAULT_MAX_HISTORY, DEFAULT_MAX_TRANSITIONS, PortfolioEventType
...
class PortfolioHistory:
    ...
    def record_transition(self, transition: object) -> None:
        """Append a :class:`PortfolioTransition`."""
        with self._lock:
