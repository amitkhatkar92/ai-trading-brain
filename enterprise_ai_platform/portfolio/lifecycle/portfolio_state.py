"""
portfolio_state.py — enterprise_ai_platform.portfolio.lifecycle
================================================
...
class PortfolioStateRecord:
    """
    Immutable record of a portfolio session entering a particular state.
...
def can_transition(
    ...
    permitted by the institutional portfolio state machine.
