...
**Package:** `enterprise_ai_platform.portfolio.lifecycle`  
**Version:** 1.0.0  
...
```python
from enterprise_ai_platform.portfolio.lifecycle import PortfolioLifecycle, PortfolioType
...
```
enterprise_ai_platform/portfolio/lifecycle/
...
```python
from enterprise_ai_platform.portfolio.lifecycle import can_transition, PortfolioState
