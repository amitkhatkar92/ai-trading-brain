"""
constants.py — enterprise_ai_platform.portfolio.lifecycle
=========================================
...
# System identifiers
# ---------------------------------------------------------------------------
LIFECYCLE_SYSTEM_ID: str = "enterprise_ai_platform:portfolio:lifecycle"
REGISTRY_SYSTEM_ID: str  = "enterprise_ai_platform:portfolio:lifecycle:registry"
FACTORY_SYSTEM_ID:  str  = "enterprise_ai_platform:portfolio:lifecycle:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_LIFECYCLE:  str = "enterprise_ai_platform:portfolio:lifecycle"
...
ACTOR_REBALANCER: str = "enterprise_ai_platform:portfolio:rebalancer"
