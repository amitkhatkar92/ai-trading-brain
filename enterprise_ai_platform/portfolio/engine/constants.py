"""
constants.py — enterprise_ai_platform.portfolio.engine
======================================
...
# System identifiers
# ---------------------------------------------------------------------------
ENGINE_SYSTEM_ID:      str = "enterprise_ai_platform:portfolio:engine"
SCHEDULER_SYSTEM_ID:   str = "enterprise_ai_platform:portfolio:engine:scheduler"
DISPATCHER_SYSTEM_ID:  str = "enterprise_ai_platform:portfolio:engine:dispatcher"
REGISTRY_SYSTEM_ID:    str = "enterprise_ai_platform:portfolio:engine:registry"
FACTORY_SYSTEM_ID:     str = "enterprise_ai_platform:portfolio:engine:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_ENGINE:     str = "enterprise_ai_platform:portfolio:engine"
ACTOR_SCHEDULER:  str = "enterprise_ai_platform:portfolio:engine:scheduler"
ACTOR_DISPATCHER: str = "enterprise_ai_platform:portfolio:engine:dispatcher"
