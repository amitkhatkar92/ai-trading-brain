"""
portfolio_pipeline.py — enterprise_ai_platform.portfolio.engine
==============================================
Portfolio workflow pipeline and stage value objects.
...
class PortfolioPipeline:
    """
    Mutable workflow pipeline tracking the execution of a portfolio request.

    A pipeline is created for every :class:`PortfolioRequest` submitted to the
    ...
    @property
    def workflow_type(self) -> PortfolioWorkflowType:
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"workflow={self._workflow_type.value!r}, "
