"""
constants.py — enterprise_ai_platform.portfolio.optimization
===========================================
...
# System identifiers
# ---------------------------------------------------------------------------
OPTIMIZATION_SYSTEM_ID: str = "enterprise_ai_platform:portfolio:optimization"
VERSION:                str = "1.0.0"

ACTOR_OPTIMIZER:  str = "enterprise_ai_platform:portfolio:optimization:optimizer"
ACTOR_ENGINE:     str = "enterprise_ai_platform:portfolio:optimization:engine"
ACTOR_MANAGER:    str = "enterprise_ai_platform:portfolio:optimization:manager"
ACTOR_SELECTOR:   str = "enterprise_ai_platform:portfolio:optimization:selector"
