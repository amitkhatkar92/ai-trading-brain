"""
constants.py — enterprise_ai_platform.portfolio.snapshot
=======================================
...
# System identifiers
# ---------------------------------------------------------------------------
SNAPSHOT_SYSTEM_ID: str = "enterprise_ai_platform:portfolio:snapshot"
VERSION:            str = "1.0.0"

ACTOR_BUILDER: str = "enterprise_ai_platform:portfolio:snapshot:builder"
ACTOR_STORE:   str = "enterprise_ai_platform:portfolio:snapshot:store"
ACTOR_ENGINE:  str = "enterprise_ai_platform:portfolio:snapshot:engine"
