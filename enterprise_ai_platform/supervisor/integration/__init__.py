"""
enterprise_ai_platform.supervisor.integration — AI Supervisor Integration
========================================================
...
External components MUST NOT directly import from:
  - ``enterprise_ai_platform.supervisor.lifecycle``  (M1)
  - ``enterprise_ai_platform.supervisor.engine``     (M2)
  - ``enterprise_ai_platform.supervisor.policies``   (M3)
  - ``enterprise_ai_platform.supervisor.governance`` (M4)
  - ``enterprise_ai_platform.supervisor.snapshot``   (M5)
"""
