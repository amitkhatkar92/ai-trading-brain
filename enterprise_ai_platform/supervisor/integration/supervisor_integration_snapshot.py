"""
supervisor_integration_snapshot.py — enterprise_ai_platform.supervisor.integration
-----------------------------------------------------------------
...
class SupervisorIntegrationSnapshot:
    ...
    request_id:              str
    session_id:              str
    supervisor_snapshot:     Any            # enterprise_ai_platform.supervisor.snapshot.SupervisorSnapshot
    snapshot_id:             str
