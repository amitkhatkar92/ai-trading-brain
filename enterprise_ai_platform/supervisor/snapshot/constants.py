"""
constants.py — enterprise_ai_platform.supervisor.snapshot
-----------------------------------------
...
SUPERVISOR_SNAPSHOT_SYSTEM_ID: str = "enterprise_ai_platform:supervisor:snapshot"
BUILDER_SYSTEM_ID:             str = "enterprise_ai_platform:supervisor:snapshot:builder"
VALIDATOR_SYSTEM_ID:           str = "enterprise_ai_platform:supervisor:snapshot:validator"
FACTORY_SYSTEM_ID:             str = "enterprise_ai_platform:supervisor:snapshot:factory"
REGISTRY_SYSTEM_ID:            str = "enterprise_ai_platform:supervisor:snapshot:registry"
STORE_SYSTEM_ID:               str = "enterprise_ai_platform:supervisor:snapshot:store"
CACHE_SYSTEM_ID:               str = "enterprise_ai_platform:supervisor:snapshot:cache"
BUNDLE_SYSTEM_ID:              str = "enterprise_ai_platform:supervisor:snapshot:bundle"
