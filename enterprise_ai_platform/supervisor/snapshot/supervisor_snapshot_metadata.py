"""
supervisor_snapshot_metadata.py — enterprise_ai_platform.supervisor.snapshot
-----------------------------------------------------------
        ...
        *,
        ...
        return cls(
            ...
            source_components = source_components or (
                "enterprise_ai_platform:supervisor:lifecycle",
                "enterprise_ai_platform:supervisor:engine",
                "enterprise_ai_platform:supervisor:policies",
                "enterprise_ai_platform:supervisor:governance",
            ),
