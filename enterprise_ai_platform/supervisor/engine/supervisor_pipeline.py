"""
supervisor_pipeline.py — enterprise_ai_platform.supervisor.engine
-------------------------------------------------
Supervisor workflow pipeline and stage value objects.
...
class SupervisorPipeline:
    """
    Mutable workflow pipeline tracking the execution of a supervisor request.

    A pipeline is created for every :class:`SupervisorRequest` submitted to
    ...
    @property
    def workflow_type(self) -> SupervisorWorkflowType:
