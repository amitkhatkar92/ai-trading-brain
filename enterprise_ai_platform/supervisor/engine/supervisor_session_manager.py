"""
supervisor_session_manager.py — enterprise_ai_platform.supervisor.engine
-------------------------------------------------------
...
class SupervisorSessionManager:
    ...
    Wraps :class:`enterprise_ai_platform.supervisor.lifecycle.SupervisorLifecycle` and exposes
