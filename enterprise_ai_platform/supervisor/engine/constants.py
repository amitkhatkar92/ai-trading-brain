"""
constants.py — enterprise_ai_platform.supervisor.engine
=======================================
...
# System identifiers
# ---------------------------------------------------------------------------
ENGINE_SYSTEM_ID:     str = "enterprise_ai_platform:supervisor:engine"
SCHEDULER_SYSTEM_ID:  str = "enterprise_ai_platform:supervisor:engine:scheduler"
DISPATCHER_SYSTEM_ID: str = "enterprise_ai_platform:supervisor:engine:dispatcher"
REGISTRY_SYSTEM_ID:   str = "enterprise_ai_platform:supervisor:engine:registry"
FACTORY_SYSTEM_ID:    str = "enterprise_ai_platform:supervisor:engine:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_ENGINE:     str = "enterprise_ai_platform:supervisor:engine"
ACTOR_SCHEDULER:  str = "enterprise_ai_platform:supervisor:engine:scheduler"
ACTOR_DISPATCHER: str = "enterprise_ai_platform:supervisor:engine:dispatcher"
