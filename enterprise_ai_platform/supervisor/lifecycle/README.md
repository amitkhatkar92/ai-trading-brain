...
**Package:** `enterprise_ai_platform.supervisor.lifecycle`  
...
```python
from enterprise_ai_platform.supervisor.lifecycle import SupervisorLifecycle, SupervisorType, SupervisorScope
