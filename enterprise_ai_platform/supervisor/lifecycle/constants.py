"""
constants.py — enterprise_ai_platform.supervisor.lifecycle
==========================================
...
# System identifiers
# ---------------------------------------------------------------------------
LIFECYCLE_SYSTEM_ID: str = "enterprise_ai_platform:supervisor:lifecycle"
REGISTRY_SYSTEM_ID:  str = "enterprise_ai_platform:supervisor:lifecycle:registry"
FACTORY_SYSTEM_ID:   str = "enterprise_ai_platform:supervisor:lifecycle:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_LIFECYCLE:  str = "enterprise_ai_platform:supervisor:lifecycle"
ACTOR_OPERATOR:   str = "operator"
ACTOR_SYSTEM:     str = "enterprise_ai_platform:system"
ACTOR_SUPERVISOR: str = "enterprise_ai_platform:supervisor:engine"
ACTOR_MONITOR:    str = "enterprise_ai_platform:supervisor:monitor"
