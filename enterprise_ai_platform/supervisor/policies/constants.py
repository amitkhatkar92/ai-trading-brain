"""
constants.py — enterprise_ai_platform.supervisor.policies
-----------------------------------------
...
AI_GOVERNANCE_SYSTEM_ID:   str = "enterprise_ai_platform:supervisor:governance"
EVALUATOR_SYSTEM_ID:       str = "enterprise_ai_platform:supervisor:governance:evaluator"
REGISTRY_SYSTEM_ID:        str = "enterprise_ai_platform:supervisor:governance:registry"
FACTORY_SYSTEM_ID:         str = "enterprise_ai_platform:supervisor:governance:factory"
CHAIN_SYSTEM_ID:           str = "enterprise_ai_platform:supervisor:governance:chain"
AUDIT_SYSTEM_ID:           str = "enterprise_ai_platform:supervisor:governance:audit"
MANAGER_SYSTEM_ID:         str = "enterprise_ai_platform:supervisor:governance:manager"
