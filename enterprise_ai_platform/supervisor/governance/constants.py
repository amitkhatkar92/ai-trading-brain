"""
constants.py — enterprise_ai_platform.supervisor.governance
------------------------------------------
...
AUTONOMOUS_GOVERNANCE_SYSTEM_ID:   str = "enterprise_ai_platform:supervisor:autonomous_governance"
REASONING_SYSTEM_ID:               str = "enterprise_ai_platform:supervisor:autonomous_governance:reasoning"
COORDINATION_SYSTEM_ID:            str = "enterprise_ai_platform:supervisor:autonomous_governance:coordination"
DETECTION_SYSTEM_ID:               str = "enterprise_ai_platform:supervisor:autonomous_governance:detection"
MANAGER_SYSTEM_ID:                 str = "enterprise_ai_platform:supervisor:autonomous_governance:manager"
REGISTRY_SYSTEM_ID:                str = "enterprise_ai_platform:supervisor:autonomous_governance:registry"
FACTORY_SYSTEM_ID:                 str = "enterprise_ai_platform:supervisor:autonomous_governance:factory"
