"""
constants.py — enterprise_ai_platform.supervisor.policy
=======================================
...
# System identifiers
# ---------------------------------------------------------------------------
POLICY_SYSTEM_ID:    str = "enterprise_ai_platform:supervisor:policy"
EVALUATOR_SYSTEM_ID: str = "enterprise_ai_platform:supervisor:policy:evaluator"
REGISTRY_SYSTEM_ID:  str = "enterprise_ai_platform:supervisor:policy:registry"
FACTORY_SYSTEM_ID:   str = "enterprise_ai_platform:supervisor:policy:factory"
CHAIN_SYSTEM_ID:     str = "enterprise_ai_platform:supervisor:policy:chain"
...
# Actors
# ---------------------------------------------------------------------------
ACTOR_POLICY_ENGINE: str = "enterprise_ai_platform:supervisor:policy:engine"
ACTOR_EVALUATOR:     str = "enterprise_ai_platform:supervisor:policy:evaluator"
ACTOR_REGISTRY:      str = "enterprise_ai_platform:supervisor:policy:registry"
