"""
governance_policy_rule.py — enterprise_ai_platform.supervisor.policy
----------------------------------------------------
Immutable governance policy rule value object.

A rule combines one or more :class:`GovernancePolicyCondition` objects
with a :class:`~.constants.LogicalOperator` and maps to a
...
class GovernancePolicyRule:
    ...
    logical_operator :  How conditions are combined (ALL / ANY).
    ...
    rule_id:           str
    name:              str
    conditions:        Tuple[GovernancePolicyCondition, ...]
