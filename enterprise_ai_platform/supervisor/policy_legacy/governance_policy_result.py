"""
governance_policy_result.py — enterprise_ai_platform.supervisor.policy
------------------------------------------------------
...
from .constants import VERSION, GovernancePolicyType, PolicyAction, PolicyPriority
...
class GovernancePolicyResult:
    ...
    policy_type :           Governance domain of the policy.
