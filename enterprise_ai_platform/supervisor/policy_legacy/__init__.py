"""
enterprise_ai_platform.supervisor.policy_legacy — AI Governance Policy Framework (superseded draft)
==================================================================================

This package is the original M3 Policy Framework implementation for C13.
It has been superseded by ``enterprise_ai_platform.supervisor.policies`` (AIGovernancePolicy* naming).
