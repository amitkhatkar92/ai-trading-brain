"""enterprise_ai_platform/decision_governance/governance_context.py
...
from enterprise_ai_platform.decision_governance.governance_constants import GovernanceMode
