"""enterprise_ai_platform/decision_governance/certification/certification_engine.py
...
from enterprise_ai_platform.decision_governance.governance_constants import DEFAULT_CERT_TTL_SEC
