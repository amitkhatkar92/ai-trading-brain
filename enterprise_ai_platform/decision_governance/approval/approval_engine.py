"""enterprise_ai_platform/decision_governance/approval/approval_engine.py
...
class ApprovalEngine:
    ...
    def approve_manual(
        ...
        record = ApprovalRecord(
            ...
            mode=__import__(
                "enterprise_ai_platform.decision_governance.governance_constants",
    ...
    def reject_manual(
        ...
        from enterprise_ai_platform.decision_governance.governance_constants import ApprovalMode  # noqa: PLC0415
        record = ApprovalRecord(
            decision_id=existing.decision_id,
            policy_id="manual_override",
            policy_name="Manual Override",
