"""enterprise_ai_platform/decision_governance/approval/approval_policy.py
...
from enterprise_ai_platform.decision_governance.approval.approval_result import ApprovalRecord
