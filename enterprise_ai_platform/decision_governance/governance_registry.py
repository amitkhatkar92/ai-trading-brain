"""enterprise_ai_platform/decision_governance/governance_registry.py
...
from enterprise_ai_platform.decision_governance.governance_constants import MAX_REGISTRY_SIZE
