"""
decision_state.py — enterprise_ai_platform.decision.lifecycle
=============================================
...
class DecisionStateRecord:
    """
    Immutable record of a decision session entering a particular state.
...
def can_transition(
    ...
    permitted by the institutional decision state machine.
