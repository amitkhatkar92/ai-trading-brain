"""
constants.py — enterprise_ai_platform.decision.lifecycle
=======================================
...
# System identifiers
# ---------------------------------------------------------------------------
LIFECYCLE_SYSTEM_ID: str = "enterprise_ai_platform:decision:lifecycle"
REGISTRY_SYSTEM_ID: str  = "enterprise_ai_platform:decision:lifecycle:registry"
FACTORY_SYSTEM_ID: str   = "enterprise_ai_platform:decision:lifecycle:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_LIFECYCLE: str = "enterprise_ai_platform:decision:lifecycle"
...
ACTOR_SCHEDULER: str = "enterprise_ai_platform:decision:scheduler"
