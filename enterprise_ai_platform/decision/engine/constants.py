"""
constants.py — enterprise_ai_platform.decision.engine
=====================================
...
# System identifiers
# ---------------------------------------------------------------------------
ENGINE_SYSTEM_ID:     str = "enterprise_ai_platform:decision:engine"
MANAGER_SYSTEM_ID:    str = "enterprise_ai_platform:decision:engine:manager"
SCHEDULER_SYSTEM_ID:  str = "enterprise_ai_platform:decision:engine:scheduler"
DISPATCHER_SYSTEM_ID: str = "enterprise_ai_platform:decision:engine:dispatcher"
REGISTRY_SYSTEM_ID:   str = "enterprise_ai_platform:decision:engine:registry"
FACTORY_SYSTEM_ID:    str = "enterprise_ai_platform:decision:engine:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_ENGINE:     str = "enterprise_ai_platform:decision:engine"
ACTOR_SCHEDULER:  str = "enterprise_ai_platform:decision:engine:scheduler"
ACTOR_DISPATCHER: str = "enterprise_ai_platform:decision:engine:dispatcher"
ACTOR_MANAGER:    str = "enterprise_ai_platform:decision:engine:manager"
