"""
exceptions.py — enterprise_ai_platform.decision.engine
======================================
...
class DecisionRequestValidationError(DecisionEngineError):
    """
    Raised when a :class:`~enterprise_ai_platform.decision.engine.DecisionRequest` fails
...
class DecisionPipelineError(DecisionEngineError):
    """
    Raised when a :class:`~enterprise_ai_platform.decision.engine.DecisionPipeline` encounters
...
class DecisionDispatchError(DecisionEngineError):
    """
    Raised when the :class:`~enterprise_ai_platform.decision.engine.DecisionDispatcher` fails
