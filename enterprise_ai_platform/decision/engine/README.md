# enterprise_ai_platform.decision.engine — Decision Engine
...
```python
from enterprise_ai_platform.decision.engine import DecisionEngine, DecisionRequest
...
```python
from enterprise_ai_platform.decision.engine.constants import (
    ENGINE_SYSTEM_ID,     # "enterprise_ai_platform:decision:engine"
    VERSION,              # "1.0.0"
    SCHEMA_VERSION,       # "1.0"
