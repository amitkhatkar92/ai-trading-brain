"""
constants.py — enterprise_ai_platform.decision.integration
=========================================
...
INTEGRATION_SYSTEM_ID: str = "enterprise_ai_platform:decision:integration"
VERSION:               str = "1.0.0"
...
SOURCE_M1: str = "enterprise_ai_platform:decision:lifecycle"
SOURCE_M2: str = "enterprise_ai_platform:decision:engine"
SOURCE_M3: str = "enterprise_ai_platform:decision:policies"
SOURCE_M4: str = "enterprise_ai_platform:decision:optimization"
SOURCE_M5: str = "enterprise_ai_platform:decision:snapshot"
