"""
decision_component_factory.py — enterprise_ai_platform.decision.integration
==========================================================
...
class DecisionComponentFactory:
    ...
    def _make_engine(self):
        from enterprise_ai_platform.decision.engine import DecisionEngine
        return DecisionEngine()

    def _make_policy(self):
        from enterprise_ai_platform.decision.policies import DecisionPolicyEngine
        return DecisionPolicyEngine()

    def _make_optimization(self):
        from enterprise_ai_platform.decision.optimization import DecisionOptimizationEngine
