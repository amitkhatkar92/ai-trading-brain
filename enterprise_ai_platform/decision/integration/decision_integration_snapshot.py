"""
decision_integration_snapshot.py — enterprise_ai_platform.decision.integration
=============================================================
...
class DecisionIntegrationSnapshot:
    ...
    Wraps the M5 :class:`~enterprise_ai_platform.decision.snapshot.DecisionSnapshot` with
