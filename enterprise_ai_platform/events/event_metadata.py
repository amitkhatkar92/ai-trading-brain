"""
enterprise_ai_platform/events/event_metadata.py
================================
...
class EventMetadata:
    ...
    event_type: str = ""
    source: str = "enterprise_ai_platform"
...
class Event:
    ...
    Usage::
        ...
        from enterprise_ai_platform.events import Event, EventMetadata, EventPriority
