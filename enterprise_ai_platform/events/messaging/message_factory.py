"""
enterprise_ai_platform/events/messaging/message_factory.py
==========================================
...
class MessageFactory:
    ...
    def __init__(self, source: str = "enterprise_ai_platform") -> None:
        self._source = source
    ...
    @classmethod
    def make(cls, source: str = "enterprise_ai_platform") -> "MessageFactory":
