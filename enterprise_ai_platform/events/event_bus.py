"""
enterprise_ai_platform/events/event_bus.py
=========================
...
_LOG = logging.getLogger("enterprise_ai_platform.events.bus")
...
class EventBus:
    ...
    def _ensure_scheduler(self) -> None:
        ...
        t = threading.Thread(target=self._scheduler_loop, daemon=True, name="enterprise_ai_platform.event-scheduler")
