"""
enterprise_ai_platform/knowledge/governance/governance_registry.py
================================================
...
_LOG = logging.getLogger("enterprise_ai_platform.knowledge.governance.governance_registry")
