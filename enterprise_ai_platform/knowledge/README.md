# Knowledge Engine (Wave 3) — enterprise_ai_platform.knowledge
...
```python
from enterprise_ai_platform.knowledge import get_knowledge_engine, get_knowledge_manager
...
- `enterprise_ai_platform.knowledge.knowledge_store`
- `enterprise_ai_platform.knowledge.knowledge_item`
- `enterprise_ai_platform.knowledge.knowledge_validator`
- `enterprise_ai_platform.knowledge.knowledge_manager`
