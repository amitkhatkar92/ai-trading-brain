"""
knowledge_integration_snapshot.py — enterprise_ai_platform.knowledge.integration
---------------------------------------------------------------
...
class KnowledgeIntegrationSnapshot:
    ...
    Distinct from enterprise_ai_platform.knowledge.snapshot.KnowledgeSnapshot, which represents
