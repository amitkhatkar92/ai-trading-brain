"""
knowledge_component_registry.py — enterprise_ai_platform.knowledge.integration
------------------------------------------------------------
...
class KnowledgeComponentRegistry:
    ...
    Components:
      lifecycle    — enterprise_ai_platform.knowledge.lifecycle.KnowledgeLifecycle   (M1)
      engine       — enterprise_ai_platform.knowledge.engine.KnowledgeEngine          (M2)
      governance   — enterprise_ai_platform.knowledge.governance.PolicyManager        (M3)
      intelligence — enterprise_ai_platform.knowledge.intelligence.KnowledgeIntelligenceEngine (M4)
      snapshot     — enterprise_ai_platform.knowledge.snapshot.KnowledgeSnapshotFactory  (M5)
    """
