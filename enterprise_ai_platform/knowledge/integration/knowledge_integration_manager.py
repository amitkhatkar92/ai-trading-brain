"""
knowledge_integration_manager.py — enterprise_ai_platform.knowledge.integration
-------------------------------------------------------------
...
class KnowledgeIntegrationManager:
    ...
    def _run_lifecycle(
        ...
        try:
            from enterprise_ai_platform.knowledge.lifecycle import KnowledgeType, KnowledgeSource
    ...
    def _run_engine(
        ...
        try:
            ...
            eng_ctx = KnowledgeEngineContext(
                ...
                subsystem_id = "enterprise_ai_platform:knowledge:integration",
