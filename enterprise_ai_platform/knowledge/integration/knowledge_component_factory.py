"""
knowledge_component_factory.py — enterprise_ai_platform.knowledge.integration
------------------------------------------------------------
...
class KnowledgeComponentFactory:
    ...
    def create_lifecycle(self) -> Optional[Any]:
        """M1: KnowledgeLifecycle from enterprise_ai_platform.knowledge.lifecycle."""
        cls = _try_import("enterprise_ai_platform.knowledge.lifecycle", "KnowledgeLifecycle")
        if cls is None:
            return None
        try:
            instance = cls()
    ...
    def create_engine(self) -> Optional[Any]:
        """M2: KnowledgeEngine from enterprise_ai_platform.knowledge.engine."""
        cls = _try_import("enterprise_ai_platform.knowledge.engine", "KnowledgeEngine")
        if cls is None:
            return None
        try:
            instance = cls()
    ...
    def create_governance(self) -> Optional[Any]:
        """M3: PolicyManager from enterprise_ai_platform.knowledge.governance."""
        cls = _try_import("enterprise_ai_platform.knowledge.governance", "PolicyManager")
        if cls is None:
            return None
        try:
            return cls()
    ...
    def create_intelligence(self) -> Optional[Any]:
        """M4: KnowledgeIntelligenceEngine from enterprise_ai_platform.knowledge.intelligence."""
        cls = _try_import(
            "enterprise_ai_platform.knowledge.intelligence", "KnowledgeIntelligenceEngine"
        )
        if cls is None:
            return None
        try:
    ...
    def create_snapshot_factory(self) -> Any:
        """M5: KnowledgeSnapshotFactory from enterprise_ai_platform.knowledge.snapshot (always available)."""
