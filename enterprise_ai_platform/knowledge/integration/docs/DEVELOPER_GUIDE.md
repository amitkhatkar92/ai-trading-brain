...
Always import from `enterprise_ai_platform.knowledge.integration`:
...
from enterprise_ai_platform.knowledge.integration.knowledge_integration_engine import KnowledgeIntegrationEngine
```
...
```python
from enterprise_ai_platform.knowledge.integration import IntegrationEvent, IntegrationEventType
