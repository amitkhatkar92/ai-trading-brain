"""
constants.py — enterprise_ai_platform.knowledge.policies
========================================
...
# System identifiers
# ---------------------------------------------------------------------------
GOVERNANCE_SYSTEM_ID: str = "enterprise_ai_platform:knowledge:governance"
EVALUATOR_SYSTEM_ID:  str = "enterprise_ai_platform:knowledge:governance:evaluator"
REGISTRY_SYSTEM_ID:   str = "enterprise_ai_platform:knowledge:governance:registry"
CHAIN_SYSTEM_ID:      str = "enterprise_ai_platform:knowledge:governance:chain"
AUDIT_SYSTEM_ID:      str = "enterprise_ai_platform:knowledge:governance:audit"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_GOVERNANCE: str = "enterprise_ai_platform:knowledge:governance"
ACTOR_EVALUATOR:  str = "enterprise_ai_platform:knowledge:governance:evaluator"
ACTOR_AUDITOR:    str = "enterprise_ai_platform:knowledge:governance:audit"
