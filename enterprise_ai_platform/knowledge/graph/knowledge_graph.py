"""
enterprise_ai_platform/knowledge/graph/knowledge_graph.py
========================================
...
_LOG = logging.getLogger("enterprise_ai_platform.knowledge.graph")
...
class KnowledgeGraph:
    ...
    Usage::
        ...
        graph.add_edge(ref)
        neighbours = graph.successors("enterprise_ai_platform.knowledge/abc")
        path = graph.shortest_path("enterprise_ai_platform.knowledge/abc", "enterprise_ai_platform.knowledge/xyz")
    """
