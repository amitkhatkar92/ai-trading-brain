"""
constants.py — enterprise_ai_platform.knowledge.engine
=======================================
...
# System identifiers
# ---------------------------------------------------------------------------
ENGINE_SYSTEM_ID:     str = "enterprise_ai_platform:knowledge:engine"
SCHEDULER_SYSTEM_ID:  str = "enterprise_ai_platform:knowledge:engine:scheduler"
DISPATCHER_SYSTEM_ID: str = "enterprise_ai_platform:knowledge:engine:dispatcher"
REGISTRY_SYSTEM_ID:   str = "enterprise_ai_platform:knowledge:engine:registry"
FACTORY_SYSTEM_ID:    str = "enterprise_ai_platform:knowledge:engine:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_ENGINE:     str = "enterprise_ai_platform:knowledge:engine"
ACTOR_SCHEDULER:  str = "enterprise_ai_platform:knowledge:engine:scheduler"
ACTOR_DISPATCHER: str = "enterprise_ai_platform:knowledge:engine:dispatcher"
