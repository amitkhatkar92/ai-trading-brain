"""
enterprise_ai_platform/knowledge/versioning/version_factory.py
=============================================
...
Usage::
    ...
    from enterprise_ai_platform.knowledge.versioning.version_factory import get_version_factory

    factory = get_version_factory()
    branch  = factory.create_branch(knowledge_id="enterprise_ai_platform.knowledge/uuid", name="experimental")
