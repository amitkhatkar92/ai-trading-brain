"""
enterprise_ai_platform/knowledge/versioning/knowledge_versioning.py
==================================================
...
_LOG = logging.getLogger("enterprise_ai_platform.knowledge.versioning")
...
class KnowledgeVersioningEngine:
    ...
    Usage::
        ...
        history = engine.history("enterprise_ai_platform.knowledge/abc-uuid")
