...
```python
from enterprise_ai_platform.knowledge.intelligence import VectorIndex, VectorIndexEngine
...
```python
from enterprise_ai_platform.knowledge.intelligence import VectorIndexEngine
...
```python
from enterprise_ai_platform.knowledge.intelligence import VectorStoreAdapter, VectorSearchResult
...
```python
from enterprise_ai_platform.knowledge.intelligence import VectorStoreManager, EmbeddingEngine
