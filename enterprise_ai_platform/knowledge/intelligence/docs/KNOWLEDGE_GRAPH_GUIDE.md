...
```python
from enterprise_ai_platform.knowledge.intelligence import KnowledgeEntity, EntityType
...
```python
from enterprise_ai_platform.knowledge.intelligence import KnowledgeRelationship, RelationshipType
...
```python
from enterprise_ai_platform.knowledge.intelligence import KnowledgeGraph
...
```python
from enterprise_ai_platform.knowledge.intelligence import EntityResolutionEngine
...
```python
from enterprise_ai_platform.knowledge.intelligence import RelationshipEngine
