...
```python
from enterprise_ai_platform.knowledge.intelligence import EmbeddingEngine
...
```python
from enterprise_ai_platform.knowledge.intelligence import EmbeddingProvider, EmbeddingEngine
...
```python
from enterprise_ai_platform.knowledge.intelligence import EmbeddingRegistry
