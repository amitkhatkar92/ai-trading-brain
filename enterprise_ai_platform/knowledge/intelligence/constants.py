"""
constants.py — enterprise_ai_platform.knowledge.intelligence
===========================================
...
# System identifiers
# ---------------------------------------------------------------------------
INTELLIGENCE_SYSTEM_ID: str = "enterprise_ai_platform:knowledge:intelligence"
GRAPH_SYSTEM_ID:        str = "enterprise_ai_platform:knowledge:intelligence:graph"
EMBEDDING_SYSTEM_ID:    str = "enterprise_ai_platform:knowledge:intelligence:embedding"
VECTOR_SYSTEM_ID:       str = "enterprise_ai_platform:knowledge:intelligence:vector"
RETRIEVAL_SYSTEM_ID:    str = "enterprise_ai_platform:knowledge:intelligence:retrieval"
MEMORY_SYSTEM_ID:       str = "enterprise_ai_platform:knowledge:intelligence:memory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_INTELLIGENCE: str = "enterprise_ai_platform:knowledge:intelligence"
ACTOR_GRAPH:        str = "enterprise_ai_platform:knowledge:intelligence:graph"
ACTOR_EMBEDDING:    str = "enterprise_ai_platform:knowledge:intelligence:embedding"
ACTOR_RETRIEVAL:    str = "enterprise_ai_platform:knowledge:intelligence:retrieval"
