"""
enterprise_ai_platform/knowledge/repositories/knowledge_repository.py
====================================================
...
_LOG = logging.getLogger("enterprise_ai_platform.knowledge.repository")
...
class KnowledgeRepository:
    ...
    Usage::
        ...
        repo.add(record)
        record = repo.get("enterprise_ai_platform.knowledge/uuid")
        result = repo.query(KnowledgeQuery())
        repo.delete("enterprise_ai_platform.knowledge/uuid")
    """
