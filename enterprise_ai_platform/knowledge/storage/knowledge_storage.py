"""
enterprise_ai_platform/knowledge/storage/knowledge_storage.py
============================================
...
_LOG = logging.getLogger("enterprise_ai_platform.knowledge.storage")
...
class KnowledgeStorage:
    ...
    Usage::
        ...
        store.put(record)
        record = store.get("enterprise_ai_platform.knowledge/some-uuid")
        store.delete("enterprise_ai_platform.knowledge/some-uuid")
    """
