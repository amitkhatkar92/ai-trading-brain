"""
enterprise_ai_platform/knowledge/storage/knowledge_cache.py
==========================================
...
_LOG = logging.getLogger("enterprise_ai_platform.knowledge.cache")
...
class KnowledgeCache:
    ...
    def _init_cache(self) -> None:
        try:
            from enterprise_ai_platform.infrastructure.cache.cache_manager import get_cache_manager
