"""
enterprise_ai_platform/knowledge/search/search_constants.py
==========================================
...
SEARCH_NAMESPACE:       Final[str]   = "enterprise_ai_platform.search"
SYSTEM_SEARCH_ACTOR:    Final[str]   = "enterprise_ai_platform:system"
