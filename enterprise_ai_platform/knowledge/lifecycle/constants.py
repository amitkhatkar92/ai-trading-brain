"""
constants.py — enterprise_ai_platform.knowledge.lifecycle
=========================================
...
# System identifiers
# ---------------------------------------------------------------------------
LIFECYCLE_SYSTEM_ID: str = "enterprise_ai_platform:knowledge:lifecycle"
REGISTRY_SYSTEM_ID:  str = "enterprise_ai_platform:knowledge:lifecycle:registry"
FACTORY_SYSTEM_ID:   str = "enterprise_ai_platform:knowledge:lifecycle:factory"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_LIFECYCLE:  str = "enterprise_ai_platform:knowledge:lifecycle"
