...
The `enterprise_ai_platform.knowledge.lifecycle` package manages the institutional lifecycle of
knowledge artifacts from creation through archival.

## Quick Start

```python
from enterprise_ai_platform.knowledge.lifecycle import KnowledgeLifecycle, KnowledgeType
