...
Always import from `enterprise_ai_platform.knowledge.snapshot` (the package root), not from
...
# ❌ Avoid
from enterprise_ai_platform.knowledge.snapshot.knowledge_snapshot import KnowledgeSnapshot
```
