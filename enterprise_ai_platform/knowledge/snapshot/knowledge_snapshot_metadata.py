"""
knowledge_snapshot_metadata.py — enterprise_ai_platform.knowledge.snapshot
----------------------------------------------------------
...
class SnapshotMetadataBuilder:
    ...
    Usage:
        metadata = (
            ...
            .with_source_components(["enterprise_ai_platform.lifecycle", "enterprise_ai_platform.engine"])
    ...
    def default(cls) -> SnapshotMetadata:
        ...
        return (
            ...
            .with_source_components(
                [
                    "enterprise_ai_platform.knowledge.lifecycle",
                    "enterprise_ai_platform.knowledge.engine",
                    "enterprise_ai_platform.knowledge.policies",
                    "enterprise_ai_platform.knowledge.intelligence",
                ]
            )
            .auto_trace()
            .build()
