"""
constants.py — enterprise_ai_platform.knowledge.snapshot
========================================
...
# System identifiers
# ---------------------------------------------------------------------------
SNAPSHOT_SYSTEM_ID: str = "enterprise_ai_platform:knowledge:snapshot"
BUILDER_SYSTEM_ID:  str = "enterprise_ai_platform:knowledge:snapshot:builder"
STORE_SYSTEM_ID:    str = "enterprise_ai_platform:knowledge:snapshot:store"
CACHE_SYSTEM_ID:    str = "enterprise_ai_platform:knowledge:snapshot:cache"
...
# Actor constants
# ---------------------------------------------------------------------------
ACTOR_SNAPSHOT: str = "enterprise_ai_platform:knowledge:snapshot"
ACTOR_BUILDER:  str = "enterprise_ai_platform:knowledge:snapshot:builder"
