...
def _reset_all():
    from enterprise_ai_platform.intelligence.reasoning import (
...
def _engine():
    from enterprise_ai_platform.intelligence.reasoning import get_reasoning_engine
...
class TestConstants:
    def test_reasoning_types(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningType
    ...
    def test_evidence_strength_ordered(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceStrength
    ...
    def test_confidence_level_values(self):
        from enterprise_ai_platform.intelligence.reasoning import ConfidenceLevel
        levels = [l.value for l in ConfidenceLevel]
        assert "very_low" in levels
        assert "certain"  in levels

    def test_debate_roles(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateRole
    ...
    def test_version_string(self):
        from enterprise_ai_platform.intelligence.reasoning import REASONING_ENGINE_VERSION
...
class TestReasoningContext:
    ...
    def test_nested_depth(self):
        from enterprise_ai_platform.intelligence.reasoning import get_reasoning_context, reasoning_session_scope
    ...
    def test_debate_scope(self):
        from enterprise_ai_platform.intelligence.reasoning import get_reasoning_context, debate_scope, reasoning_session_scope
...
class TestReasoningResult:
    def test_is_successful(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningResult, ReasoningStatus
    ...
    def test_to_dict(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningResult, ConfidenceLevel
    ...
    def test_reasoning_output(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningOutput, ReasoningType
        o = ReasoningOutput(
            reasoner_id    = "r1",
            conclusion     = "SELL",
            confidence     = 0.6,
...
class TestReasoningSession:
    def test_lifecycle(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningSession, ReasoningStatus, ReasoningResult
    ...
    def test_cancel(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningSession, ReasoningStatus
        s = ReasoningSession(topic="test")
        s.start()
        s.cancel()
    ...
    def test_evidence_tracking(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningSession
        s = ReasoningSession(topic="test")
        s.add_evidence("e1")
        s.add_evidence("e2")
...
class TestEvidenceItem:
    def test_composite_score(self):
        from enterprise_ai_platform.intelligence.reasoning import Evidence, EvidenceStrength
        e = Evidence(strength=EvidenceStrength.STRONG, confidence=0.8)
        expected = (3 / 5) * 0.8
        assert abs(e.composite_score - expected) < 1e-9

    def test_is_valid(self):
        from enterprise_ai_platform.intelligence.reasoning import Evidence, EvidenceStatus
    ...
    def test_to_dict(self):
        from enterprise_ai_platform.intelligence.reasoning import Evidence, EvidenceType
...
class TestEvidenceRegistry:
    ...
    def test_not_found(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceRegistry, EvidenceNotFoundError
        reg = EvidenceRegistry()
        with pytest.raises(EvidenceNotFoundError):
            reg.get("ghost")

    def test_by_session(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceRegistry, Evidence
        reg = EvidenceRegistry()
        for i in range(3):
...
class TestEvidenceValidator:
    def test_valid_evidence(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceValidator, Evidence, EvidenceStatus
        v = EvidenceValidator()
    ...
    def test_empty_claim_fails(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceValidator, Evidence
        v = EvidenceValidator()
...
class TestEvidenceRanker:
    def test_ranking_order(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceRanker, Evidence, EvidenceStrength
        r  = EvidenceRanker()
    ...
    def test_top_n(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceRanker, Evidence
        r     = EvidenceRanker()
    ...
    def test_empty_list(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceRanker
...
class TestEvidenceGraph:
    def test_add_node_and_edge(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceGraph, EvidenceRelation
        g = EvidenceGraph()
        g.add_node("e1")
        g.add_node("e2")
...
class TestEvidenceChain:
    def test_add_links(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceChain, Evidence
    ...
    def test_empty_chain(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceChain
...
class TestEvidenceManager:
    def test_add_and_get(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceManager, EvidenceType
        mgr = EvidenceManager()
        ev  = mgr.add(
    ...
    def test_validate_session(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceManager
        mgr = EvidenceManager()
    ...
    def test_rank(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceManager, EvidenceStrength
        mgr = EvidenceManager()
    ...
    def test_require_evidence_raises(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceManager, InsufficientEvidenceError
        mgr = EvidenceManager()
...
class TestArgument:
    def test_is_supporting(self):
        from enterprise_ai_platform.intelligence.reasoning import Argument, ArgumentType
    ...
    def test_weighted_confidence(self):
        from enterprise_ai_platform.intelligence.reasoning import Argument
...
class TestCounterArgument:
    def test_from_argument(self):
        from enterprise_ai_platform.intelligence.reasoning import Argument, CounterArgument, ArgumentType
...
class TestDebateRound:
    def test_add_and_close(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateRound, Argument, ArgumentType, DebateStatus
    ...
    def test_consensus_score_all_support(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateRound, Argument, ArgumentType
        rnd = DebateRound()
        for _ in range(3):
    ...
    def test_add_after_close_raises(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateRound, Argument
        rnd = DebateRound()
        rnd.close()
...
class TestDebateSession:
    def test_add_participant(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateSession, DebateRole
    ...
    def test_start_and_close_round(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateSession, DebateStatus
        ds  = DebateSession(topic="T", proposition="P")
        rnd = ds.start_round()
    ...
    def test_is_consensus_reached(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateSession, Argument, ArgumentType
    ...
    def test_to_dict(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateSession
...
class TestDebateEngine:
    def test_create_and_add_participants(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateEngine, DebateRole
        eng = DebateEngine()
    ...
    def test_submit_argument(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateEngine, DebateRole, ArgumentType
        eng = DebateEngine()
        ds  = eng.create_session(topic="T", proposition="P")
    ...
    def test_check_consensus_no_arguments(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateEngine
        eng = DebateEngine()
    ...
    def test_summarize(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateEngine, ArgumentType
        eng = DebateEngine()
    ...
    def test_not_found_raises(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateEngine, DebateNotFoundError
        eng = DebateEngine()
...
class TestDebateManager:
    ...
    def test_conduct_debate_reaches_consensus(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateManager, DebateRole
        mgr = DebateManager()
        mgr.initialize()
    ...
    def test_insufficient_participants_raises(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateManager, InsufficientParticipantsError
        mgr = DebateManager()
        mgr.initialize()
    ...
    def test_deadlock_on_no_consensus(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateManager, DebateRole, DebateStatus, Argument, ArgumentType
    ...
    def test_stats(self):
        from enterprise_ai_platform.intelligence.reasoning import DebateManager
        mgr = DebateManager()
        mgr.initialize()
        s = mgr.stats()
...
class TestConfidenceModel:
    def test_compute_all_high(self):
        from enterprise_ai_platform.intelligence.reasoning import ConfidenceModel
        m = ConfidenceModel(
    ...
    def test_score_to_level(self):
        from enterprise_ai_platform.intelligence.reasoning import ConfidenceModel, ConfidenceLevel
...
class TestConfidenceCalculator:
    def test_evidence_confidence(self):
        from enterprise_ai_platform.intelligence.reasoning import ConfidenceCalculator, Evidence, EvidenceStrength
    ...
    def test_source_confidence_unknown(self):
        from enterprise_ai_platform.intelligence.reasoning import ConfidenceCalculator
        calc = ConfidenceCalculator()
...
class TestConfidenceEngine:
    ...
    def test_no_evidence_produces_warnings(self):
        from enterprise_ai_platform.intelligence.reasoning import ConfidenceEngine
        eng    = ConfidenceEngine()
...
class TestReasoningTrace:
    def test_add_steps(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningTrace, TraceStepType
        t = ReasoningTrace("s1")
...
class TestProofChain:
    def test_valid_chain(self):
        from enterprise_ai_platform.intelligence.reasoning import ProofChain
    ...
    def test_overflow_raises(self):
        from enterprise_ai_platform.intelligence.reasoning import ProofChain
        from enterprise_ai_platform.intelligence.reasoning.reasoning_constants import MAX_PROOF_CHAIN_STEPS
        chain = ProofChain("s1")
...
class TestExplanationEngine:
    def test_create_and_get_explanation(self):
        from enterprise_ai_platform.intelligence.reasoning import ExplanationEngine, Evidence, ExplanationType
    ...
    def test_trace_auto_created_on_record(self):
        from enterprise_ai_platform.intelligence.reasoning import ExplanationEngine, TraceStepType
        eng = ExplanationEngine()
    ...
    def test_proof_chain_stored(self):
        from enterprise_ai_platform.intelligence.reasoning import ExplanationEngine
        eng   = ExplanationEngine()
    ...
    def test_generate_text_formats(self):
        from enterprise_ai_platform.intelligence.reasoning import ExplanationEngine, ExplanationType
        eng = ExplanationEngine()
        exp = eng.create_explanation(
            session_id = "s1",
            conclusion = "BUY",
...
class TestReasoningRegistry:
    ...
    def test_duplicate_raises(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningSessionRegistry, ReasoningSession, SessionAlreadyExistsError
        reg = ReasoningSessionRegistry()
        s   = ReasoningSession(topic="test")
        reg.register(s)
    ...
    def test_overwrite(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningSessionRegistry, ReasoningSession
        reg = ReasoningSessionRegistry()
...
class TestReasoningManager:
    def _mgr(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningManager
        m = ReasoningManager()
        m.initialize()
        return m

    def test_create_session(self):
        from enterprise_ai_platform.intelligence.reasoning import ReasoningStatus
        mgr = self._mgr()
        s   = mgr.create_session("NIFTY analysis")
        assert s.status == ReasoningStatus.RUNNING

    def test_add_evidence_tracks_in_session(self):
        from enterprise_ai_platform.intelligence.reasoning import EvidenceType, EvidenceStrength
        mgr = self._mgr()
...
class TestReasoningEngine:
    ...
    def test_double_initialize_raises(self):
        from enterprise_ai_platform.intelligence.reasoning import get_reasoning_engine, EngineAlreadyRunningError
        e = get_reasoning_engine()
        e.initialize()
    ...
    def test_not_initialized_raises(self):
        from enterprise_ai_platform.intelligence.reasoning import get_reasoning_engine, EngineNotInitializedError
        e = get_reasoning_engine()
    ...
    def test_explain_text(self):
        from enterprise_ai_platform.intelligence.reasoning import ExplanationType
        en  = _engine()
...
class TestPerformance:
    def test_single_session_under_200ms(self):
        ...
        from enterprise_ai_platform.intelligence.reasoning import EvidenceType
        e  = _engine()
