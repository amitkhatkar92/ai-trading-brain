...
def _ctx(payload: dict | None = None, source_id: str = "test") -> "EvaluationContext":
    from enterprise_ai_platform.decision_policies import EvaluationContext
    return EvaluationContext(source_id=source_id, payload=payload or {})


def _pass_eval(ctx):
    from enterprise_ai_platform.decision_policies import RuleStatus
...
def _reset_all() -> None:
    from enterprise_ai_platform.decision_policies.decision_policy_engine import reset_decision_policy_engine
    from enterprise_ai_platform.decision_policies.policy_manager import reset_policy_manager
    from enterprise_ai_platform.decision_policies.registry.policy_registry import reset_policy_registry
    from enterprise_ai_platform.decision_policies.rules.rule_registry import reset_rule_registry
    from enterprise_ai_platform.decision_policies.constraints.constraint_registry import reset_constraint_registry
    from enterprise_ai_platform.decision_policies.policy_context import reset_policy_context
...
class TestConstants:
    ...
    def test_group_operator_values(self):
        from enterprise_ai_platform.decision_policies import GroupOperator
    ...
    def test_policy_verdict_values(self):
        from enterprise_ai_platform.decision_policies import PolicyVerdict
    ...
    def test_evaluation_mode_values(self):
        from enterprise_ai_platform.decision_policies import EvaluationMode
    ...
    def test_constraint_types_present(self):
        from enterprise_ai_platform.decision_policies import ConstraintType
        for v in ("hard", "soft", "risk", "portfolio", "capital", "liquidity", "time", "custom"):
            assert ConstraintType(v) is not None

    def test_version(self):
        from enterprise_ai_platform.decision_policies import POLICY_ENGINE_VERSION
...
class TestEvaluationContext:
    def test_defaults(self):
        from enterprise_ai_platform.decision_policies import EvaluationContext, EvaluationMode
...
class TestPolicyContextScope:
    def test_evaluation_scope(self):
        from enterprise_ai_platform.decision_policies import evaluation_scope, EvaluationMode
        with evaluation_scope("src1", EvaluationMode.STRICT) as state:
            assert state.source_id == "src1"
            assert state.depth     == 1

    def test_stage_scope(self):
        from enterprise_ai_platform.decision_policies import evaluation_scope, policy_stage_scope
    ...
    def test_diagnostics(self):
        from enterprise_ai_platform.decision_policies import evaluation_scope, get_policy_context
...
class TestStaticRule:
    def test_pass(self):
        from enterprise_ai_platform.decision_policies import StaticRule, RuleStatus
    ...
    def test_to_dict(self):
        from enterprise_ai_platform.decision_policies import StaticRule
...
class TestDynamicRule:
    def test_evaluate(self):
        from enterprise_ai_platform.decision_policies import DynamicRule, RuleStatus
    ...
    def test_rule_type(self):
        from enterprise_ai_platform.decision_policies import DynamicRule, RuleType
...
class TestConditionalRule:
    def test_condition_true_evaluates(self):
        from enterprise_ai_platform.decision_policies import ConditionalRule, StaticRule, RuleStatus
    ...
    def test_rule_type(self):
        from enterprise_ai_platform.decision_policies import ConditionalRule, StaticRule, RuleType
...
class TestCompositeRule:
    def _make(self, op: str, *evals) -> "CompositeRule":
        from enterprise_ai_platform.decision_policies import StaticRule, CompositeRule
    ...
    def test_rule_type(self):
        from enterprise_ai_platform.decision_policies import RuleType
    ...
    def test_and_short_circuit(self):
        ...
        from enterprise_ai_platform.decision_policies import StaticRule, CompositeRule, RuleStatus
        called = []
        def last_eval(ctx):
            called.append(1)
...
class TestPriorityRule:
    def test_priority_override(self):
        from enterprise_ai_platform.decision_policies import StaticRule, PriorityRule
...
class TestRuleGroup:
    ...
    def test_and_all_pass(self):
        from enterprise_ai_platform.decision_policies import RuleGroup, GroupOperator, RuleStatus
    ...
    def test_add_remove_rule(self):
        from enterprise_ai_platform.decision_policies import RuleGroup, GroupOperator, StaticRule
    ...
    def test_to_dict(self):
        from enterprise_ai_platform.decision_policies import RuleGroup, GroupOperator
...
class TestRuleRegistry:
    def test_register_and_get(self):
        from enterprise_ai_platform.decision_policies import StaticRule, get_rule_registry
    ...
    def test_duplicate_raises(self):
        from enterprise_ai_platform.decision_policies import StaticRule, get_rule_registry, RuleAlreadyExistsError
        reg  = get_rule_registry()
    ...
    def test_not_found_raises(self):
        from enterprise_ai_platform.decision_policies import get_rule_registry, RuleNotFoundError
    ...
    def test_singleton(self):
        from enterprise_ai_platform.decision_policies import get_rule_registry
...
class TestRuleExecutor:
    def test_execute_sequential(self):
        from enterprise_ai_platform.decision_policies import StaticRule, RuleExecutor
    ...
    def test_dependency_missing_raises(self):
        from enterprise_ai_platform.decision_policies import StaticRule, RuleExecutor, RuleDependencyError
        ex   = RuleExecutor()
    ...
    def test_circular_dependency_raises(self):
        from enterprise_ai_platform.decision_policies import StaticRule, RuleExecutor, CircularRuleDependencyError
        ex = RuleExecutor()
...
class TestRuleEngine:
    def test_evaluate_rules(self):
        from enterprise_ai_platform.decision_policies import StaticRule, RuleEngine
        eng   = RuleEngine()
    ...
    def test_evaluate_group(self):
        from enterprise_ai_platform.decision_policies import StaticRule, RuleGroup, RuleEngine, GroupOperator
        from enterprise_ai_platform.decision_policies import RuleStatus
    ...
    def test_evaluate_by_tags(self):
        from enterprise_ai_platform.decision_policies import StaticRule, RuleEngine, get_rule_registry
        reg = get_rule_registry()
...
class TestStaticConstraint:
    def test_pass(self):
        from enterprise_ai_platform.decision_policies import StaticConstraint
...
class TestBoundedConstraint:
    def test_within_bounds(self):
        from enterprise_ai_platform.decision_policies import BoundedConstraint
...
class TestThresholdConstraint:
    def test_above_threshold_pass(self):
        from enterprise_ai_platform.decision_policies import ThresholdConstraint
...
class TestConstraintResult:
    def test_violated_property(self):
        from enterprise_ai_platform.decision_policies import ConstraintResult
...
class TestConstraintRegistry:
    def test_register_and_get(self):
        from enterprise_ai_platform.decision_policies import StaticConstraint, get_constraint_registry
    ...
    def test_duplicate_raises(self):
        from enterprise_ai_platform.decision_policies import StaticConstraint, get_constraint_registry, ConstraintAlreadyExistsError
        reg = get_constraint_registry()
    ...
    def test_not_found_raises(self):
        from enterprise_ai_platform.decision_policies import get_constraint_registry, ConstraintNotFoundError
    ...
    def test_singleton(self):
        from enterprise_ai_platform.decision_policies import get_constraint_registry
...
class TestConstraintEngine:
    def test_evaluate(self):
        from enterprise_ai_platform.decision_policies import StaticConstraint, ConstraintEngine
...
class TestCompliancePolicy:
    def test_pass(self):
        from enterprise_ai_platform.decision_policies import StaticCompliancePolicy
    ...
    def test_category(self):
        from enterprise_ai_platform.decision_policies import StaticCompliancePolicy, ComplianceCategory
...
class TestComplianceReport:
    def test_build_pass(self):
        from enterprise_ai_platform.decision_policies import StaticCompliancePolicy, build_compliance_report
    ...
    def test_to_dict(self):
        from enterprise_ai_platform.decision_policies import build_compliance_report
...
class TestComplianceEngine:
    def test_evaluate_pass(self):
        from enterprise_ai_platform.decision_policies import StaticCompliancePolicy, ComplianceEngine
...
class TestPolicyEvaluator:
    def test_empty_request_approves(self):
        from enterprise_ai_platform.decision_policies import PolicyEvaluator, PolicyEvaluationRequest, PolicyVerdict
        ev  = PolicyEvaluator()
    ...
    def test_rules_pass(self):
        from enterprise_ai_platform.decision_policies import PolicyEvaluator, PolicyEvaluationRequest, StaticRule
        ev  = PolicyEvaluator()
        req = PolicyEvaluationRequest(
    ...
    def test_rules_fail_rejects(self):
        from enterprise_ai_platform.decision_policies import PolicyEvaluator, PolicyEvaluationRequest, StaticRule, PolicyVerdict
        ev  = PolicyEvaluator()
        req = PolicyEvaluationRequest(
    ...
    def test_constraint_hard_rejects(self):
        from enterprise_ai_platform.decision_policies import PolicyEvaluator, PolicyEvaluationRequest, StaticConstraint, PolicyVerdict
        ev  = PolicyEvaluator()
        req = PolicyEvaluationRequest(
    ...
    def test_compliance_fail_rejects(self):
        from enterprise_ai_platform.decision_policies import PolicyEvaluator, PolicyEvaluationRequest, StaticCompliancePolicy, PolicyVerdict
        ev  = PolicyEvaluator()
        req = PolicyEvaluationRequest(
...
class TestConflictDetector:
    def test_no_conflicts_clean(self):
        from enterprise_ai_platform.decision_policies import ConflictDetector, StaticRule
    ...
    def test_duplicate_constraint_id_conflict(self):
        from enterprise_ai_platform.decision_policies import ConflictDetector, ConstraintResult
        det = ConflictDetector()
    ...
    def test_detect_all(self):
        from enterprise_ai_platform.decision_policies import ConflictDetector
        det = ConflictDetector()
        out = det.detect_all([], [])
...
class TestPolicyRegistry:
    def test_register_get_rule(self):
        from enterprise_ai_platform.decision_policies import get_policy_registry, StaticRule
    ...
    def test_duplicate_rule_raises(self):
        from enterprise_ai_platform.decision_policies import get_policy_registry, StaticRule, PolicyAlreadyExistsError
        reg  = get_policy_registry()
    ...
    def test_register_constraint(self):
        from enterprise_ai_platform.decision_policies import get_policy_registry, StaticConstraint
        reg = get_policy_registry()
    ...
    def test_register_compliance(self):
        from enterprise_ai_platform.decision_policies import get_policy_registry, StaticCompliancePolicy
        reg = get_policy_registry()
    ...
    def test_register_group(self):
        from enterprise_ai_platform.decision_policies import get_policy_registry, RuleGroup, GroupOperator
        reg = get_policy_registry()
    ...
    def test_not_found_raises(self):
        from enterprise_ai_platform.decision_policies import get_policy_registry, PolicyNotFoundError
        with pytest.raises(PolicyNotFoundError):
            get_policy_registry().get_rule("ghost_rule")

    def test_stats(self):
        from enterprise_ai_platform.decision_policies import get_policy_registry
...
class TestPolicyFactory:
    def test_make_rule(self):
        from enterprise_ai_platform.decision_policies import PolicyFactory, StaticRule
    ...
    def test_make_dynamic_rule(self):
        from enterprise_ai_platform.decision_policies import PolicyFactory, DynamicRule
        r = PolicyFactory.make_dynamic_rule("fd1", "FD1", _pass_eval)
        assert isinstance(r, DynamicRule)

    def test_make_composite_rule(self):
        from enterprise_ai_platform.decision_policies import PolicyFactory, StaticRule, CompositeRule
    ...
    def test_make_bounded_constraint(self):
        from enterprise_ai_platform.decision_policies import PolicyFactory, BoundedConstraint
    ...
    def test_make_threshold_constraint(self):
        from enterprise_ai_platform.decision_policies import PolicyFactory, ThresholdConstraint
    ...
    def test_make_compliance_policy(self):
        from enterprise_ai_platform.decision_policies import PolicyFactory, StaticCompliancePolicy
...
class TestPolicyManager:
    def test_register_and_evaluate_rule(self):
        from enterprise_ai_platform.decision_policies import get_policy_manager, StaticRule, PolicyVerdict
    ...
    def test_evaluate_hard_constraint_rejects(self):
        from enterprise_ai_platform.decision_policies import get_policy_manager, StaticConstraint, PolicyVerdict
        mgr = get_policy_manager()
    ...
    def test_register_compliance_policy(self):
        from enterprise_ai_platform.decision_policies import get_policy_manager, StaticCompliancePolicy
        mgr = get_policy_manager()
    ...
    def test_evaluate_all_registered(self):
        from enterprise_ai_platform.decision_policies import get_policy_manager, StaticRule
        mgr  = get_policy_manager()
    ...
    def test_stats(self):
        from enterprise_ai_platform.decision_policies import get_policy_manager
...
class TestDecisionPolicyEngine:
    def _engine(self):
        from enterprise_ai_platform.decision_policies import get_decision_policy_engine
    ...
    def test_not_initialized_raises(self):
        from enterprise_ai_platform.decision_policies import get_decision_policy_engine, EngineNotInitializedError
        eng = get_decision_policy_engine()
    ...
    def test_version_constant(self):
        from enterprise_ai_platform.decision_policies import DecisionPolicyEngine
...
class TestConcurrency:
    def test_concurrent_evaluations(self):
        from enterprise_ai_platform.decision_policies import get_decision_policy_engine, StaticRule
        eng = get_decision_policy_engine()
        eng.initialize()
...
class TestPackageImports:
    def test_all_key_symbols_importable(self):
        import enterprise_ai_platform.decision_policies as dp
        for sym in (
