...
ssh -i ~/.ssh/trading_vps root@178.18.252.24 "cd /root/ai-trading-brain && git pull origin main && docker compose build --no-cache && docker compose down --remove-orphans && docker compose up -d --force-recreate && sleep 8 && docker compose ps"
```
