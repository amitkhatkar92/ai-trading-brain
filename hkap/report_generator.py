...
class HKAPReportGenerator:
    ...
    def _final_recommendation(
        ...
        lines = [
            ...
            "> Promotion is automatic and evidence-gated (hkap_idr_evidence_bridge.py):",
            "> a pattern merges once it is independently reconfirmed across >=2",
            "> synthesis runs with genuinely new year coverage, non-degrading",
            "> survival, and >=75% survival across >=4 years. No human names a pattern;",
