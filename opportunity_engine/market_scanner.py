...
def _builtin_universe() -> List[Dict[str, Any]]:
    """
    Minimal fallback: the 38 existing watchlist symbols with sector tags.
    Used when nifty500_universe.json is absent (Phase B not yet complete).
    """
    return [
        ...
        {"symbol": "BANKBARODA", "yahoo_ticker": "BANKBARODA.NS", "sector": "BANKING",        "index": "NIFTY500"},
        ...
        {"symbol": "NTPC",       "yahoo_ticker": "NTPC.NS",       "sector": "ENERGY",         "index": "NIFTY50"},
        ...
        {"symbol": "HAVELLS",    "yahoo_ticker": "HAVELLS.NS",    "sector": "CONSUMER",       "index": "NIFTY500"},
        {"symbol": "PIDILITIND", "yahoo_ticker": "PIDILITIND.NS", "sector": "CHEMICALS",      "index": "NIFTY500"},
