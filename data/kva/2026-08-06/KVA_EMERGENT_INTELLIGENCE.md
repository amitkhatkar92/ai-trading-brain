...
|---------|--------|----------------------|---------------|
| sector_flow_count | 0.0000 | **WEAK** | Synergy amplifier |
| volume_ratio_raw | 0.0000 | **WEAK** | Synergy amplifier |
| macd_signal_norm | 0.0000 | **WEAK** | Synergy amplifier |
...
**Finding:** 'sector_flow_count' (solo r=0.0000 — near-zero individual predictive power) becomes powerful in multi-condition edges: EDG_VOLATI_93_EE0002(oos=100.0%) combined with [pcr, bb_position, mom_1d]; EDG_VOLATI_94_EE0002(oos=100.0%) combined with [pcr, bb_position, mom_1d]. Total synergy-only features identified: 22.
...
### Lesson 5
Sector conviction is the most reliable precursor of winners. 'sect_conviction' is the top winner DNA feature (avg confidence=0.538 across 10 winner patterns). Verify sector supports the trade before entry.
