══════════════════════════════════════════════════════════════════════════════
  ...
  Symbol: LT    Generated: 2026-08-07 12:20 IST
...
══════════════════════════════════════════════════════════════════════════════
  ...
  ────────────────────────────────────────────────────────────────────────────
  VERDICT: 10/10 questions answered with evidence  |  Decision: APPROVED  |  Confidence: 6.55/10
  ────────────────────────────────────────────────────────────────────────────
...
──────────────────────────────────────────────────────────────────────────────
  ...
  ··············································································
    ...
    GROUP        FEATURE                           VALUE
    ──────────────────────────────────────────────────────
    MOMENTUM     mom_1d                          -0.0048
    MOMENTUM     mom_5d                           0.0154
    MOMENTUM     mom_20d                          0.0503
    MOMENTUM     adx_score                        0.0648
                                                          
    VOLUME       volume_ratio_raw                 1.7290
    VOLUME       volume_spike                     0.0000
                                                          
    TECHNICAL    rsi                             54.8354
    TECHNICAL    rsi_overbought                   0.0000
  ...
  ··············································································
    ...
    ────────────────────────────────────────────────────────────────────────
    2026-03-18     APPROVED          6.55 range_market    Breakout_Volume_RSI_HiVol
    2026-03-18     APPROVED          6.58 range_market    Breakout_Volume_RSI_HiVol
    2026-03-17     APPROVED          6.50 range_market    Breakout_Volume_RSI_HiVol
    2026-03-17     APPROVED          6.50 range_market    Breakout_Volume_RSI_HiVol
    2026-03-17     APPROVED          6.54 range_market    Breakout_Volume_RSI_HiVol
    2026-03-17     APPROVED          6.54 range_market    Breakout_Volume_RSI_HiVol
    2026-03-16     APPROVED          7.06 range_market    Breakout_Volume_RSI_HiVol
    2026-03-16     APPROVED          7.06 range_market    Breakout_Volume_RSI_HiVol
    2026-03-16     APPROVED          7.06 range_market    Breakout_Volume_RSI_HiVol
    2026-03-16     APPROVED          7.04 range_market    Breakout_Volume_RSI_HiVol
  ...
  ··············································································
    ...
    • study002a [2026-08-03] — 'Study 2A — Winner DNA Discovery' | obs=280,909 | features matched: regime_bull, regime_score, mom_5d, mom_20d, mom_1d
    • ars_study_003 [2026-08-05] — 'Study 003 — Systematic Loser DNA Discovery' | obs=500 | features matched: breadth_weak, global_bias, volume_ratio_raw, mom_10d, vix_low
    • ars_study_h001 [2026-08-05] — 'Study H001 — Loser DNA Cross-Year Validation' | obs=500 | features matched: volume_ratio_raw, mom_10d, volume_spike, bb_position, mom_5d
...
──────────────────────────────────────────────────────────────────────────────
  ...
  ··········································································
  [✓ ANSWERED]  Decision APPROVED — LT cleared all 12 decision layers. Strategy: Breakout_Volume_RSI_HiVol. Final confidence: 6.55/10.

    • Scanner signal: direction=BUY  initial_confidence=8.05  strategy=Breakout_Volume
    • Market context: regime=range_market  VIX=18.9  breadth=0.720  PCR=1.37
    • Active edge fully satisfied: EDG_MOMENT_62_EE0003 (prec=62.7% oos_wr=50.0%), EDG_MOMENT_68_EE0001 (prec=68.3% oos_wr=71.4%), EDG_MOMENT_69_EE0001 (prec=69.9% oos_wr=78.4%)
    • DNA matches: 42 total  0 winner DNA  avg_confidence=0.903
    • Position modifier applied: 79.40% of full size (risk-adjusted entry)
    • Decision engine score: 6.55  position_modifier=0.794  regime=range_market  VIX=18.9

  Q2: Why were other stocks rejected? (Full scanner rejection audit)
  ··········································································
  [✓ ANSWERED]  16 stocks were scanned this cycle. Target (LT) was selected. 11 others rejected or pre-filtered; 4 also approved. Rejection reasons by stock:
    ...
    • ICICIBANK        scan_conf=8.72  outcome=APPROVED      gap_vs_target=-0.18  → Also APPROVED in this cycle (confidence=6.73)
    • RELIANCE         scan_conf=8.48  outcome=APPROVED      gap_vs_target=-0.12  → Also APPROVED in this cycle (confidence=6.67)
    ...
    • COALINDIA        scan_conf=8.04  outcome=APPROVED      → Also APPROVED in this cycle (confidence=6.55)
    ...
    • HDFCBANK         scan_conf=7.79  outcome=APPROVED      gap_vs_target=+0.07  → Also APPROVED in this cycle (confidence=6.48)
    ...
    • LT scanner rank: #7 of 16 stocks by initial confidence
  ...
  ··········································································
  [✓ ANSWERED]  PMCI composite: 8.05/10 broken into 7 sub-factor groups below.

    • PMCI composite score: 8.05/10  (strategy=Breakout_Volume  direction=BUY)
    • MOMENTUM: mom_1d=-0.0048  mom_5d=0.0154  mom_20d=0.0503  adx_score=0.0648
    • VOLUME: volume_ratio_raw=1.7290  volume_spike=0.0000
    • TECHNICAL: rsi=54.8354  rsi_overbought=0.0000  rsi_oversold=0.0000  macd_signal_norm=1.0000  macd_bull=1.0000  macd_bear=0.0000
    ...
    • EDGE CONFIRMATION: 23 active edge(s) fully satisfied — EDG_MOMENT_62_EE0003 (prec=62.7%), EDG_MOMENT_68_EE0001 (prec=68.3%), EDG_MOMENT_69_EE0001 (prec=69.9%)

  Q6: Which CDS factors mattered? (Decision engine sub-score breakdown)
  ··········································································
  [✓ ANSWERED]  CDS final score: 6.55/10 via 4 sub-components (technical + risk + macro + regime). Position modifier: 79% of max size.

    • Final confidence: 6.5500/10
    • Scanner (pre-CDS): 8.05/10
    • CDS adjustment: -1.50 (reduced by risk/regime filters)
  ...
  ··········································································
  [✓ ANSWERED]  8 counterfactual conditions identified that could flip this decision from APPROVED to the opposite outcome.

    • CONFIDENCE BUFFER: 0.05 pts above threshold. Decision would flip to REJECTED if confidence fell to < 6.5 (needs -0.05)
    • EDGE MARGIN 'EDG_MOMENT_62_EE0003': mom_5d=0.0154 is only 0.0095 units from breaking condition > 0.0059
    • EDGE MARGIN 'EDG_MOMENT_62_EE0003': volume_ratio=0.4322 is only 0.0742 units from breaking condition <= 0.5064
    • EDGE MARGIN 'EDG_MOMENT_62_EE0003': mom_10d=-0.0287 is only 0.0039 units from breaking condition <= -0.0248
    • EDGE MARGIN 'EDG_MOMENT_62_EE0003': mom_20d=0.0503 is only 0.0117 units from breaking condition > 0.0386
  ...
  [✓ ANSWERED]  If this trade results in a loss, 9 specific knowledge records will be updated (named below).
    ...
    • EDGE RECORD ['EDG_MOMENT_62_EE0003' ID=EDG_MOMENT_62_EE0003]: live_trades +1, live_wins unchanged. live_sharpe degrades. If below DECAYING threshold, status transitions ACTIVE → DECAYING.
    • EDGE RECORD ['EDG_MOMENT_68_EE0001' ID=EDG_MOMENT_68_EE0001]: live_trades +1, live_wins unchanged. live_sharpe degrades. If below DECAYING threshold, status transitions ACTIVE → DECAYING.
    • EDGE RECORD ['EDG_MOMENT_69_EE0001' ID=EDG_MOMENT_69_EE0001]: live_trades +1, live_wins unchanged. live_sharpe degrades. If below DECAYING threshold, status transitions ACTIVE → DECAYING.
    ...
    • KNN REGIME MODEL: Feature vector for LT (regime=range_market, VIX=18.9) added to training set with label=LOSS. Model retrained in next walk-forward validation run.

──────────────────────────────────────────────────────────────────────────────
  ▸ REJECTION AUDIT — Why Other Stocks Were Not Selected
──────────────────────────────────────────────────────────────────────────────
    Scanner universe this cycle: 16 stocks scanned
    Target: LT | Decision: APPROVED
    ...
    ICICIBANK             8.72 APPROVED              -0.18  Also APPROVED in this cycle (confidence=6.73)
    RELIANCE              8.48 APPROVED              -0.12  Also APPROVED in this cycle (confidence=6.67)
    ...
    COALINDIA             8.04 APPROVED                N/A  Also APPROVED in this cycle (confidence=6.55)
    ...
    HDFCBANK              7.79 APPROVED              +0.07  Also APPROVED in this cycle (confidence=6.48)
...
──────────────────────────────────────────────────────────────────────────────
    ...
    ICICIBANK        BUY               8.72 Breakout_Volume
...
──────────────────────────────────────────────────────────────────────────────
    ...
    [PARTIAL 2/4] EDG_MOMENT_86_EE0002
    precision=86%  sharpe=17.38  oos_wr=85%
       ✗   macd_signal_norm             <= 0.6361  (current=1.0)
       ✗   volume_ratio_raw             > 2.0109  (current=1.7289933660002794)
       ✓   volume_ratio_raw             <= 2.3279  (current=1.7289933660002794)
       ✓   adx_score                    > 0.0042  (current=0.06484979888029309)
