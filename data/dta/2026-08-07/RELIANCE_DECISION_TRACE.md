══════════════════════════════════════════════════════════════════════════════
  ...
  Symbol: RELIANCE    Generated: 2026-08-07 12:20 IST
...
══════════════════════════════════════════════════════════════════════════════
  ...
  ────────────────────────────────────────────────────────────────────────────
  VERDICT: 10/10 questions answered with evidence  |  Decision: APPROVED  |  Confidence: 6.67/10
  ────────────────────────────────────────────────────────────────────────────
...
──────────────────────────────────────────────────────────────────────────────
  ...
  ··············································································
    ...
    GROUP        FEATURE                           VALUE
    ──────────────────────────────────────────────────────
    MOMENTUM     mom_1d                          -0.0036
    MOMENTUM     mom_5d                           0.0102
    MOMENTUM     mom_20d                         -0.0391
    MOMENTUM     adx_score                        0.0000
                                                          
    VOLUME       volume_ratio_raw                 1.2308
    VOLUME       volume_spike                     0.0000
                                                          
    TECHNICAL    rsi                             71.9585
  ...
  ··············································································
    ...
    ────────────────────────────────────────────────────────────────────────
    2026-04-02     REJECTED          6.49 volatile        Equity_Breakout
    2026-04-02     REJECTED          6.49 volatile        Equity_Breakout
    2026-03-20     REJECTED          6.46 volatile        Hedging_Model
    2026-03-18     APPROVED          6.67 range_market    Breakout_Volume_RSI_HiVol
    2026-03-18     APPROVED          6.60 range_market    Breakout_Volume_RSI_HiVol
    2026-03-17     APPROVED          6.59 range_market    Breakout_Volume_RSI_HiVol
    2026-03-17     APPROVED          6.59 range_market    Breakout_Volume_RSI_HiVol
    2026-03-17     APPROVED          6.63 range_market    Breakout_Volume_RSI_HiVol
    2026-03-17     APPROVED          6.63 range_market    Breakout_Volume_RSI_HiVol
    2026-03-16     APPROVED          7.10 range_market    Breakout_Volume_RSI_HiVol
  ...
  ··············································································
    ...
    • study002a [2026-08-03] — 'Study 2A — Winner DNA Discovery' | obs=280,909 | features matched: regime_score, mom_5d, mom_20d, mom_1d, gap_pct
    • ars_study_003 [2026-08-05] — 'Study 003 — Systematic Loser DNA Discovery' | obs=500 | features matched: regime_score, pcr_neutral, breadth_weak, vix_low, volume_ratio
    • ars_study_h001 [2026-08-05] — 'Study H001 — Loser DNA Cross-Year Validation' | obs=500 | features matched: volume_ratio, breadth, event_count, bb_position, mom_5d
...
──────────────────────────────────────────────────────────────────────────────
  ...
  ··········································································
  [✓ ANSWERED]  Decision APPROVED — RELIANCE cleared all 12 decision layers. Strategy: Breakout_Volume_RSI_HiVol. Final confidence: 6.67/10.

    • Scanner signal: direction=BUY  initial_confidence=8.48  strategy=Breakout_Volume
    • Market context: regime=range_market  VIX=18.9  breadth=0.720  PCR=1.37
    • Active edge fully satisfied: EDG_MOMENT_67_EE0003 (prec=67.6% oos_wr=85.0%), EDG_MOMENT_67_EE0004 (prec=67.2% oos_wr=76.5%), EDG_MOMENT_68_EE0001 (prec=68.3% oos_wr=71.4%)
    • DNA matches: 42 total  0 winner DNA  avg_confidence=0.903
    • Position modifier applied: 79.40% of full size (risk-adjusted entry)
    • Decision engine score: 6.67  position_modifier=0.794  regime=range_market  VIX=18.9

  Q2: Why were other stocks rejected? (Full scanner rejection audit)
  ··········································································
  [✓ ANSWERED]  16 stocks were scanned this cycle. Target (RELIANCE) was selected. 11 others rejected or pre-filtered; 4 also approved. Rejection reasons by stock:
    ...
    • ICICIBANK        scan_conf=8.72  outcome=APPROVED      gap_vs_target=-0.06  → Also APPROVED in this cycle (confidence=6.73)
    ...
    • LT               scan_conf=8.05  outcome=APPROVED      gap_vs_target=+0.12  → Also APPROVED in this cycle (confidence=6.55)
    • COALINDIA        scan_conf=8.04  outcome=APPROVED      gap_vs_target=+0.12  → Also APPROVED in this cycle (confidence=6.55)
    ...
    • HDFCBANK         scan_conf=7.79  outcome=APPROVED      gap_vs_target=+0.19  → Also APPROVED in this cycle (confidence=6.48)
    ...
    • RELIANCE scanner rank: #4 of 16 stocks by initial confidence
  ...
  ··········································································
  [✓ ANSWERED]  PMCI composite: 8.48/10 broken into 7 sub-factor groups below.

    • PMCI composite score: 8.48/10  (strategy=Breakout_Volume  direction=BUY)
    • MOMENTUM: mom_1d=-0.0036  mom_5d=0.0102  mom_20d=-0.0391  adx_score=0.0000
    • VOLUME: volume_ratio_raw=1.2308  volume_spike=0.0000
    • TECHNICAL: rsi=71.9585  rsi_overbought=1.0000  rsi_oversold=0.0000  macd_signal_norm=1.0000  macd_bull=1.0000  macd_bear=0.0000
    ...
    • EDGE CONFIRMATION: 24 active edge(s) fully satisfied — EDG_MOMENT_67_EE0003 (prec=67.6%), EDG_MOMENT_67_EE0004 (prec=67.2%), EDG_MOMENT_68_EE0001 (prec=68.3%)

  Q6: Which CDS factors mattered? (Decision engine sub-score breakdown)
  ··········································································
  [✓ ANSWERED]  CDS final score: 6.67/10 via 4 sub-components (technical + risk + macro + regime). Position modifier: 79% of max size.

    • Final confidence: 6.6700/10
    • Scanner (pre-CDS): 8.48/10
    • CDS adjustment: -1.81 (reduced by risk/regime filters)
  ...
  [✓ ANSWERED]  7 counterfactual conditions identified that could flip this decision from APPROVED to the opposite outcome.
    ...
    • CONFIDENCE BUFFER: 0.17 pts above threshold. Decision would flip to REJECTED if confidence fell to < 6.5 (needs -0.17)
    • EDGE MARGIN 'EDG_MOMENT_67_EE0003': mom_10d=0.0420 is only 0.0668 units from breaking condition > -0.0248
    • EDGE MARGIN 'EDG_MOMENT_67_EE0004': mom_5d=0.0102 is only 0.0043 units from breaking condition > 0.0059
    • EDGE MARGIN 'EDG_MOMENT_67_EE0004': mom_10d=0.0420 is only 0.0668 units from breaking condition > -0.0248
  ...
  [✓ ANSWERED]  If this trade results in a loss, 9 specific knowledge records will be updated (named below).
    ...
    • KNN REGIME MODEL: Feature vector for RELIANCE (regime=range_market, VIX=18.9) added to training set with label=LOSS. Model retrained in next walk-forward validation run.

──────────────────────────────────────────────────────────────────────────────
  ▸ REJECTION AUDIT — Why Other Stocks Were Not Selected
──────────────────────────────────────────────────────────────────────────────
    Scanner universe this cycle: 16 stocks scanned
    Target: RELIANCE | Decision: APPROVED
    ...
    ICICIBANK             8.72 APPROVED              -0.06  Also APPROVED in this cycle (confidence=6.73)
    ...
    LT                    8.05 APPROVED              +0.12  Also APPROVED in this cycle (confidence=6.55)
    COALINDIA             8.04 APPROVED              +0.12  Also APPROVED in this cycle (confidence=6.55)
    ...
    HDFCBANK              7.79 APPROVED              +0.19  Also APPROVED in this cycle (confidence=6.48)
...
──────────────────────────────────────────────────────────────────────────────
    ...
    precision=86%  sharpe=17.38  oos_wr=85%
       ...
       ✗   volume_ratio_raw             > 2.0109  (current=1.230807751189618)
       ✓   volume_ratio_raw             <= 2.3279  (current=1.230807751189618)
